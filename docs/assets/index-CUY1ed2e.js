...
function Hm() {
  ...
  function B(m, x, U) {
    ...
    return (
      (x = U.ref),
      { $$typeof: D, type: m, key: G, ref: x !== void 0 ? x : null, props: U }
    );
  }
  return (Mu.Fragment = J), (Mu.jsx = B), (Mu.jsxs = B), Mu;
}
var ud;
function qm() {
  return ud || ((ud = 1), (nf.exports = Hm())), nf.exports;
}
var s = qm(),
  cf = { exports: {} },
  $ = {};
...
function Cm() {
  ...
  (Da.prototype.isReactComponent = {}),
    (Da.prototype.setState = function (r, _) {
    ...
    (Da.prototype.forceUpdate = function (r) {
      this.updater.enqueueForceUpdate(this, r, "forceUpdate");
    });
  function ua() {}
  ua.prototype = Da.prototype;
  function Ea(r, _, R) {
    (this.props = r),
      (this.context = _),
      (this.refs = $a),
  ...
  var w = (Ea.prototype = new ua());
  (w.constructor = Ea), Na(w, Da.prototype), (w.isPureReactComponent = !0);
  var cl = Array.isArray,
    O = { H: null, A: null, T: null, S: null, V: null },
    Wa = Object.prototype.hasOwnProperty;
  function ta(r, _, R, M, d, N) {
    return (
      (R = N.ref),
      { $$typeof: D, type: r, key: _, ref: R !== void 0 ? R : null, props: N }
    );
  }
  function Za(r, _) {
  ...
  function Ta(r, _, R, M, d) {
        ...
        case "object":
          switch (r.$$typeof) {
            ...
            case J:
              ...
              break;
            case C:
              return (E = r._init), Ta(E(r._payload), _, R, M, d);
          }
      }
    if (E)
      return (
    ...
    if (cl(r))
      for (var Q = 0; Q < r.length; Q++)
        (M = r[Q]), (N = X + ba(M, Q)), (E += Ta(M, _, R, N, d));
    else if (((Q = la(r)), typeof Q == "function"))
      for (r = Q.call(r), Q = 0; !(M = r.next()).done; )
        (M = M.value), (N = X + ba(M, Q++)), (E += Ta(M, _, R, N, d));
    else if (N === "object") {
      if (typeof r.then == "function") return Ta(Cl(r), _, R, M, d);
      throw (
        ((_ = String(r)),
        Error(
  ...
  return (
    ...
    ($.cloneElement = function (r, _, R) {
      ...
      var M = Na({}, r.props),
        ...
        N = void 0;
      if (_ != null)
        for (E in (_.ref !== void 0 && (N = void 0),
      ...
      if (E === 1) M.children = R;
        ...
        for (var X = Array(E), Q = 0; Q < E; Q++) X[Q] = arguments[Q + 2];
        M.children = X;
      }
      return ta(r.type, d, void 0, void 0, N, M);
    }),
    ...
    ($.createElement = function (r, _, R) {
      var M,
        ...
        N = null;
      if (_ != null)
        for (M in (_.key !== void 0 && (N = "" + _.key), _))
          Wa.call(_, M) &&
            M !== "key" &&
            M !== "__self" &&
            M !== "__source" &&
      ...
      if (r && r.defaultProps)
        for (M in ((E = r.defaultProps), E)) d[M] === void 0 && (d[M] = E[M]);
      return ta(r, N, void 0, void 0, null, d);
    }),
    ($.createRef = function () {
      return { current: null };
    }),
...
var id;
function df() {
  return id || ((id = 1), (cf.exports = Cm())), cf.exports;
}
var Ha = df(),
  ff = { exports: {} },
  ju = {},
    ...
    cd ||
      ...
      (function (D) {
            ...
            a: for (var sa = 0, r = S.length, _ = r >>> 1; sa < _; ) {
              ...
              if (0 > x(M, Z))
                d < r && 0 > x(N, M)
                  ? ((S[sa] = N), (S[d] = Z), (sa = d))
                  : ((S[sa] = M), (S[R] = Z), (sa = R));
              else if (d < r && 0 > x(N, Z)) (S[sa] = N), (S[d] = Z), (sa = d);
              else break a;
            }
          }
          return j;
        ...
        var q = [],
          ...
          $a = !1,
          Da = !1,
          ua = typeof setTimeout == "function" ? setTimeout : null,
        ...
        function O(S) {
          if ((($a = !1), cl(S), !Na))
            if (B(q) !== null) (Na = !0), Wa || ((Wa = !0), ba());
            else {
              var j = B(p);
              j !== null && Ta(O, j.startTime - S);
            }
        }
        var Wa = !1,
          ta = -1,
          ...
          Ba = -1;
        function ql() {
          return Da ? !0 : !(D.unstable_now() - Ba < Za);
        }
        function Ma() {
          if (((Da = !1), Wa)) {
            ...
            try {
              a: {
                (Na = !1), $a && (($a = !1), Ea(ta), (ta = -1)), (ca = !0);
                var Z = la;
                try {
                  l: {
                    for (
                      cl(S), k = B(q);
                      k !== null && !(k.expirationTime > S && ql());
                      ...
                      if (typeof sa == "function") {
                        ...
                        if (((S = D.unstable_now()), typeof r == "function")) {
                          (k.callback = r), cl(S), (j = !0);
                          break l;
                        }
                        k === B(q) && m(q), cl(S);
                      } else m(q);
        ...
        (D.unstable_IdlePriority = 5),
          ...
          (D.unstable_runWithPriority = function (S, j) {
            switch (S) {
              case 1:
              case 2:
              case 3:
          ...
          (D.unstable_scheduleCallback = function (S, j, Z) {
            var sa = D.unstable_now();
            switch (
            ...
            return (
              ...
              Z > sa
                ? ((S.sortIndex = Z),
                  ...
                  B(q) === null &&
                    S === B(p) &&
                    ($a ? (Ea(ta), (ta = -1)) : ($a = !0), Ta(O, Z - sa)))
                : ((S.sortIndex = r),
                  J(q, S),
                  Na || ca || ((Na = !0), Wa || ((Wa = !0), ba()))),
              S
            );
          }),
          (D.unstable_shouldYield = ql),
...
var fd;
function Ym() {
  return fd || ((fd = 1), (sf.exports = Bm())), sf.exports;
}
var of = { exports: {} },
  Pa = {};
/**
...
function Xm() {
  ...
  var G = D.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
  function aa(q, p) {
    if (q === "font") return "";
...
function Gm() {
  ...
  return D(), (of.exports = Xm()), of.exports;
}
/**
 * @license React
...
function Qm() {
  ...
  var C = Object.assign,
    ...
    ql = Symbol.for("react.memo_cache_sentinel"),
    Ma = Symbol.iterator;
  function ba(a) {
  ...
  var d = _(null),
    ...
    X = _(null);
  function Q(a, l) {
    switch ((M(E, l), M(N, a), M(d, null), l.nodeType)) {
      case 9:
      case 11:
  ...
  function na(a) {
    N.current === a && (R(d), R(N)),
      X.current === a && (R(X), (Eu._currentValue = Z));
  }
  var ka = Object.prototype.hasOwnProperty,
    Va = D.unstable_scheduleCallback,
    xa = D.unstable_cancelCallback,
    Ml = D.unstable_shouldYield,
    at = D.unstable_requestPaint,
    ll = D.unstable_now,
    xe = D.unstable_getCurrentPriorityLevel,
    Lt = D.unstable_ImmediatePriority,
    Kt = D.unstable_UserBlockingPriority,
    lt = D.unstable_NormalPriority,
    Re = D.unstable_LowPriority,
    xu = D.unstable_IdlePriority,
    Bl = D.log,
    Ru = D.unstable_setDisableYieldValue,
    Yl = null,
    La = null;
  function tt(a) {
    if (
...
` +
  ...
  function Yu(a) {
    a._valueTracker || (a._valueTracker = Md(a));
  }
  function _f(a) {
    if (!a) return !1;
  ...
  var jd = /[\n"\\]/g;
  function gl(a) {
    return a.replace(jd, function (l) {
  ...
  var Dt = {
    ...
    Cf = el(Ku),
    qd = C({}, Ku, { dataTransfer: 0 }),
    Cd = el(qd),
    Bd = C({}, Xe, { relatedTarget: 0 }),
    di = el(Bd),
    Yd = C({}, Dt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Xd = el(Yd),
    Gd = C({}, Dt, {
  ...
  var wd = C({}, Xe, {
    ...
    Fd = el(kd),
    Id = C({}, Dt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Pd = el(Id),
    ah = C({}, Ku, {
      deltaX: function (a) {
        return "deltaX" in a
    ...
    lh = el(ah),
    th = C({}, Dt, { newState: 0, oldState: 0 }),
    eh = el(th),
    uh = [9, 13, 27, 32],
    mi = Gl && "CompositionEvent" in window,
    Qe = null;
  Gl && "documentMode" in document && (Qe = document.documentMode);
  var nh = Gl && "TextEvent" in window && !Qe,
    Xf = Gl && (!mi || (Qe && 8 < Qe && 11 >= Qe)),
    Gf = " ",
    Qf = !1;
  function Zf(a, l) {
    switch (a) {
      case "keyup":
        return uh.indexOf(l.keyCode) !== -1;
      case "keydown":
  ...
  function ch(a, l) {
    if (te)
      return a === "compositionend" || (!mi && Zf(a, l))
  ...
  function Lf(a) {
    ...
    return l === "input" ? !!fh[a.type] : l === "textarea";
  }
  function Kf(a, l, t, e) {
  ...
  var sl = typeof Object.is == "function" ? Object.is : mh;
  function Le(a, l) {
    if (sl(a, l)) return !0;
    if (
      typeof a != "object" ||
  ...
  var vh = Gl && "documentMode" in document && 11 >= document.documentMode,
    ee = null,
    bi = null,
    Ke = null,
    Si = !1;
  ...
  var es = jt("animationend"),
    ...
    yh = jt("transitionrun"),
    gh = jt("transitionstart"),
    bh = jt("transitioncancel"),
    is = jt("transitionend"),
    cs = new Map(),
    pi =
  ...
  function Wu(a) {
    if (50 < yu) throw ((yu = 0), (Mc = null), Error(m(185)));
  ...
  function ku(a, l, t, e, u, n) {
    ...
    if (((e = a), typeof a == "function")) Ei(a) && (i = 1);
      ...
      a: switch (a) {
        ...
        case Da:
          return (
            (a = rl(12, t, l, u | 2)), (a.elementType = Da), (a.lanes = n), a
          );
        case O:
          return (a = rl(13, t, l, u)), (a.elementType = O), (a.lanes = n), a;
        case Wa:
          return (a = rl(19, t, l, u)), (a.elementType = Wa), (a.lanes = n), a;
        default:
          if (typeof a == "object" && a !== null)
            switch (a.$$typeof) {
              case ua:
  ...
  function ds(a) {
    ...
    switch (((l[Fa] = a), (l[tl] = e), t)) {
      ...
      case "select":
        ...
        break;
      case "textarea":
        P("invalid", l), Mf(l, e.value, e.defaultValue, e.children), Yu(l);
    }
    (t = e.children),
  ...
  function Je(a) {
    ...
    if (
      ...
      l === 27
        ? ((l = pa), zt(a.type) ? ((a = Wc), (Wc = null), (pa = a)) : (pa = l))
  ...
  var ji = _(null),
    ...
    Ll = null;
  function nt(a, l, t) {
    M(ji, l._currentValue), (l._currentValue = t);
  }
  function Kl(a) {
    (a._currentValue = ji.current), R(ji);
  }
  function xi(a, l, t) {
    for (; a !== null; ) {
      var e = a.alternate;
  ...
  function ln(a, l) {
    l === null ? M(Yt, Yt.current) : M(Yt, l.pool);
  }
  function bs() {
    var a = qi();
  ...
  var de = _(null),
    un = _(0);
  function _s(a, l) {
    (a = Il), M(un, a), M(de, l), (Il = a | l.baseLanes);
  }
  function Qi() {
    M(un, Il), M(de, de.current);
  }
  function Zi() {
  ...
  function Wi(a) {
    ...
    if (
      ...
      t === null && ((t = $i()), (W.updateQueue = t)),
      (t.memoCache = l),
      (t = l.data[l.index]),
      t === void 0)
    )
      for (t = l.data[l.index] = Array(a), e = 0; e < a; e++) t[e] = ql;
    return l.index++, t;
  }
  function Jl(a, l) {
  ...
  function Ms(a, l, t) {
    ...
    var i = !sl((ha || u).memoizedState, t);
    i && ((u.memoizedState = t), (Xa = !0)), (u = u.queue);
    var c = Rs.bind(null, e, u, a);
    if (
      (nu(2048, 8, c, [a]),
      u.getSnapshot !== l || i || (Ra !== null && Ra.memoizedState.tag & 1))
    ) {
      if (
        ((e.flags |= 2048),
  ...
  function js(a, l, t) {
    (a.flags |= 16384),
      ...
      (l = W.updateQueue),
      l === null
        ? ((l = $i()), (W.updateQueue = l), (l.stores = [a]))
  ...
  function qs(a, l, t, e) {
    return (a.baseState = t), ki(a, ha, typeof e == "function" ? e : Jl);
  }
  function Oh(a, l, t, e, u) {
  ...
  function Qs(a, l) {
      ...
      if (t !== null) {
        a: {
          ...
          if (fa) {
            if (pa) {
              l: {
                for (var u = pa, n = jl; u.nodeType !== 8; ) {
                  if (!n) {
                    u = null;
                    break l;
                  }
    ...
    return (
      ...
      (e.dispatch = t),
      (e = Ii(!1)),
      (n = uc.bind(null, W, !1, e.queue)),
      (e = ul()),
      (u = { state: l, dispatch: null, action: a, pending: null }),
      (e.queue = u),
      (t = Oh.bind(null, W, u, n, t)),
      (u.dispatch = t),
      (e.memoizedState = a),
      [l, t, !1]
    );
  ...
  function nu(a, l, t, e) {
    ...
    ha !== null && e !== null && Vi(e, ha.memoizedState.deps)
  ...
  function lr(a, l, t, e, u) {
    ...
    try {
      ...
      iu(a, l, { then: function () {}, status: "rejected", reason: T }, ml());
    } finally {
      (j.p = n), (S.T = i);
    }
  }
  ...
  var hn = {
    ...
    sr = {
      ...
      useOptimistic: function (a) {
        ...
        return (
          (l.queue = t), (l = uc.bind(null, W, !0, t)), (t.dispatch = l), [a, l]
        );
      },
      useMemoCache: Wi,
      useCacheRefresh: function () {
        return (ul().memoizedState = jh.bind(null, W));
      },
    },
    rr = {
      readContext: Ia,
    ...
    Rh = {
      ...
      useDeferredValue: function (a, l) {
        var t = Ua();
        return ha === null ? lc(t, a, l) : ar(t, ha.memoizedState, a, l);
      },
      useTransition: function () {
        var a = Fi(Jl)[0],
          l = Ua().memoizedState;
  ...
  function dr(a) {
    ...
    function f(h, o, v, A) {
      ...
      return H === Na
        ...
        : ((o = ku(v.type, v.key, v.props, null, h.mode, A)),
          fu(o, v),
          (o.return = h),
          o);
    }
    function y(h, o, v, A) {
      return o === null ||
        ...
        ? ((o = _i(v, h.mode, A)), (o.return = h), o)
        : ((o = u(o, v.children || [])), (o.return = h), o);
    }
    function z(h, o, v, A, H) {
      return o === null || o.tag !== 7
        ? ((o = xt(v, h.mode, A, H)), (o.return = h), o)
        : ((o = u(o, v)), (o.return = h), o);
    }
    function T(h, o, v) {
      if (
        ...
        return (o = Ti("" + o, h.mode, v)), (o.return = h), o;
      if (typeof o == "object" && o !== null) {
        switch (o.$$typeof) {
          ...
          case ca:
            return (o = _i(o, h.mode, v)), (o.return = h), o;
          case Za:
            var A = o._init;
            return (o = A(o._payload)), T(h, o, v);
        }
        if (Ta(o) || ba(o))
    ...
    function g(h, o, v, A) {
      ...
      if (typeof v == "object" && v !== null) {
        ...
        if (Ta(v) || ba(v)) return H !== null ? null : z(h, o, v, A, null);
        if (typeof v.then == "function") return g(h, o, mn(v), A);
        if (v.$$typeof === w) return g(h, o, an(h, v), A);
        vn(h, v);
      }
      return null;
    }
    function b(h, o, v, A, H) {
      if (
        (typeof A == "string" && A !== "") ||
        typeof A == "number" ||
        typeof A == "bigint"
      )
        return (h = h.get(v) || null), c(o, h, "" + A, H);
      if (typeof A == "object" && A !== null) {
        switch (A.$$typeof) {
          case la:
            return (
          ...
          case Za:
            var F = A._init;
            return (A = F(A._payload)), b(h, o, v, A, H);
        }
        if (Ta(A) || ba(A)) return (h = h.get(v) || null), z(o, h, A, H, null);
        if (typeof A.then == "function") return b(h, o, v, mn(A), H);
        if (A.$$typeof === w) return b(h, o, v, an(o, A), H);
        vn(o, A);
      }
      return null;
    }
    function K(h, o, v, A) {
      for (
        ...
        a && Y && ia.alternate === null && l(h, Y),
          (o = n(ia, o, L)),
          F === null ? (H = ia) : (F.sibling = ia),
          (F = ia),
          (Y = Qa);
      }
    ...
    function V(h, o, v, A) {
      ...
      for (
        var H = null, F = null, Y = o, L = (o = 0), Qa = null, ia = v.next();
        Y !== null && !ia.done;
        L++, ia = v.next()
      ) {
        Y.index > L ? ((Qa = Y), (Y = null)) : (Qa = Y.sibling);
        var Tt = g(h, Y, ia.value, A);
        if (Tt === null) {
          Y === null && (Y = Qa);
          break;
        }
      ...
      if (ia.done) return t(h, Y), fa && Ut(h, L), H;
      if (Y === null) {
        for (; !ia.done; L++, ia = v.next())
          (ia = T(h, ia.value, A)),
            ia !== null &&
              ((o = n(ia, o, L)),
              F === null ? (H = ia) : (F.sibling = ia),
      ...
      for (Y = e(Y); !ia.done; L++, ia = v.next())
        (ia = b(Y, h, L, ia.value, A)),
          ia !== null &&
            (a &&
              ia.alternate !== null &&
              Y.delete(ia.key === null ? L : ia.key),
            (o = n(ia, o, L)),
            F === null ? (H = ia) : (F.sibling = ia),
            (F = ia));
      return (
        a &&
          Y.forEach(function (Um) {
            return l(h, Um);
          }),
        fa && Ut(h, L),
        H
        ...
        switch (v.$$typeof) {
          case la:
            a: {
              ...
              v.type === Na
                ? ((A = xt(v.props.children, h.mode, A, v.key)),
                  (A.return = h),
                  (h = A))
                : ((A = ku(v.type, v.key, v.props, null, h.mode, A)),
                  fu(A, v),
                  (A.return = h),
                  (h = A));
            }
          ...
          case ca:
            a: {
              ...
              (A = _i(v, h.mode, A)), (A.return = h), (h = A);
            }
            return i(h);
          case Za:
            return (H = v._init), (v = H(v._payload)), va(h, o, v, A);
        }
        if (Ta(v)) return K(h, o, v, A);
        if (ba(v)) {
          if (((H = ba(v)), typeof H != "function")) throw Error(m(150));
          return (v = H.call(v)), V(h, o, v, A);
        }
        if (typeof v.then == "function") return va(h, o, mn(v), A);
        if (v.$$typeof === w) return va(h, o, an(h, v), A);
        vn(h, v);
      }
      return (typeof v == "string" && v !== "") ||
        ...
        ? ((v = "" + v),
          o !== null && o.tag === 6
            ...
            : (t(h, o), (A = Ti(v, h.mode, A)), (A.return = h), (h = A)),
          i(h))
        : t(h, o);
    }
  ...
  function mr(a) {
    if (a.tag === 22) {
      if ((M(Ca, Ca.current), M(Al, a), xl === null)) {
        var l = a.alternate;
        l !== null && l.memoizedState !== null && (xl = a);
      }
    } else ot();
  }
  function ot() {
    M(Ca, Ca.current), M(Al, Al.current);
  }
  function wl(a) {
    R(Al), xl === a && (xl = null), R(Ca);
  }
  var Ca = _(0);
  function yn(a) {
    for (var l = a; l !== null; ) {
    ...
    if (
      ...
      if (
        ...
        switch (t.tag) {
          case 13:
            return (
              xl === null ? xc() : t.alternate === null && Aa === 0 && (Aa = 3),
              (t.flags &= -257),
              (t.flags |= 65536),
              (t.lanes = u),
              e === Ci
      ...
      return (
        ...
        l !== null
          ? ((l.flags & 65536) === 0 && (l.flags |= 256),
            (l.flags |= 65536),
            (l.lanes = u),
            e !== Mi && ((a = Error(m(422), { cause: e })), $e(bl(a, t))))
          : (e !== Mi && ((l = Error(m(423), { cause: e })), $e(bl(l, t))),
  ...
  function Er(a, l, t, e, u) {
    ...
    return (
      ...
      a !== null && !Xa
        ? (Ji(a, l, u), $l(a, l, u))
        : (fa && c && Oi(l), (l.flags |= 1), Ka(a, l, e, u), l.child)
    );
  }
  ...
  function _r(a, l, t, e, u) {
    if (a !== null) {
      ...
      if (Le(n, e) && a.ref === l.ref)
        if (((Xa = !1), (l.pendingProps = e = n), vc(a, u)))
  ...
  function fc(a, l, t, e, u) {
    return (
      ...
      a !== null && !Xa
        ? (Ji(a, l, u), $l(a, l, u))
        : (fa && e && Oi(l), (l.flags |= 1), Ka(a, l, t, u), l.child)
    );
  }
  function Mr(a, l, t, e, u, n) {
    return (
      Bt(l),
      (l.updateQueue = null),
      (t = Ds(l, e, t, u)),
      ...
      a !== null && !Xa
        ? (Ji(a, l, n), $l(a, l, n))
        : (fa && e && Oi(l), (l.flags |= 1), Ka(a, l, t, n), l.child)
    );
  }
  function jr(a, l, t, e, u) {
    if ((Bt(l), l.stateNode === null)) {
      ...
      var y = n.context,
        z = t.contextType;
      (i = ce), typeof z == "object" && z !== null && (i = Ia(z));
  ...
  function xr(a, l, t, e) {
    return we(), (l.flags |= 256), Ka(a, l, t, e), l.child;
  }
  var sc = {
    dehydrated: null,
    treeContext: null,
  ...
  function Rr(a, l, t) {
    ...
    if (
      ...
      if (n)
        ...
        (Xa || We(a, l, t, !1), (i = (t & a.childLanes) !== 0), Xa || i)
      ) {
        if (
          ((i = ga),
          i !== null &&
    ...
    return u
      ? (ot(),
        ...
        y !== null ? (u = Ql(y, u)) : ((u = xt(u, c, t, null)), (u.flags |= 2)),
        (u.return = l),
        (e.return = l),
        (e.sibling = u),
        (l.child = e),
  ...
  function Ur(a, l, t) {
    a.lanes |= l;
    var e = a.alternate;
    e !== null && (e.lanes |= l), xi(a.return, l, t);
  }
  function mc(a, l, t, e, u) {
  ...
  function Hr(a, l, t) {
    var e = l.pendingProps,
      u = e.revealOrder,
      n = e.tail;
    if ((Ka(a, l, e.children, t), (e = Ca.current), (e & 2) !== 0))
      (e = (e & 1) | 2), (l.flags |= 128);
    else {
  ...
  function qr(a, l, t) {
    if (a !== null)
      if (a.memoizedProps !== l.pendingProps) Xa = !0;
        ...
        if (!vc(a, t) && (l.flags & 128) === 0) return (Xa = !1), Hh(a, l, t);
        Xa = (a.flags & 131072) !== 0;
      }
    ...
    switch (((l.lanes = 0), l.tag)) {
          ...
          a === null
            ? (t = Go(l.type, null, l.pendingProps, null))
              ...
              : fa ||
                ((t = l.type),
                (a = l.pendingProps),
                (e = Hn(E.current).createElement(t)),
                (e[Fa] = l),
                (e[tl] = a),
                wa(e, t, a),
                Ya(e),
      ...
      case 27:
        return (
          ...
          a === null &&
            fa &&
            ((e = l.stateNode = Bo(l.type, l.pendingProps, E.current)),
            (al = l),
            (jl = !0),
            (u = pa),
            zt(l.type) ? ((Wc = u), (pa = Ol(e.firstChild))) : (pa = u)),
          Ka(a, l, l.pendingProps.children, t),
          Sn(a, l),
      ...
      case 5:
        return (
          a === null &&
            fa &&
            ((u = e = pa) &&
              ((e = fm(e, l.type, l.pendingProps, jl)),
              e !== null
                ? ((l.stateNode = e),
                  (al = l),
                  (pa = Ol(e.firstChild)),
          ...
          l.memoizedState !== null &&
            ((u = Li(a, l, _h, null, null, t)), (Eu._currentValue = u)),
          Sn(a, l),
          Ka(a, l, e, t),
          l.child
        );
      ...
      case 4:
        return (
          Q(l, l.stateNode.containerInfo),
          (e = l.pendingProps),
          a === null ? (l.child = ge(l, null, e, t)) : Ka(a, l, e, t),
          l.child
        );
      case 11:
        return Er(a, l, l.type, l.pendingProps, t);
      case 7:
        return Ka(a, l, l.pendingProps, t), l.child;
      case 8:
        return Ka(a, l, l.pendingProps.children, t), l.child;
      case 12:
        return Ka(a, l, l.pendingProps.children, t), l.child;
      case 10:
        return (
    ...
    if (l.type !== "stylesheet" || (l.state.loading & 4) !== 0)
      ...
      if (
        ...
        l !== null &&
          ((ea & 4194048) === ea
            ? xl !== null
            : ((ea & 62914560) !== ea && (ea & 536870912) === 0) || l !== xl))
      )
        throw ((Pe = Ci), Ss);
      a.flags |= 8192;
    }
  ...
  function qh(a, l, t) {
    ...
    switch ((Di(l), l.tag)) {
      ...
      case 27:
        ...
        return za(l), null;
      case 5:
        if ((na(l), (t = l.type), a !== null && l.stateNode != null))
      ...
      case 4:
        return ja(), a === null && Gc(l.stateNode.containerInfo), za(l), null;
      case 10:
              ...
              for (a = l.child; a !== null; ) {
                if (((n = yn(a)), n !== null)) {
                  for (
                    ...
                    rs(t, a), (t = t.sibling);
                  return M(Ca, (Ca.current & 1) | 2), l.child;
                }
                a = a.sibling;
              }
            u.tail !== null &&
  ...
  function Bh(a, l) {
    ...
    for (
      Lc = { focusedElem: a, selectionRange: t }, Gn = !1, Ga = l;
      Ga !== null;
      ...
      case 13:
        ht(a, t),
          ...
          e & 64 &&
            ...
            a !== null &&
              ((a = a.dehydrated),
              a !== null && ((t = Jh.bind(null, t)), rm(a, t))));
        break;
      case 22:
        if (((e = t.memoizedState !== null || kl), !e)) {
          (l = (l !== null && l.memoizedState !== null) || Oa), (u = kl);
          var n = Oa;
          (kl = e),
            (Oa = l) && !n ? mt(a, t, (t.subtreeFlags & 8772) !== 0) : ht(a, t),
            (kl = u),
            (Oa = n);
        }
        break;
  ...
  function Jr(a, l, t) {
    ...
    switch (t.tag) {
      ...
      case 14:
      case 15:
        Oa || dt(2, t, l), Oa || dt(4, t, l), Fl(a, l, t);
        break;
      case 1:
        Oa ||
          (Rl(t, l),
      ...
      case 21:
        ...
        break;
      case 22:
        (Oa = (e = Oa) || t.memoizedState !== null), Fl(a, l, t), (Oa = e);
        break;
      default:
        Fl(a, l, t);
    }
      ...
      for (var e = 0; e < t.length; e++) {
        ...
        a: for (; c !== null; ) {
          switch (c.tag) {
            ...
            case 3:
            case 4:
              (Sa = c.stateNode.containerInfo), (nl = !0);
              break a;
          }
          c = c.return;
        }
  ...
  function mt(a, l, t) {
    for (t = t && (l.subtreeFlags & 8772) !== 0, l = l.child; l !== null; ) {
      ...
      switch (n.tag) {
        ...
        case 26:
        case 5:
          mt(u, n, t), t && e === null && i & 4 && Gr(n), ou(n, n.return);
          break;
        case 12:
          mt(u, n, t);
          break;
        case 13:
          mt(u, n, t), t && i & 4 && wr(u, n);
          break;
        case 22:
  ...
  function to() {
    Nl === 0 && (Nl = (ea & 536870912) === 0 || fa ? hf() : 536870912);
    var a = Al.current;
  ...
  function eo(a, l, t) {
    ...
    do {
      if (u === 0) {
        ...
        if (((t = a.current.alternate), n && !Qh(t))) {
          (u = Rc(a, l, !1)), (n = !1);
          continue;
        }
        if (u === 2) {
          ...
          if (i !== 0) {
            ...
            a: {
              ...
              if ((f && (Ee(c, i).flags |= 256), (i = Rc(c, i, !1)), i !== 2)) {
                if (Nc && !f) {
        ...
        a: {
          ...
          if ((l & 62914560) === l && ((u = _c + 300 - ll()), 10 < u)) {
            if ((St(e, l, Nl, !vt), qu(e, 0, !0) !== 0)) break a;
            e.timeoutHandle = Uo(
  ...
  function uo(a, l, t, e, u, n, i, c, f, y, z, T, g, b) {
    if (
      ((a.timeoutHandle = -1),
      (T = l.subtreeFlags),
      (T & 8192 || (T & 16785408) === 16785408) &&
        ((Nu = { stylesheets: null, count: 0, unsuspend: Am }),
        Fr(l),
        (T = Em()),
        T !== null))
    ) {
      (a.cancelPendingCommit = T(
        oo.bind(null, a, l, n, t, e, u, i, c, f, z, 1, g, b)
      )),
        St(a, n, i, !y);
      return;
    }
  ...
  function jc() {
    if (I !== null) {
      ...
      else (a = I), (Ll = Ct = null), wi(a), (ye = null), (cu = 0), (a = I);
        ...
        if (da !== 0 && I !== null) {
          ...
          switch (da) {
            ...
            case 6:
              Al.current === null && (l = !0);
              var y = da;
              if (((da = 0), (hl = null), Te(a, c, f, y), t && ze)) {
                i = 0;
                break a;
              }
              break;
            default:
              (y = da), (da = 0), (hl = null), Te(a, c, f, y);
          }
        }
        Zh(), (i = Aa);
        break;
  ...
  function so(a) {
    ...
    switch (l.tag) {
      case 15:
      case 0:
        l = Mr(t, l, l.pendingProps, l.type, void 0, ea);
        break;
      case 11:
        l = Mr(t, l, l.pendingProps, l.type.render, l.ref, ea);
        break;
      case 5:
        wi(l);
      default:
  ...
  function oo(a, l, t, e, u, n, i, c, f) {
    ...
    if (l !== null) {
      ...
      if (
        ...
        (e = S.T), (S.T = null), (u = j.p), (j.p = 2), (i = oa), (oa |= 4);
        try {
          Bh(a, l, t);
        } finally {
          (oa = i), (j.p = u), (S.T = e);
  ...
  function vo() {
    if (Ja === 4 || Ja === 3) {
      ...
      (l.subtreeFlags & 10256) !== 0 || (l.flags & 10256) !== 0
        ? (Ja = 5)
        : ((Ja = 0), (Ae = bt = null), yo(a, a.pendingLanes));
      ...
      if (
        ...
        try {
          La.onCommitFiberRoot(Yl, l, void 0, (l.current.flags & 128) === 128);
        } catch {}
      if (e !== null) {
  ...
  function go() {
    ...
    var t = kn(Ne),
      ...
      u = j.p;
    try {
      (j.p = 32 > t ? 32 : t), (S.T = null), (t = Dc), (Dc = null);
      var n = bt,
        i = Ne;
      if (((Ja = 0), (Ae = bt = null), (Ne = 0), (oa & 6) !== 0))
        throw Error(m(331));
      var c = oa;
      if (
        ((oa |= 4),
  ...
  function Uc(a, l, t) {
    var e = a.pingCache;
    if (e === null) {
      e = a.pingCache = new Gh();
      var u = new Set();
      e.set(l, u);
    } else (u = e.get(l)), u === void 0 && ((u = new Set()), e.set(l, u));
    u.has(t) ||
      ((Nc = !0), u.add(t), (a = Kh.bind(null, a, l, t)), l.then(a, a));
  }
  function Kh(a, l, t) {
    var e = a.pingCache;
    e !== null && e.delete(l),
      ...
      ga === a &&
        (ea & t) === t &&
        (Aa === 4 || (Aa === 3 && (ea & 62914560) === ea && 300 > ll() - _c)
          ? (oa & 2) === 0 && Ee(a, 0)
          : (Ec |= t),
        pe === ea && (pe = 0)),
      Hl(a);
  ...
  function So(a, l) {
    l === 0 && (l = mf()), (a = ie(a, l)), a !== null && (He(a, l), Hl(a));
  }
  function Jh(a) {
    var l = a.memoizedState,
      t = 0;
  ...
  function zo() {
    ...
    var a = 0;
    Vt !== 0 && (um() && (a = Vt), (Vt = 0));
    for (var l = ll(), t = null, e = Mn; e !== null; ) {
      var u = e.next,
        n = po(e, l);
      n === 0
        ? ((e.next = null),
          t === null ? (Mn = u) : (t.next = u),
          u === null && (_e = t))
        : ((t = e), (a !== 0 || (n & 3) !== 0) && (jn = !0)),
        (e = u);
    }
  ...
  function Ao(a, l) {
    ...
    if (Dn() && a.callbackNode !== t) return null;
    var e = ea;
    return (
      (e = qu(
        a,
  ...
  for (var Bc = 0; Bc < pi.length; Bc++) {
    var Yc = pi[Bc],
      Ih = Yc.toLowerCase(),
      Ph = Yc[0].toUpperCase() + Yc.slice(1);
    Tl(Ih, "on" + Ph);
  }
  Tl(es, "onAnimationEnd"),
    ...
    Tl("focusin", "onFocus"),
    Tl("focusout", "onBlur"),
    Tl(yh, "onTransitionRun"),
    Tl(gh, "onTransitionStart"),
    Tl(bh, "onTransitionCancel"),
    ...
    if (!a[xn]) {
      (a[xn] = !0),
        Sf.forEach(function (t) {
          t !== "selectionchange" && (am.has(t) || Xc(t, !1, a), Xc(t, !0, a));
        });
      var l = a.nodeType === 9 ? a : a.ownerDocument;
      l === null || l[xn] || ((l[xn] = !0), Xc("selectionchange", !1, l));
    }
  }
  function Oo(a, l, t, e) {
    switch (Fo(l)) {
          ...
          for (var o = y, v; o !== null; ) {
            ...
            if (
              ...
              (A !== 5 && A !== 26 && A !== 27) ||
                v === null ||
                h === null ||
                ((A = Be(o, h)), A != null && V.push(Su(o, A, v))),
              va)
            )
              break;
            o = o.return;
...
`
    ...
    switch (l) {
      ...
      default:
        if (ui(l)) {
          for (z in t)
            t.hasOwnProperty(z) &&
              ((e = t[z]), e !== void 0 && Zc(a, l, z, e, t, void 0));
          return;
        }
    }
    for (c in t)
      t.hasOwnProperty(c) && ((e = t[c]), e != null && ma(a, l, c, e, t, null));
  }
  function em(a, l, t, e) {
    switch (l) {
      case "div":
  ...
  var Uo = typeof setTimeout == "function" ? setTimeout : void 0,
    ...
    im =
      typeof queueMicrotask == "function"
        ...
        : typeof Ho < "u"
        ? function (a) {
            return Ho.resolve(null).then(a).catch(cm);
          }
        : Uo;
  function cm(a) {
    setTimeout(function () {
  ...
  var Pl = j.d;
  j.d = { f: om, r: dm, D: hm, C: mm, L: vm, m: ym, X: bm, S: gm, M: Sm };
  function om() {
    var a = Pl.f(),
      l = _n();
    return a || l;
  ...
  function Jo(a, l, t, e, u, n, i, c, f, y, z, T) {
    return (
      (a = new _m(a, l, t, i, c, f, y, T)),
      (l = 1),
      n === !0 && (l |= 24),
      (n = rl(3, null, null, l)),
      (a.current = n),
  ...
  function af(a, l, t, e) {
    if (Gn) {
      ...
      else if (jm(u, a, l, t, e)) e.stopPropagation();
      else if ((Io(a, e), l & 4 && -1 < Mm.indexOf(a))) {
        for (; u !== null; ) {
          var n = $t(u);
          if (n !== null)
            switch (n.tag) {
  ...
  function Vn(a, l) {
    a.blockedOn === l &&
      ...
      ef ||
        ((ef = !0),
        D.unstable_scheduleCallback(D.unstable_NormalPriority, xm)));
  }
  var Ln = null;
  function ld(a) {
    Ln !== a &&
...
function Zm() {
  ...
  return D(), (ff.exports = Qm()), ff.exports;
}
var Vm = Zm();
const wn = {
  Fuerza: "Fuerza",
  ...
  for (const m of J) {
    ...
    if (p && C) {
      const k = parseInt(p[1], 10),
        ...
        Na = parseInt(C[1], 10),
        $a = parseInt(C[2], 10),
        Da = C[3] ? parseInt(C[3], 10) : 0;
      if (la === $a) {
        const ua = k + Na,
          Ea = ca + Da;
        B[aa] = `${ua}D${la}${Ea !== 0 ? (Ea > 0 ? "+" : "") + Ea : ""}`;
      } else {
        const ua = q.trim(),
          Ea = G.trim().replace(/^\+/, "");
        ua.includes(Ea) || (B[aa] = `${ua}+${Ea}`);
      }
      continue;
    }
    if (p && /^[+-]?\d+D$/.test(G)) {
      const k = parseInt(p[1], 10),
        la = parseInt(p[2], 10),
        ca = p[3] ? parseInt(p[3], 10) : 0,
        Na = parseInt(G.replace("D", ""), 10);
      B[aa] = `${k + Na}D${la}${ca !== 0 ? (ca > 0 ? "+" : "") + ca : ""}`;
      continue;
    }
    if (p && /^[+-]?\d+$/.test(G)) {
      const k = parseInt(p[1], 10),
...
function hd(D, J, B) {
  for (const m of B)
    if (m.caracteristica === D && m.tipo === "MAX" && J > m.valor)
      return {
        valido: !1,
        mensaje: `El valor máximo para ${D} es ${m.valor}`,
        valorCorregido: m.valor,
      };
  return { valido: !0 };
}
function Jm(D) {
  return !D?.variacion_caracMINMAX || D.variacion_caracMINMAX.length === 0
    ? []
    : gd(D.variacion_caracMINMAX);
}
const md = {
...
function $m() {
  const D = () =>
                ...
                ta.variacion_caracteristicas &&
                  ...
                  s.jsxs("div", {
                    ...
                    children: [
                      ...
                      s.jsx("div", {
                        className: "raza-list",
                        children: ta.variacion_caracteristicas.map((d, N) =>
                          s.jsx(
                            "div",
                            {
        ...
        ? s.jsx("div", {
            ...
            children: s.jsxs("div", {
              ...
              children: [
                s.jsxs("h3", {
                  className: "raza-title",
                  children: ["Origen: ", ua.nombre],
                }),
                ua.info_Origen &&
                  ua.info_Origen.trim() !== "" &&
                  s.jsx("p", {
                    className: "raza-description",
                    children: ua.info_Origen,
                  }),
                s.jsx("hr", { className: "raza-divider" }),
                ua.variacion_habilidades &&
                  ua.variacion_habilidades.length > 0 &&
                  s.jsxs("div", {
                    className: "raza-section",
                    children: [
                      s.jsx("h4", {
                      ...
                      s.jsx("div", {
                        className: "raza-list",
                        children: ua.variacion_habilidades.map((d, N) =>
                          s.jsxs(
                            "div",
                            {
                              className: "raza-list-item",
                ...
                ua.variacion_bonus_combate &&
                  Object.keys(ua.variacion_bonus_combate).length > 0 &&
                  s.jsxs("div", {
                    className: "raza-section",
                    children: [
                      s.jsx("h4", {
    ...
    [ca, Na] = Ha.useState([]),
    [$a, Da] = Ha.useState([]),
    [ua, Ea] = Ha.useState(null),
    [w, cl] = Ha.useState(null),
    [O, Wa] = Ha.useState(null),
    [ta, Za] = Ha.useState(null);
  Ha.useEffect(() => {
    if (!ta) {
      Da(ca);
      return;
    ...
    const N = ca.filter((E) => d.includes(E.nombre.trim().toUpperCase()));
    Da(N);
  }, [ta, ca]);
  const [Ba, ql] = Ha.useState(null),
    [Ma, ba] = Ha.useState({}),
    [Dl, Cl] = Ha.useState(!0),
    [Ta, S] = Ha.useState([]),
    j = (d, N) => {
      const E = parseInt(N, 10);
      if (!isNaN(E) && Ta.length > 0) {
        const X = hd(d, E, Ta);
  ...
  function Z(d) {
    ...
    for (; (X = E.exec(d)) !== null; ) {
      const ra = parseInt(X[1], 10),
        na = parseInt(X[2], 10),
        ka = Math.sign(ra);
      for (let Va = 0; Va < Math.abs(ra); Va++) {
        let xa = Math.floor(Math.random() * na) + 1;
        Dl && xa < 2 && (xa = 2), (N += ka * xa);
      }
    }
    const Q = /([+-]\d+)(?!D)/g;
    let ja;
    for (; (ja = Q.exec(d)) !== null; ) N += parseInt(ja[1], 10);
    return N;
  }
  const sa = () => {
      if (
        !Ba ||
        (Object.values(Ma).some((Bl) => Bl && Bl.trim() !== "") &&
          !window.confirm(
      ...
      Object.entries(Ba).forEach(([Bl, Ru]) => {
        if (typeof Ru == "string") {
          let Yl = Z(Ru);
          if (Ta.length > 0) {
            const La = hd(Bl, Yl, Ta);
            !La.valido &&
              La.valorCorregido !== void 0 &&
              (Yl = La.valorCorregido);
          }
          d[Bl] = Yl.toString();
        }
      }),
        ba(d);
      const N = parseInt(d.Fuerza || "0", 10);
      let E = "";
      N >= 18 && N <= 23
        ? (E = "+1")
        : N >= 24 && N <= 30
      ...
      O &&
        ...
        (Q >= 0 && Q <= 24
          ...
          ? (ja = "+2D4")
          : Q >= 53 && (ja = "2D4+1"));
      const na = parseInt(d.Inteligencia || "0", 10),
        ka = parseInt(d.Constitución || "0", 10),
        Va = parseInt(d.Poder || "0", 10),
        xa = parseInt(d.Carisma || "0", 10),
        Ml = parseInt(d.Tamaño || "0", 10);
      let at = 0;
      na >= 1 && na <= 10
        ? (at = na)
        : na >= 11 && na <= 18
        ...
        : na >= 19 && (at = na + 30);
      const ll = na + X + 10,
        xe = Math.floor(ka / 2) + na + Va + xa - 5,
        Lt = X * 2 + na + Va - Ml - 5,
        Kt = na * 2 + X + xa - 15,
        lt = na + Math.floor(N / 2) + Va + X - Ml - 5,
        Re = Va + xa + na + 40 - ka,
        xu = Math.max(1, ka + Ml - 12);
      G({
        bonusCC: `Bonus de Fuerza CC: ${E}`,
    ...
    _ = () =>
      O
                    ...
                    O.variacion_caracteristicas &&
                      ...
                      s.jsxs("div", {
                        ...
                        children: [
                          ...
                          s.jsx("div", {
                            className: "raza-list",
                            children: O.variacion_caracteristicas.map((d, N) =>
                              s.jsx(
                                "div",
                                {
                                  className: "raza-list-item",
                    ...
                    O.variacion_caracMINMAX &&
                      ...
                      s.jsxs("div", {
                        ...
                        children: [
                          ...
                          s.jsx("div", {
                            className: "raza-list",
                            children: O.variacion_caracMINMAX.map((d, N) =>
                              s.jsxs(
                                "div",
                                {
                                  className: "raza-list-item",
                    ...
                    O.variacion_habilidades &&
                      ...
                      s.jsxs("div", {
                        ...
                        children: [
                          ...
                          s.jsx("div", {
                            className: "raza-list",
                            children: O.variacion_habilidades.map((d, N) =>
                              s.jsxs(
                                "div",
                                {
                                  className: "raza-list-item",
        ...
        : null,
    R = () => {
      if (!w && !O && !ua) return null;
      const d = {};
      return (
        w &&
          Object.entries(w.bonificaciones).forEach(([N, E]) => {
            if (typeof E == "number") d[N] = (d[N] || 0) + E;
            else if (typeof E == "string") {
              const X = parseInt(E.replace(/[+-]/g, "")) || 0,
                Q = E.startsWith("-") ? -1 : 1;
              d[N] = (d[N] || 0) + X * Q;
            }
          }),
        O &&
          O.variacion_habilidades &&
          O.variacion_habilidades.forEach((N) => {
            const E = N.trim();
            if (
              E.includes("Regeneración de SM") ||
              E.includes("al día") ||
              E.includes("1D6") ||
              E === ""
            )
            ...
            if (E.includes("100%") || E.includes("+100")) {
              const Q = E.replace(/(\+100|100\s*%).*$/, "").trim();
              Q && (d[Q] = 100);
            }
          }),
        ua &&
          ua.variacion_habilidades &&
          ua.variacion_habilidades.forEach((N) => {
            const E = N.trim();
            if (
              E.includes("Regeneración de SM") ||
              E.includes("al día") ||
        ...
        : s.jsxs("div", {
            ...
            children: [
              ...
              s.jsx("ul", {
                ...
                children: Object.entries(d).map(([N, E]) =>
                  s.jsxs(
                    "li",
                    {
  ...
  return (
    ...
    Ha.useEffect(() => {
      if ((ba({}), w)) {
        ...
        ta &&
          ta.variacion_caracteristicas &&
          (d = yd(d, ta.variacion_caracteristicas)),
          ql(d);
      } else ql(null);
    }, [w, O, ta]),
    Ha.useEffect(() => {
        ...
        s.jsxs("div", {
          ...
          children: [
            ...
            s.jsxs("select", {
              ...
              value: w?.nombre || "",
              onChange: (d) => {
                const N = aa.find((E) => E.nombre === d.target.value);
                cl(N || null),
                  x(),
                  G(null),
                  Za(null),
        ...
        s.jsxs("div", {
          ...
          children: [
            ...
            s.jsxs("select", {
              ...
              value: O?.nombre || "",
              onChange: (d) => {
                const N = p.find((E) => E.nombre === d.target.value);
                Wa(N || null),
                  ba({}),
                  G(null),
                  Za(null),
            ...
            s.jsxs("div", {
              ...
              children: [
                s.jsxs("select", {
                  ...
                  value: ta?.nombre || "",
                  onChange: (d) => {
                    const N = k.find((E) => E.nombre === d.target.value);
                    Za(N || null), ba({}), G(null), Ea(null), x();
                  },
                  disabled: !w,
                  children: [
                    s.jsx("option", {
            ...
            s.jsxs("div", {
              ...
              children: [
                s.jsxs("select", {
                  ...
                  value: ua?.nombre || "",
                  onChange: (d) => {
                    const N = $a.find((E) => E.nombre === d.target.value);
                    Ea(N || null), ba({}), G(null), x();
                  },
                  disabled: !ta,
                  children: [
        ...
        Ba &&
          s.jsxs("div", {
            ...
            children: [
              ...
              s.jsx("ul", {
                className: "ficha-resultado-list",
                children: Object.entries(Ba).map(([d, N]) =>
                  s.jsxs(
                    "li",
                    {
                      className: "ficha-resultado-item",
                ...
                children: [
                  ...
                  s.jsx("button", {
                    ...
                    disabled:
                      ...
                      Object.entries(Ba || {}).some(([d]) => !Ma[d]),
                    onClick: () => {
                      const d = parseInt(Ma.Fuerza || "0", 10);
                      let N = "";
                      d >= 18 && d <= 23
                        ? (N = "+1")
                        : d >= 24 && d <= 30
                        ...
                        ? (N = "+2D6")
                        : (N = "Sin bonus");
                      const E = parseInt(Ma.Destreza || "0", 10),
                        X = d + E;
                      let Q = "NO TIENE";
                      O &&
                        [
                        ...
                        (X >= 0 && X <= 24
                          ...
                          ? (Q = "+2D4")
                          : X >= 53 && (Q = "2D4+1"));
                      const ra = parseInt(Ma.Inteligencia || "0", 10),
                        na = parseInt(Ma.Constitución || "0", 10),
                        ka = parseInt(Ma.Poder || "0", 10),
                        Va = parseInt(Ma.Carisma || "0", 10),
                        xa = parseInt(Ma.Tamaño || "0", 10);
                      let Ml = 0;
                      ra >= 1 && ra <= 10
                        ? (Ml = ra)
                        : ra >= 11 && ra <= 18
                        ...
                        : ra >= 19 && (Ml = ra + 30);
                      const at = ra + E + 10,
                        ll = Math.floor(na / 2) + ra + ka + Va - 5,
                        xe = E * 2 + ra + ka - xa - 5,
                        Lt = ra * 2 + E + Va - 15,
                        Kt = ra + Math.floor(d / 2) + ka + E - xa - 5,
                        lt = ka + Va + ra + 40 - na;
                      G({
                        ...
                        discrecion: Kt,
                        saludMental: lt,
                        puntosVida: Math.max(1, na + xa - 12),
                      });
                    },
                        ...
                        children: (() => {
                          ...
                          function E(ra, na) {
                            ...
                            return (typeof ra == "string" &&
                              ra.includes("%")) ||
                              (typeof na == "string" && na.includes("%"))
                              ? `${xa > 0 ? "+" : ""}${xa}%`
                              : `${xa > 0 ? "+" : ""}${xa}`;
                          }
                          const X = E(
                              d && "ataque" in d ? d.ataque : void 0,
                              N && "ataque" in N ? N.ataque : void 0
                            ),
                            Q = E(
                              d && "defensa" in d ? d.defensa : void 0,
                              N && "defensa" in N ? N.defensa : void 0
                            ),
                            ja = E(
                              d && "armas_arrojadizas" in d
                                ? d.armas_arrojadizas
                                : void 0,
                              N && "armas_arrojadizas" in N
                                ? N.armas_arrojadizas
                                : void 0
                            );
