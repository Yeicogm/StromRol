...
function qm() {
  ...
  function B(m, x, U) {
    ...
    return (
      (x = U.ref),
      { $$typeof: M, type: m, key: Q, ref: x !== void 0 ? x : null, props: U }
    );
  }
...
function Bm() {
  ...
  var w = (Ha.prototype = new ia());
  (w.constructor = Ha), Ea(w, Oa.prototype), (w.isPureReactComponent = !0);
  ...
  function Na(r, _, R, D, d) {
    ...
    if (N)
      return (
        ...
        il(d)
          ? ((R = ""),
            N != null && (R = N.replace(Ma, "$&/") + "/"),
            Na(d, _, R, "", function (Da) {
              return Da;
            }))
          : d != null &&
            (Ba(d) &&
    ...
    if (il(r))
      for (var G = 0; G < r.length; G++)
        (D = r[G]), (A = X + Sa(D, G)), (N += Na(D, _, R, A, d));
    else if (((G = la(r)), typeof G == "function"))
      for (r = G.call(r), G = 0; !(D = r.next()).done; )
        (D = D.value), (A = X + Sa(D, G++)), (N += Na(D, _, R, A, d));
    else if (A === "object") {
  ...
  return (
    ...
    ($.cloneElement = function (r, _, R) {
      ...
      if (N === 1) D.children = R;
        ...
        for (var X = Array(N), G = 0; G < N; G++) X[G] = arguments[G + 2];
        D.children = X;
      }
...
` +
  ...
  function Os(a) {
    ...
    if (((st = 0), (xa = ha = W = null), (nn = !1), (eu = 0), (me = null), l))
      throw Error(m(300));
    a === null ||
      Xa ||
  ...
  function Ms(a, l, t, e) {
    ...
    do {
      if ((he && (me = null), (eu = 0), (he = !1), 25 <= u))
        throw Error(m(301));
      if (((u += 1), (xa = ha = null), a.updateQueue != null)) {
        var n = a.updateQueue;
        (n.lastEffect = null),
          (n.events = null),
          (n.stores = null),
  ...
  function wc(a) {
    ...
    (st = 0), (xa = ha = W = null), (he = !1), (eu = cn = 0), (me = null);
  }
  function ul() {
    var a = {
      memoizedState: null,
    ...
    return xa === null ? (W.memoizedState = xa = a) : (xa = xa.next = a), xa;
  }
  function Ra() {
    if (ha === null) {
      var a = W.alternate;
    ...
    var l = xa === null ? W.memoizedState : xa.next;
    if (l !== null) (xa = l), (ha = a);
    else {
      if (a === null)
      ...
      (ha = a),
        ...
        xa === null ? (W.memoizedState = xa = a) : (xa = xa.next = a);
    }
    return xa;
  }
  function $c() {
  ...
  function uu(a) {
    ...
    return (
      ...
      (a = ps(me, a, l)),
      (l = W),
      (xa === null ? l.memoizedState : xa.next) === null &&
        ((l = l.alternate),
  ...
  function Ds(a, l, t) {
    ...
    if (
      (nu(2048, 8, i, [a]),
      u.getSnapshot !== l || c || (xa !== null && xa.memoizedState.tag & 1))
    ) {
      if (
        ((e.flags |= 2048),
  ...
  function dr(a) {
    ...
    function g(h, o, v, E) {
      ...
      if (typeof v == "object" && v !== null) {
        ...
        if (Na(v) || Sa(v)) return H !== null ? null : z(h, o, v, E, null);
    ...
    function b(h, o, v, E, H) {
      ...
      if (typeof E == "object" && E !== null) {
        ...
        if (Na(E) || Sa(E)) return (h = h.get(v) || null), z(o, h, E, H, null);
    ...
    function va(h, o, v, E) {
      if (
        ...
        if (Sa(v)) {
          if (((H = Sa(v)), typeof H != "function")) throw Error(m(150));
  ...
  function qh(a, l, t) {
    switch (l.tag) {
      case 3:
        G(l, l.stateNode.containerInfo), nt(l, qa, a.memoizedState.cache), we();
        break;
      case 27:
      case 5:
        ra(l);
  ...
  function qr(a, l, t) {
    ...
    switch (((l.lanes = 0), l.tag)) {
      ...
      case 3:
        a: {
          if ((G(l, l.stateNode.containerInfo), a === null))
            throw Error(m(387));
          e = l.pendingProps;
  ...
  function Ch(a, l, t) {
    ...
    switch ((Mc(l), l.tag)) {
      ...
      case 4:
        return Da(), a === null && Gi(l.stateNode.containerInfo), za(l), null;
      case 10:
      ...
      for (var e = 0; e < t.length; e++) {
        ...
        a: for (; i !== null; ) {
          switch (i.tag) {
            ...
            case 3:
            case 4:
              (ba = i.stateNode.containerInfo), (nl = !0);
              break a;
          }
          i = i.return;
        }
        if (ba === null) throw Error(m(160));
        Jr(n, c, u),
          (ba = null),
          (nl = !1),
          (n = u.alternate),
  ...
  for (const m of J) {
    ...
    if (p && C) {
      ...
      if (la === wa) {
        const ia = k + Ea,
          Ha = ca + Oa;
        B[aa] = `${ia}D${la}${Ha !== 0 ? (Ha > 0 ? "+" : "") + Ha : ""}`;
      } else {
        const ia = q.trim(),
          Ha = Q.trim().replace(/^\+/, "");
        ia.includes(Ha) || (B[aa] = `${ia}+${Ha}`);
      }
      continue;
    }
    if (p && /^[+-]?\d+D$/.test(Q)) {
  ...
  for (const B of M) {
    ...
    if (m) {
      ...
      if (U) {
        ...
        J.push({ caracteristica: U, tipo: "MIN", valor: 0, dados: Q });
      }
      continue;
    }
    ...
    if (x) {
      ...
      if (U) {
        ...
        J.push({ caracteristica: U, tipo: "MAX", valor: Q });
      }
    }
  }
  return J;
...
function $m() {
  const M = () =>
    ...
    [U, Q] = Ua.useState(null),
    [aa, q] = Ua.useState([]),
    [p, C] = Ua.useState([]),
    [k, la] = Ua.useState([]),
    [ca, Ea] = Ua.useState([]),
    [wa, Oa] = Ua.useState([]),
    [ia, Ha] = Ua.useState(null),
    [w, il] = Ua.useState(null),
    [O, $a] = Ua.useState(null),
    [ta, Wa] = Ua.useState(null);
  Ua.useEffect(() => {
    if (!ta) {
      Oa(ca);
      return;
    ...
    j = (d, A) => {
      ...
      if (!isNaN(N) && Na.length > 0) {
        ...
        if (!X.valido && X.valorCorregido !== void 0) {
          Sa((G) => ({ ...G, [d]: X.valorCorregido.toString() }));
          return;
        }
      }
      Sa((X) => ({ ...X, [d]: A }));
  ...
  function Z(d) {
    ...
    for (; (X = N.exec(d)) !== null; ) {
      ...
      for (let Za = 0; Za < Math.abs(ra); Za++) {
        let ja = Math.floor(Math.random() * ua) + 1;
        Dl && ja < 2 && (ja = 2), (A += ka * ja);
      }
    }
    const G = /([+-]\d+)(?!D)/g;
    let Da;
    for (; (Da = G.exec(d)) !== null; ) A += parseInt(Da[1], 10);
    return A;
  }
  const sa = () => {
      if (
        ...
        O &&
          ...
          O.variacion_habilidades.forEach((A) => {
            ...
            if (N.includes("100%") || N.includes("+100")) {
              const G = N.replace(/(\+100|100\s*%).*$/, "").trim();
              G && (d[G] = 100);
            }
          }),
        ia &&
          ...
          children: [
            ...
            s.jsxs("select", {
              ...
              onChange: (d) => {
                ...
                $a(A || null), Sa({}), Q(null), Wa(null), Ha(null), x();
              },
              disabled: !!(
                w &&
                ["SELOROK", "DEMONIOS", "DEMONIO", "SELEROK"].includes(
                  ...
                  s.jsx("button", {
                    ...
                    onClick: () => {
                      ...
                      d >= 18 && d <= 23
                        ...
                        ? (A = "+2D6")
                        : (A = "Sin bonus");
                      const N = parseInt(Ma.Destreza || "0", 10),
                        X = d + N;
                      let G = "NO TIENE";
                      O &&
                        [
                      ...
                      const ra = parseInt(Ma.Inteligencia || "0", 10),
                        ua = parseInt(Ma.Constitución || "0", 10),
                        ka = parseInt(Ma.Poder || "0", 10),
                        Za = parseInt(Ma.Carisma || "0", 10),
                        ja = parseInt(Ma.Tamaño || "0", 10);
                      let jl = 0;
                      ra >= 1 && ra <= 10
                        ? (jl = ra)
                        : ra >= 11 && ra <= 18
                      ...
                      const at = ra + N + 10,
                        ...
                        xe = N * 2 + ra + ka - ja - 5,
                        Lt = ra * 2 + N + Za - 15,
                        Kt = ra + Math.floor(d / 2) + ka + N - ja - 5,
                        lt = ka + Za + ra + 40 - ua;
                      Q({
                        bonusCC: `Bonus de Fuerza CC: ${A}`,
                        bonusAA: `Bonus de Fuerza AA: ${G}`,
                        conocimiento: jl,
                        percepcion: at,
                        comunicacion: ll,
                        agilidad: xe,
                        ...
                        discrecion: Kt,
                        saludMental: lt,
                        puntosVida: Math.max(1, ua + ja - 12),
                      });
                    },
...
Lm.createRoot(document.getElementById("root")).render(
  s.jsx(Ua.StrictMode, { children: s.jsx($m, {}) })
);
