...
function Uh() {
  ...
  function Q(m, x, L) {
    ...
    return (
      (x = L.ref),
      { $$typeof: _, type: m, key: J, ref: x !== void 0 ? x : null, props: L }
    );
  }
  return (gu.Fragment = tl), (gu.jsx = Q), (gu.jsxs = Q), gu;
}
var kd;
function xh() {
...
function jh() {
  ...
  function Kl(s, T, M, D, B, P) {
    return (
      (M = P.ref),
      { $$typeof: _, type: s, key: T, ref: M !== void 0 ? M : null, props: P }
    );
  }
  function Jl(s, T) {
  ...
  function ll(s, T, M, D, B) {
        ...
        case "object":
          switch (s.$$typeof) {
            ...
            case tl:
              ...
              break;
            case R:
              return (Z = s._init), ll(Z(s._payload), T, M, D, B);
          }
      }
    if (Z)
      return (
    ...
    if (la(s))
      for (var yl = 0; yl < s.length; yl++)
        (D = s[yl]), (P = Bl + w(D, yl)), (Z += ll(D, T, M, P, B));
    else if (((yl = K(s)), typeof yl == "function"))
      for (s = yl.call(s), yl = 0; !(D = s.next()).done; )
        (D = D.value), (P = Bl + w(D, yl++)), (Z += ll(D, T, M, P, B));
    else if (P === "object") {
      if (typeof s.then == "function") return ll(Xl(s), T, M, D, B);
      throw (
        ((T = String(s)),
        Error(
  ...
  return (
    ...
    ($.StrictMode = m),
    ($.Suspense = j),
    ($.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = ul),
    ($.__COMPILER_RUNTIME = {
      __proto__: null,
      c: function (s) {
    ...
    ($.cloneElement = function (s, T, M) {
      ...
      var D = Nl({}, s.props),
        ...
        P = void 0;
      if (T != null)
        for (Z in (T.ref !== void 0 && (P = void 0),
      ...
      return Kl(s.type, B, void 0, void 0, P, D);
    }),
    ...
    ($.createElement = function (s, T, M) {
      var D,
        ...
        P = null;
      if (T != null)
        for (D in (T.key !== void 0 && (P = "" + T.key), T))
          Ll.call(T, D) &&
            D !== "key" &&
            D !== "__self" &&
            D !== "__source" &&
      ...
      return Kl(s, P, void 0, void 0, null, B);
    }),
    ($.createRef = function () {
      return { current: null };
    }),
    ...
    ($.useActionState = function (s, T, M) {
      return ul.H.useActionState(s, T, M);
    }),
    ($.useCallback = function (s, T) {
      return ul.H.useCallback(s, T);
    }),
    ...
    ($.useDeferredValue = function (s, T) {
      return ul.H.useDeferredValue(s, T);
    }),
    ...
    ($.useImperativeHandle = function (s, T, M) {
      return ul.H.useImperativeHandle(s, T, M);
    }),
    ($.useInsertionEffect = function (s, T) {
      return ul.H.useInsertionEffect(s, T);
    }),
    ($.useLayoutEffect = function (s, T) {
      return ul.H.useLayoutEffect(s, T);
    }),
    ($.useMemo = function (s, T) {
      return ul.H.useMemo(s, T);
    }),
    ($.useOptimistic = function (s, T) {
      return ul.H.useOptimistic(s, T);
    }),
    ($.useReducer = function (s, T, M) {
      return ul.H.useReducer(s, T, M);
    }),
    ($.useRef = function (s) {
    ...
    ($.useSyncExternalStore = function (s, T, M) {
      return ul.H.useSyncExternalStore(s, T, M);
    }),
    ...
    Pd ||
      ...
      (function (_) {
        ...
        function m(S) {
          ...
          if (H !== N) {
            S[0] = H;
            l: for (var al = 0, s = S.length, T = s >>> 1; al < T; ) {
              var M = 2 * (al + 1) - 1,
                D = S[M],
                B = M + 1,
                P = S[B];
              if (0 > x(D, H))
                B < s && 0 > x(P, D)
                  ? ((S[al] = P), (S[B] = H), (al = B))
                  : ((S[al] = D), (S[M] = H), (al = M));
              else if (B < s && 0 > x(P, H)) (S[al] = P), (S[B] = H), (al = B);
              else break l;
            }
          }
          return N;
        ...
        function la(S) {
          for (var N = Q(b); N !== null; ) {
            if (N.callback === null) m(b);
              ...
              m(b), (N.sortIndex = N.expirationTime), tl(j, N);
            else break;
            N = Q(b);
          }
        }
        function ul(S) {
          if (((zl = !1), la(S), !Nl))
            if (Q(j) !== null) (Nl = !0), Ll || ((Ll = !0), w());
            else {
              var N = Q(b);
              N !== null && ll(ul, N.startTime - S);
            }
        }
        var Ll = !1,
          Kl = -1,
                ...
                try {
                  a: {
                    ...
                    if (O !== null) N = !0;
                      ...
                      var T = Q(b);
                      T !== null && ll(ul, T.startTime - S), (N = !1);
                    }
                  }
                  break l;
                } finally {
        ...
        (_.unstable_IdlePriority = 5),
          ...
          (_.unstable_scheduleCallback = function (S, N, H) {
            var al = _.unstable_now();
            switch (
              (typeof H == "object" && H !== null
                ? ((H = H.delay),
                  (H = typeof H == "number" && 0 < H ? al + H : al))
                : (H = al),
              S)
            ) {
              case 1:
            ...
            return (
              ...
              H > al
                ? ((S.sortIndex = H),
                  ...
                  Q(j) === null &&
                    S === Q(b) &&
                    (zl ? (za(Kl), (Kl = -1)) : (zl = !0), ll(ul, H - al)))
                : ((S.sortIndex = s),
                  tl(j, S),
                  Nl || el || ((Nl = !0), Ll || ((Ll = !0), w()))),
              S
            );
          }),
...
function Yh() {
  ...
  var ll = Array.isArray,
    S = tl.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
  ...
  var B = T(null),
    ...
    Bl = T(null);
  function yl(l, a) {
    switch ((D(Z, a), D(P, l), D(B, null), a.nodeType)) {
      case 9:
      case 11:
...
` +
  ...
  function Yu(l, a, t, e, u, n) {
    ...
    if (((e = l), typeof l == "function")) mc(l) && (c = 1);
      ...
      l: switch (l) {
        ...
        case ul:
          return (l = ua(13, t, a, u)), (l.elementType = ul), (l.lanes = n), l;
        case Ll:
  ...
  function zs(l) {
    ...
    if (((Pa = 0), (Ol = ol = W = null), (wu = !1), (Ke = 0), (ee = null), a))
      throw Error(m(300));
    l === null ||
      jl ||
  ...
  function Cc(l) {
    ...
    (Pa = 0), (Ol = ol = W = null), (te = !1), (Ke = $u = 0), (ee = null);
  }
  function Fl() {
    var l = {
      memoizedState: null,
  ...
  function nr(l) {
    ...
    function y(d, r, o, E) {
      ...
      if (typeof o == "object" && o !== null) {
        ...
        if (ll(o) || w(o)) return U !== null ? null : z(d, r, o, E, null);
    ...
    function g(d, r, o, E, U) {
      ...
      if (typeof E == "object" && E !== null) {
        ...
        if (ll(E) || w(E)) return (d = d.get(o) || null), z(r, d, E, U, null);
    ...
    function V(d, r, o, E) {
      for (
        var U = null, k = null, q = r, X = (r = 0), ql = null;
        q !== null && X < o.length;
        X++
      ) {
        q.index > X ? ((ql = q), (q = null)) : (ql = q.sibling);
        var cl = y(d, q, o[X], E);
        if (cl === null) {
          q === null && (q = ql);
          break;
        }
        l && q && cl.alternate === null && a(d, q),
          (r = n(cl, r, X)),
          k === null ? (U = cl) : (k.sibling = cl),
          (k = cl),
          (q = ql);
      }
      if (X === o.length) return t(d, q), fl && Tt(d, X), U;
      if (q === null) {
        for (; X < o.length; X++)
          (q = A(d, o[X], E)),
            q !== null &&
      ...
      for (q = e(q); X < o.length; X++)
        (ql = g(q, d, X, o[X], E)),
          ql !== null &&
            (l &&
              ql.alternate !== null &&
              q.delete(ql.key === null ? X : ql.key),
            (r = n(ql, r, X)),
            k === null ? (U = ql) : (k.sibling = ql),
            (k = ql));
      return (
        l &&
    ...
    function G(d, r, o, E) {
      ...
      for (
        var U = null, k = null, q = r, X = (r = 0), ql = null, cl = o.next();
        q !== null && !cl.done;
        X++, cl = o.next()
      ) {
        q.index > X ? ((ql = q), (q = null)) : (ql = q.sibling);
        var vt = y(d, q, cl.value, E);
        if (vt === null) {
          q === null && (q = ql);
          break;
        }
      ...
      if (cl.done) return t(d, q), fl && Tt(d, X), U;
      if (q === null) {
        for (; !cl.done; X++, cl = o.next())
          (cl = A(d, cl.value, E)),
            cl !== null &&
              ((r = n(cl, r, X)),
              k === null ? (U = cl) : (k.sibling = cl),
      ...
      for (q = e(q); !cl.done; X++, cl = o.next())
        (cl = g(q, d, X, cl.value, E)),
          cl !== null &&
            (l &&
              cl.alternate !== null &&
              q.delete(cl.key === null ? X : cl.key),
            (r = n(cl, r, X)),
            k === null ? (U = cl) : (k.sibling = cl),
            (k = cl));
      return (
    ...
    if (a.type !== "stylesheet" || (a.state.loading & 4) !== 0)
      ...
      if (
        ...
        a !== null &&
          ((nl & 4194048) === nl
            ? Da !== null
            : ((nl & 62914560) !== nl && (nl & 536870912) === 0) || a !== Da))
      )
        throw ((Qe = Oc), os);
      l.flags |= 8192;
    }
  ...
  function Wr() {
    ga === 0 && (ga = (nl & 536870912) === 0 || fl ? nf() : 536870912);
    var l = ya.current;
      ...
      a === Xe || a === Lu
        ...
        : (rl =
            a === yr
              ...
              : 1),
      (ia = a),
      F === null && ((Al = 1), nn(l, oa(a, l.current)));
  }
  function Pr() {
    var l = S.H;
  ...
  function Ei() {
    (Al = 4),
      nt || ((nl & 4194048) !== nl && ya.current !== null) || (se = !0),
  ...
  function td(l) {
    ...
    switch (a.tag) {
      case 15:
      case 0:
        a = Ar(t, a, a.pendingProps, a.type, void 0, nl);
        break;
      case 11:
        a = Ar(t, a, a.pendingProps, a.type.render, a.ref, nl);
        break;
      case 5:
        Cc(a);
      default:
  ...
  function me(l, a, t, e) {
    ...
    try {
      if (R0(l, u, a, t, nl)) {
        (Al = 1), nn(l, oa(t, l.current)), (F = null);
        return;
      }
    } catch (n) {
              ...
              if ((z === void 0 && (z = h), "selectionStart" in i))
                ...
                if (y.getSelection) {
                  var g = y.getSelection(),
                    ...
                    G = Math.min(f.start, V),
                    ml = f.end === void 0 ? G : Math.min(f.end, V);
  ...
  function Z0(l, a, t) {
    ...
    e !== null && e.delete(a),
      ...
      gl === l &&
        (nl & t) === t &&
        (Al === 4 || (Al === 3 && (nl & 62914560) === nl && 300 > Na() - yi)
          ? (sl & 2) === 0 && he(l, 0)
          : (mi |= t),
        re === nl && (re = 0)),
      Ra(l);
    ...
    Of(function () {
      ...
      l: {
        ...
        if (y !== void 0) {
          ...
          0 < G.length &&
            ((y = new g(y, V, null, t, z)), A.push({ event: y, listeners: G }));
        }
      }
      if ((a & 7) === 0) {
        l: {
          ...
          if (
            ...
            if (
              ...
              a: {
                for (G = g, d = V, r = 0, o = G; o; o = ye(o)) r++;
...
function Qh(_, tl) {
  if (!tl || tl.length === 0) return _;
  const Q = { ..._ };
  for (const m of tl) {
    let x = m.match(/^(\w+)\s*([+-]?\d+D\d+|[+-]?\d+D|[+-]?\d+)$/i);
    if (
      !x &&
      ((x = m.match(/^([+-]?\d+D\d+|[+-]?\d+D|[+-]?\d+)\s+(\w+)$/i)), x)
    ) {
      const R = x[1];
      (x[1] = x[2]), (x[2] = R);
    }
    ...
    if (b) {
      ...
      if (/^[+-]?\d+D$/.test(J)) {
        const el = parseInt(J.replace("D", ""), 10);
        (R += el),
          (Q[il] = `${R}D${O}${K !== 0 ? (K > 0 ? "+" : "") + K : ""}`);
      } else if (/^[+-]?\d+D\d+$/.test(J)) {
        const el = J.match(/([+-]?\d+)D(\d+)/);
        el && ((R += parseInt(el[1], 10)), (O = parseInt(el[2], 10))),
          (Q[il] = `${R}D${O}${K !== 0 ? (K > 0 ? "+" : "") + K : ""}`);
      } else
        /^[+-]?\d+$/.test(J) &&
          ((K += parseInt(J, 10)),
      ...
      if (R) {
        let O = parseInt(R[1], 10),
          K = parseInt(R[2], 10),
          el = R[3] ? parseInt(R[3], 10) : 0;
        (el += parseInt(J, 10)),
          (Q[il] = `${O}D${K}${el !== 0 ? (el > 0 ? "+" : "") + el : ""}`);
      } else {
        const O = parseInt(j || "0", 10);
        Q[il] = (O + parseInt(J, 10)).toString();
      }
    } else Q[il] = J;
  }
  return Q;
...
function co(_, tl) {
  const Q = _.caracteristicas,
    m = tl?.variacion_caracteristicas;
  return Qh(Q, m);
}
const io = {
...
function Vh(_) {
  ...
  for (const m of Q) {
    ...
    if (x) {
      let L, J;
      m === Q[0]
        ? ((L = parseInt(x[1].replace(/[+]/g, ""))), (J = x[2]))
        : ((J = x[1]), (L = parseInt(x[2].replace(/[+]/g, ""))));
      const il = Zh(J);
...
function Lh() {
  const [_, tl] = ba.useState(!0),
    Q = () => {
      _ && tl(!1);
    },
    [m, x] = ba.useState(null),
    [L, J] = ba.useState([]),
    [il, j] = ba.useState([]),
    [b, R] = ba.useState(null),
    [O, K] = ba.useState(null),
    [el, Nl] = ba.useState(null),
    [zl, Rl] = ba.useState({}),
    [pa, za] = ba.useState(!0);
  function Ul(p) {
    const C = /(\d+)D(\d+)([+-]\d+)?/i,
  ...
  const la = () => {
      if (
        ...
        return;
      const p = {};
      Object.entries(el).forEach(([wl, Ht]) => {
      ...
      S >= 1 && S <= 10
        ...
        : S >= 19 && (T = S + 30);
      const M = S + w + 10,
        D = Math.floor(N / 2) + S + H + al - 5,
        B = w * 2 + S + H - s - 5,
        P = S * 2 + w + al - 15,
        Z = S + Math.floor(C / 2) + H + w - s - 5,
        Bl = H + al + S + 40 - N,
        ...
        el &&
          v.jsxs("div", {
            ...
            children: [
              ...
              v.jsx("ul", {
                className: "ficha-resultado-list",
                children: Object.entries(el).map(([p, C]) =>
                  v.jsxs(
                    "li",
                    {
                      className: "ficha-resultado-item",
                  ...
                  v.jsx("button", {
                    ...
                    onClick: () => {
                      ...
                      ll >= 1 && ll <= 10
                        ...
                        : ll >= 19 && (s = ll + 30);
                      const T = ll + Y + 10,
                        M = Math.floor(S / 2) + ll + N + H - 5,
                        D = Y * 2 + ll + N - al - 5,
                        B = ll * 2 + Y + H - 15,
                        P = ll + Math.floor(p / 2) + N + Y - al - 5,
                        Z = N + H + ll + 40 - S;
                      x({
