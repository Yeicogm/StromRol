(function () {
  ...
  new MutationObserver((H) => {
    for (const L of H)
      if (L.type === "childList")
        for (const J of L.addedNodes)
          J.tagName === "LINK" && J.rel === "modulepreload" && v(J);
  }).observe(document, { childList: !0, subtree: !0 });
  function Q(H) {
    const L = {};
    return (
      H.integrity && (L.integrity = H.integrity),
...
function Uh() {
  ...
  function Q(v, H, L) {
    ...
    if (
      ...
      L = {};
      for (var cl in H) cl !== "key" && (L[cl] = H[cl]);
    } else L = H;
    return (
      (H = L.ref),
      { $$typeof: _, type: v, key: J, ref: H !== void 0 ? H : null, props: L }
    );
  }
  return (gu.Fragment = al), (gu.jsx = Q), (gu.jsxs = Q), gu;
}
var kd;
function xh() {
...
function jh() {
  ...
  var xl = (za.prototype = new pa());
  (xl.constructor = za), Ol(xl, Ul.prototype), (xl.isPureReactComponent = !0);
  var la = Array.isArray,
    el = { H: null, A: null, T: null, S: null, V: null },
    Vl = Object.prototype.hasOwnProperty;
  function Ll(s, T, M, O, B, ll) {
    return (
      (M = ll.ref),
  ...
  function Sl(s, T, M, O, B) {
        ...
        case "object":
          switch (s.$$typeof) {
            ...
            case al:
              ...
              break;
            case R:
              return (V = s._init), Sl(V(s._payload), T, M, O, B);
          }
      }
    if (V)
      return (
        ...
        la(B)
          ? ((M = ""),
            V != null && (M = V.replace(Y, "$&/") + "/"),
            Sl(B, T, M, "", function (wl) {
              return wl;
            }))
          : B != null &&
            (p(B) &&
    ...
    if (la(s))
      for (var yl = 0; yl < s.length; yl++)
        (O = s[yl]), (ll = Jl + w(O, yl)), (V += Sl(O, T, M, ll, B));
    else if (((yl = K(s)), typeof yl == "function"))
      for (s = yl.call(s), yl = 0; !(O = s.next()).done; )
        (O = O.value), (ll = Jl + w(O, yl++)), (V += Sl(O, T, M, ll, B));
    else if (ll === "object") {
      if (typeof s.then == "function") return Sl(fl(s), T, M, O, B);
      throw (
        ((T = String(s)),
        Error(
  ...
  return (
    ...
    ($.StrictMode = v),
    ($.Suspense = x),
    ($.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = el),
    ($.__COMPILER_RUNTIME = {
      __proto__: null,
      c: function (s) {
    ...
    ($.useActionState = function (s, T, M) {
      return el.H.useActionState(s, T, M);
    }),
    ($.useCallback = function (s, T) {
      return el.H.useCallback(s, T);
    }),
    ($.useContext = function (s) {
      return el.H.useContext(s);
    }),
    ($.useDebugValue = function () {}),
    ($.useDeferredValue = function (s, T) {
      return el.H.useDeferredValue(s, T);
    }),
    ($.useEffect = function (s, T, M) {
      var O = el.H;
    ...
    ($.useImperativeHandle = function (s, T, M) {
      return el.H.useImperativeHandle(s, T, M);
    }),
    ($.useInsertionEffect = function (s, T) {
      return el.H.useInsertionEffect(s, T);
    }),
    ($.useLayoutEffect = function (s, T) {
      return el.H.useLayoutEffect(s, T);
    }),
    ($.useMemo = function (s, T) {
      return el.H.useMemo(s, T);
    }),
    ($.useOptimistic = function (s, T) {
      return el.H.useOptimistic(s, T);
    }),
    ($.useReducer = function (s, T, M) {
      return el.H.useReducer(s, T, M);
    }),
    ($.useRef = function (s) {
    ...
    ($.useSyncExternalStore = function (s, T, M) {
      return el.H.useSyncExternalStore(s, T, M);
    }),
  ...
  return (
    Pd ||
      ...
      (function (_) {
            ...
            l: for (var P = 0, s = S.length, T = s >>> 1; P < T; ) {
              ...
              if (0 > H(O, j))
                B < s && 0 > H(ll, O)
                  ? ((S[P] = ll), (S[B] = j), (P = B))
                  : ((S[P] = O), (S[M] = j), (P = M));
              else if (B < s && 0 > H(ll, j)) (S[P] = ll), (S[B] = j), (P = B);
              else break l;
            }
          }
          return N;
        ...
        function H(S, N) {
          var j = S.sortIndex - N.sortIndex;
          return j !== 0 ? j : S.id - N.id;
        }
        if (
        ...
        function la(S) {
          for (var N = Q(b); N !== null; ) {
            if (N.callback === null) v(b);
            else if (N.startTime <= S)
              v(b), (N.sortIndex = N.expirationTime), al(x, N);
            else break;
            N = Q(b);
          }
        }
        function el(S) {
          if (((El = !1), la(S), !Ol))
            if (Q(x) !== null) (Ol = !0), Vl || ((Vl = !0), w());
            else {
              var N = Q(b);
              N !== null && Sl(el, N.startTime - S);
            }
        }
        var Vl = !1,
          Ll = -1,
          ...
          p = -1;
        function C() {
          return Ul ? !0 : !(_.unstable_now() - p < Kl);
        }
        function Y() {
          if (((Ul = !1), Vl)) {
            ...
            try {
              l: {
                (Ol = !1), El && ((El = !1), za(Ll), (Ll = -1)), (tl = !0);
                var j = K;
                try {
                  a: {
                    for (
                      la(S), D = Q(x);
                      D !== null && !(D.expirationTime > S && C());

                    ) {
                      var P = D.callback;
                      if (typeof P == "function") {
                        (D.callback = null), (K = D.priorityLevel);
                        var s = P(D.expirationTime <= S);
                        if (((S = _.unstable_now()), typeof s == "function")) {
                          (D.callback = s), la(S), (N = !0);
                          break a;
                        }
                        D === Q(x) && v(x), la(S);
                      } else v(x);
                    ...
                    if (D !== null) N = !0;
                      ...
                      var T = Q(b);
                      T !== null && Sl(el, T.startTime - S), (N = !1);
                    }
                  }
                  break l;
                } finally {
        ...
        (_.unstable_IdlePriority = 5),
          ...
          (_.unstable_scheduleCallback = function (S, N, j) {
            ...
            return (
              ...
              j > P
                ? ((S.sortIndex = j),
                  ...
                  Q(x) === null &&
                    S === Q(b) &&
                    (El ? (za(Ll), (Ll = -1)) : (El = !0), Sl(el, j - P)))
                : ((S.sortIndex = s),
                  al(x, S),
                  Ol || tl || ((Ol = !0), Vl || ((Vl = !0), w()))),
              S
            );
          }),
...
function Bh() {
  ...
  return (
    ...
    (Zl.prefetchDNS = function (x) {
      typeof x == "string" && v.d.D(x);
    }),
    (Zl.preinit = function (x, b) {
      if (typeof x == "string" && b && typeof b.as == "string") {
        var R = b.as,
          D = cl(R, b.crossOrigin),
          K = typeof b.integrity == "string" ? b.integrity : void 0,
          tl = typeof b.fetchPriority == "string" ? b.fetchPriority : void 0;
        R === "style"
          ? v.d.S(x, typeof b.precedence == "string" ? b.precedence : void 0, {
              crossOrigin: D,
              integrity: K,
              fetchPriority: tl,
            })
    ...
    (Zl.preinitModule = function (x, b) {
      if (typeof x == "string")
        if (typeof b == "object" && b !== null) {
          if (b.as == null || b.as === "script") {
            var R = cl(b.as, b.crossOrigin);
            v.d.M(x, {
              crossOrigin: R,
    ...
    (Zl.requestFormReset = function (x) {
      v.d.r(x);
    }),
    (Zl.unstable_batchedUpdates = function (x, b) {
      return x(b);
    }),
    (Zl.useFormState = function (x, b, R) {
      return J.H.useFormState(x, b, R);
    }),
...
function Yh() {
  ...
  function x(l) {
    ...
    for (var t = l, e = a; ; ) {
      ...
      if (u.child === n.child) {
        for (n = u.child; n; ) {
          if (n === t) return cl(u), l;
          if (n === e) return cl(u), a;
          n = n.sibling;
        }
        throw Error(v(188));
      }
  ...
  function bu(l) {
    ll.current === l && (M(B), M(ll)),
      Jl.current === l && (M(Jl), (ou._currentValue = j));
  }
  var qn = Object.prototype.hasOwnProperty,
    ...
    ho = _.log,
    vo = _.unstable_setDisableYieldValue,
    ze = null,
    aa = null;
  function Ja(l) {
    if (
  ...
  var wa = Math.random().toString(36).slice(2),
    ...
    Te = "__reactMarker$" + wa;
  function Zn(l) {
    delete l[Xl], delete l[Wl], delete l[Qn], delete l[Eo], delete l[Ao];
  }
  function Bt(l) {
    var a = l[Xl];
    if (a) return a;
...
` +
  ...
  function Of(l, a, t) {
    ...
    try {
      ...
      if (
        ((Fn = !1),
        (Vt !== null || Lt !== null) &&
          (vn(), Vt && ((a = Vt), (l = Lt), (Lt = Vt = null), Nf(a), l)))
      )
  ...
  function Cu(l) {
    if (50 < uu) throw ((uu = 0), (bi = null), Error(v(185)));
  ...
  function Yu(l, a, t, e, u, n) {
    ...
    if (((e = l), typeof l == "function")) vc(l) && (c = 1);
      ...
      l: switch (l) {
        ...
        case Ul:
          return (
            (l = ua(12, t, a, u | 2)), (l.elementType = Ul), (l.lanes = n), l
          );
        case el:
          return (l = ua(13, t, a, u)), (l.elementType = el), (l.lanes = n), l;
        case Vl:
          return (l = ua(19, t, a, u)), (l.elementType = Vl), (l.lanes = n), l;
        default:
          if (typeof l == "object" && l !== null)
            switch (l.$$typeof) {
              case pa:
  ...
  function us(l, a, t) {
    (va[ma++] = Ha), (va[ma++] = qa), (va[ma++] = At), (At = l);
    var e = Ha;
    l = qa;
    var u = 32 - ta(e) - 1;
    (e &= ~(1 << u)), (t += 1);
  ...
  function ns(l) {
    ...
    switch (((a[Xl] = l), (a[Wl] = e), t)) {
      ...
      case "video":
      case "audio":
        for (t = 0; t < cu.length; t++) I(cu[t], a);
        break;
      case "source":
        I("error", a);
        break;
      ...
      case "select":
        ...
        break;
      case "textarea":
        I("invalid", a), Af(a, e.value, e.defaultValue, e.children), Ou(a);
    }
    (t = e.children),
  ...
  function He(l) {
    ...
    if (
      ...
      a === 27
        ...
        : (Al = $l ? Ta(l.stateNode.nextSibling) : null);
    return !0;
  }
  function qe() {
    (Al = $l = null), (il = !1);
  ...
  function ys(l) {
    if (l === Xe || l === Lu) throw Error(v(483));
  }
  var ka = !1;
  function Dc(l) {
    l.updateQueue = {
          ...
          l: {
            ...
            switch (G.tag) {
              ...
              case 0:
                if (
                  ((Z = G.payload),
                  (y = typeof Z == "function" ? Z.call(vl, A, y) : Z),
                  y == null)
                )
                  break l;
                A = R({}, A, y);
  ...
  var ae = T(null),
    Ju = T(0);
  function bs(l, a) {
    (l = La), O(Ju, l), O(ae, a), (La = l | a.baseLanes);
  }
  function Uc() {
    O(Ju, La), O(ae, ae.current);
  }
  function xc() {
  ...
  function zs(l) {
    ...
    if (((Pa = 0), (Dl = ol = W = null), (wu = !1), (Ke = 0), (ee = null), a))
      throw Error(v(300));
    l === null ||
      Hl ||
      ((l = l.dependencies), l !== null && Qu(l) && (Hl = !0));
  }
  function Es(l, a, t, e) {
    W = l;
    var u = 0;
  ...
  function Cc(l) {
    ...
    (Pa = 0), (Dl = ol = W = null), (te = !1), (Ke = $u = 0), (ee = null);
  }
  function Fl() {
    var l = {
      memoizedState: null,
  ...
  function Xc(l, a, t) {
    ...
    if (((n = l.baseState), u === null)) l.memoizedState = n;
      ...
      if (
        (f === null ? (c = n) : (f.next = i),
        !ea(n, l.memoizedState) && ((Hl = !0), z && ((t = le), t !== null)))
      )
        throw t;
      (l.memoizedState = n),
        (l.baseState = c),
  ...
  function Bs(l, a, t) {
    ...
    return (
      t !== a.memoizedState &&
        ((W.flags |= 2048), ue(9, Fu(), N0.bind(null, u, t), null)),
      [e, n, l]
    );
  }
  function N0(l, a) {
  ...
  function we(l, a, t, e) {
    ...
    ol !== null && e !== null && jc(e, ol.memoizedState.deps)
      ...
      : ((W.flags |= l), (u.memoizedState = ue(1 | a, n, t, e)));
  }
  function Gs(l, a) {
    Iu(8390656, 8, l, a);
  }
  ...
  var ln = {
    ...
    tr = {
      ...
      useCacheRefresh: function () {
        return (Fl().memoizedState = D0.bind(null, W));
      },
    },
    er = {
      readContext: Ql,
  ...
  function an(l) {
    var a = We;
    return (We += 1), ne === null && (ne = []), vs(ne, l, a);
  }
  function ke(l, a) {
  ...
  function nr(l) {
    ...
    function A(d, r, o) {
      ...
      if (typeof r == "object" && r !== null) {
        ...
        if (r.$$typeof === xl) return A(d, Zu(d, r), o);
        tn(d, r);
      }
      return null;
    }
    function y(d, r, o, E) {
      ...
      if (typeof o == "object" && o !== null) {
        ...
        if (Sl(o) || w(o)) return U !== null ? null : z(d, r, o, E, null);
        if (typeof o.then == "function") return y(d, r, an(o), E);
        if (o.$$typeof === xl) return y(d, r, Zu(d, o), E);
        tn(d, o);
      }
      return null;
    }
    function g(d, r, o, E, U) {
      ...
      if (typeof E == "object" && E !== null) {
        ...
        if (Sl(E) || w(E)) return (d = d.get(o) || null), z(r, d, E, U, null);
        if (typeof E.then == "function") return g(d, r, o, an(E), U);
        if (E.$$typeof === xl) return g(d, r, o, Zu(r, E), U);
        tn(r, E);
      }
      return null;
    }
    function Z(d, r, o, E) {
      for (
        ...
        l && q && nl.alternate === null && a(d, q),
          (r = n(nl, r, X)),
          k === null ? (U = nl) : (k.sibling = nl),
          (k = nl),
          (q = Bl);
      }
      if (X === o.length) return t(d, q), il && Tt(d, X), U;
      if (q === null) {
        for (; X < o.length; X++)
          (q = A(d, o[X], E)),
            q !== null &&
    ...
    function G(d, r, o, E) {
      ...
      for (
        var U = null, k = null, q = r, X = (r = 0), Bl = null, nl = o.next();
        q !== null && !nl.done;
        X++, nl = o.next()
      ) {
        q.index > X ? ((Bl = q), (q = null)) : (Bl = q.sibling);
        var mt = y(d, q, nl.value, E);
        if (mt === null) {
          q === null && (q = Bl);
          break;
        }
      ...
      if (nl.done) return t(d, q), il && Tt(d, X), U;
      if (q === null) {
      ...
      for (q = e(q); !nl.done; X++, nl = o.next())
        (nl = g(q, d, X, nl.value, E)),
          nl !== null &&
            (l &&
              nl.alternate !== null &&
              q.delete(nl.key === null ? X : nl.key),
            (r = n(nl, r, X)),
            k === null ? (U = nl) : (k.sibling = nl),
            (k = nl));
      return (
      ...
      if (
        ...
        switch (o.$$typeof) {
          ...
          case tl:
            ...
            return c(d);
          case Kl:
            return (U = o._init), (o = U(o._payload)), vl(d, r, o, E);
        }
        if (Sl(o)) return Z(d, r, o, E);
        if (w(o)) {
          if (((U = w(o)), typeof U != "function")) throw Error(v(150));
          return (o = U.call(o)), G(d, r, o, E);
        }
        if (typeof o.then == "function") return vl(d, r, an(o), E);
        if (o.$$typeof === xl) return vl(d, r, Zu(d, o), E);
        tn(d, o);
      }
  ...
  function ir(l) {
    if (l.tag === 22) {
      if ((O(Rl, Rl.current), O(ya, l), Da === null)) {
        var a = l.alternate;
  ...
  function at() {
    O(Rl, Rl.current), O(ya, ya.current);
  }
  function Ga(l) {
    M(ya), Da === l && (Da = null), M(Rl);
  }
  var Rl = T(0);
  function en(l) {
    for (var a = l; a !== null; ) {
      ...
      return (
        ...
        a !== null
          ? ((a.flags & 65536) === 0 && (a.flags |= 256),
            (a.flags |= 65536),
            (a.lanes = u),
            e !== bc && ((l = Error(v(422), { cause: e })), Be(oa(l, t))))
          : (e !== bc && ((a = Error(v(423), { cause: e })), Be(oa(a, t))),
  ...
  function gr(l, a, t, e, u) {
    ...
    return (
      ...
      l !== null && !Hl
        ? (Bc(l, a, u), Xa(l, a, u))
        : (il && i && gc(a), (a.flags |= 1), Cl(l, a, e, u), a.child)
    );
  }
  ...
  function Ic(l, a, t, e, u) {
    return (
      ...
      l !== null && !Hl
        ? (Bc(l, a, u), Xa(l, a, u))
        : (il && e && gc(a), (a.flags |= 1), Cl(l, a, t, u), a.child)
    );
  }
  function Ar(l, a, t, e, u, n) {
    return (
      ...
      l !== null && !Hl
        ? (Bc(l, a, n), Xa(l, a, n))
        : (il && e && gc(a), (a.flags |= 1), Cl(l, a, t, n), a.child)
    );
  }
  function Tr(l, a, t, e, u) {
    if ((Dt(a), a.stateNode === null)) {
      ...
      typeof c == "object" && c !== null && (n = Ql(c)),
        ...
        Dc(a),
        (c = t.contextType),
        (n.context = typeof c == "object" && c !== null ? Ql(c) : kt),
        (n.state = a.memoizedState),
      ...
      var h = n.context,
        z = t.contextType;
      (c = kt), typeof z == "object" && z !== null && (c = Ql(z));
  ...
  function Nr(l, a, t) {
    ...
    if (
      ...
      if (n)
        ...
        (Hl || Ce(l, a, t, !1), (c = (t & l.childLanes) !== 0), Hl || c)
      ) {
        if (
          ((c = gl),
          c !== null &&
  ...
  function _r(l, a, t) {
    ...
    else (Hl = !1), il && (a.flags & 1048576) !== 0 && us(a, Xu, a.index);
        ...
        l: {
          ...
          if (
            ...
            if (
              ...
              (u = oa(Error(v(424)), a)), Be(u), (a = pr(l, a, e, t));
              break l;
            } else {
          ...
          l === null
            ? (t = xd(a.type, null, a.pendingProps, null))
              ...
              : il ||
                ((t = a.type),
                (l = a.pendingProps),
                (e = An(V.current).createElement(t)),
                (e[Xl] = a),
                (e[Wl] = l),
                Gl(e, t, l),
                jl(e),
  ...
  function x0(l, a, t) {
    ...
    switch ((Sc(a), a.tag)) {
        ...
        if (l && a.stateNode != null) l.memoizedProps !== e && Qa(a);
          ...
          if (((l = V.current), He(a))) {
            ...
            (l[Xl] = a),
              ...
              l || Nt(a);
          } else (l = An(l).createTextNode(e)), (l[Xl] = a), (a.stateNode = l);
        }
        return zl(a), null;
      case 13:
        if (
      ...
      case 4:
        return wl(), l === null && Ri(a.stateNode.containerInfo), zl(a), null;
      case 10:
        return Ca(a.type), zl(a), null;
      case 19:
        if ((M(Rl), (u = a.memoizedState), u === null)) return zl(a), null;
  ...
  function H0(l, a) {
    ...
    for (
      Hi = { focusedElem: l, selectionRange: t }, _n = !1, ql = a;
      ql !== null;
            ...
            case 1:
              if ((l & 1024) !== 0 && n !== null) {
                (l = void 0),
                  ...
                  (e = t.stateNode);
                try {
                  var Z = Rt(t.type, u, t.elementType === t.type);
    ...
    for (u = u && (a.subtreeFlags & 10256) !== 0, a = a.child; a !== null; ) {
      ...
      switch (c.tag) {
        ...
        case 22:
          ...
          break;
        case 24:
          ie(n, c, i, f, u), u && h & 2048 && oi(c.alternate, c);
          break;
        default:
          ie(n, c, i, f, u);
      }
  ...
  function Wr() {
    ga === 0 && (ga = (ul & 536870912) === 0 || il ? nf() : 536870912);
    var l = ya.current;
      ...
      if (u === 0) {
        ...
        l: {
          ...
          if ((a & 62914560) === a && ((u = yi + 300 - Na()), 10 < u)) {
            ...
            e.timeoutHandle = Nd(
              Fr.bind(null, e, t, Pl, hn, mi, a, ga, xt, re, nt, n, 2, -0, 0),
              u
            );
            break l;
          }
          Fr(e, t, Pl, hn, mi, a, ga, xt, re, nt, n, 0, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function zi() {
    if (F !== null) {
      if (rl === 0) var l = F.return;
      else (l = F), (Ba = Ot = null), Cc(l), (ne = null), (We = 0), (l = F);
      ...
      a === Xe || a === Lu
        ...
        : (rl =
            a === yr
              ...
              : 1),
      (ia = a),
      F === null && ((Tl = 1), nn(l, oa(a, l.current)));
  }
  function Pr() {
    var l = S.H;
  ...
  function Ei() {
    (Tl = 4),
      nt || ((ul & 4194048) !== ul && ya.current !== null) || (se = !0),
        ...
        if (rl !== 0 && F !== null) {
          ...
          switch (rl) {
            ...
            case 6:
              ya.current === null && (a = !0);
              var h = rl;
              if (((rl = 0), (ia = null), ve(l, i, f, h), t && se)) {
                c = 0;
                break l;
              }
              break;
            default:
              (h = rl), (rl = 0), (ia = null), ve(l, i, f, h);
          }
        }
        G0(), (c = Tl);
        break;
                ...
                case 27:
                  ...
                  if (!c || Cd(c)) {
                    ...
                    if (f !== null) F = f;
                      ...
                      var h = i.return;
                      h !== null ? ((F = h), mn(h)) : (F = null);
                    }
                    break a;
                  }
              }
              (rl = 0), (ia = null), ve(l, a, n, 5);
              break;
            case 6:
              (rl = 0), (ia = null), ve(l, a, n, 6);
              break;
            case 8:
              zi(), (Tl = 6);
              break l;
  ...
  function ad(l) {
    ...
    (l.memoizedProps = l.pendingProps), a === null ? mn(l) : (F = a);
  }
  function td(l) {
    var a = l,
      t = a.alternate;
    switch (a.tag) {
      case 15:
      case 0:
        a = Ar(t, a, a.pendingProps, a.type, void 0, ul);
        break;
      case 11:
        a = Ar(t, a, a.pendingProps, a.type.render, a.ref, ul);
        break;
      case 5:
        Cc(a);
      default:
  ...
  function ve(l, a, t, e) {
    ...
    try {
      if (R0(l, u, a, t, ul)) {
        (Tl = 1), nn(l, oa(t, l.current)), (F = null);
        return;
      }
    } catch (n) {
              ...
              if ((z === void 0 && (z = h), "selectionStart" in i))
                ...
                if (y.getSelection) {
                  var g = y.getSelection(),
                    Z = i.textContent.length,
                    G = Math.min(f.start, Z),
                    vl = f.end === void 0 ? G : Math.min(f.end, Z);
                  !g.extend && G > vl && ((c = vl), (vl = G), (G = c));
                  var d = Kf(i, G),
                    r = Kf(i, vl);
                  if (
                    d &&
  ...
  function Z0(l, a, t) {
    ...
    e !== null && e.delete(a),
      ...
      gl === l &&
        (ul & t) === t &&
        (Tl === 4 || (Tl === 3 && (ul & 62914560) === ul && 300 > Na() - yi)
          ? (sl & 2) === 0 && he(l, 0)
          : (vi |= t),
        re === ul && (re = 0)),
      Ra(l);
    ...
    Of(function () {
      ...
      l: {
        ...
        if (y !== void 0) {
          ...
          for (var r = h, o; r !== null; ) {
            ...
            if (
              ...
              (E !== 5 && E !== 26 && E !== 27) ||
                o === null ||
                d === null ||
                ((E = Ne(r, d)), E != null && G.push(iu(r, E, o))),
              vl)
            )
              break;
            r = r.return;
          ...
          0 < G.length &&
            ((y = new g(y, Z, null, t, z)), A.push({ event: y, listeners: G }));
        }
      }
      if ((a & 7) === 0) {
        l: {
          ...
          if (
            ...
            if (
              ...
              a: {
                for (G = g, d = Z, r = 0, o = G; o; o = ye(o)) r++;
        ...
        X &&
          (xf &&
            t.locale !== "ko" &&
            (Kt || X !== "onCompositionStart"
              ? X === "onCompositionEnd" && Kt && (q = Df())
              : (($a = z),
  ...
  function zd(l, a, t, e, u) {
    for (var n = a._reactName, c = []; t !== null && t !== e; ) {
      ...
      (i !== 5 && i !== 26 && i !== 27) ||
        ...
        ((f = h),
        u
          ? ((h = Ne(t, n)), h != null && c.unshift(iu(t, h, f)))
          : u || ((h = Ne(t, n)), h != null && c.push(iu(t, h, f)))),
        (t = t.return);
    }
...
`
  ...
  function hl(l, a, t, e, u, n) {
    switch (t) {
      ...
      case "start":
        ...
        break;
      case "popover":
        I("beforetoggle", l), I("toggle", l), pu(l, "popover", e);
        break;
      case "xlinkActuate":
  ...
  function Gl(l, a, t) {
    switch (a) {
      ...
      case "video":
      case "audio":
        for (e = 0; e < cu.length; e++) I(cu[e], l);
        break;
      case "image":
        I("error", l), I("load", l);
        break;
    ...
    switch (a) {
      ...
      case "option":
        for (var Z in t)
          if (
            ((y = t[Z]),
            t.hasOwnProperty(Z) && y != null && !e.hasOwnProperty(Z))
          )
            switch (Z) {
              case "selected":
                l.selected = !1;
          ...
          if (n !== null)
            switch (n.tag) {
              case 3:
                ...
                break;
              case 13:
                (i = Wt(n, 2)), i !== null && sa(i, n, 2), vn(), Vi(n, 2);
            }
  ...
  function Dh(l, a, t, e, u) {
    switch (a) {
      case "focusin":
        return (dt = mu(dt, l, a, t, e, u)), !0;
      case "dragenter":
        return (ot = mu(ot, l, a, t, e, u)), !0;
      case "mouseover":
        return (ht = mu(ht, l, a, t, e, u)), !0;
      case "pointerover":
        var n = u.pointerId;
        return hu.set(n, mu(hu.get(n) || null, l, a, t, e, u)), !0;
      case "gotpointercapture":
        return (
          (n = u.pointerId), vu.set(n, mu(vu.get(n) || null, l, a, t, e, u)), !0
        );
    }
    return !1;
  }
    ...
    (jn.prototype.unmount = $i.prototype.unmount =
      function () {
        ...
        if (l !== null) {
          ...
          Xd(l.current, 2, null, l, null, null), vn(), (a[qt] = null);
        }
      });
  function jn(l) {
    this._internalRoot = l;
...
function Qh(_, al) {
  if (!al || al.length === 0) return _;
  const Q = { ..._ };
  for (const v of al) {
    let H = v.match(/^(\w+)\s*([+-]?\d+D\d+|[+-]?\d+D|[+-]?\d+)$/i);
    if (
      !H &&
      ((H = v.match(/^([+-]?\d+D\d+|[+-]?\d+D|[+-]?\d+)\s+(\w+)$/i)), H)
    ) {
      const R = H[1];
      (H[1] = H[2]), (H[2] = R);
    }
    ...
    if (b) {
      ...
      if (/^[+-]?\d+D$/.test(J)) {
        const tl = parseInt(J.replace("D", ""), 10);
        (R += tl),
          (Q[cl] = `${R}D${D}${K !== 0 ? (K > 0 ? "+" : "") + K : ""}`);
      } else if (/^[+-]?\d+D\d+$/.test(J)) {
        const tl = J.match(/([+-]?\d+)D(\d+)/);
        tl && ((R += parseInt(tl[1], 10)), (D = parseInt(tl[2], 10))),
          (Q[cl] = `${R}D${D}${K !== 0 ? (K > 0 ? "+" : "") + K : ""}`);
      } else
        /^[+-]?\d+$/.test(J) &&
          ((K += parseInt(J, 10)),
      ...
      const R = x.match(/^(\d+)D(\d+)([+-]\d+)?$/);
      if (R) {
        let D = parseInt(R[1], 10),
          K = parseInt(R[2], 10),
          tl = R[3] ? parseInt(R[3], 10) : 0;
        (tl += parseInt(J, 10)),
          (Q[cl] = `${D}D${K}${tl !== 0 ? (tl > 0 ? "+" : "") + tl : ""}`);
      } else {
        const D = parseInt(x || "0", 10);
        Q[cl] = (D + parseInt(J, 10)).toString();
      }
    } else Q[cl] = J;
  }
  return Q;
...
function Vh(_) {
  ...
  for (const v of Q) {
    ...
    if (H) {
      let L, J;
      v === Q[0]
        ? ((L = parseInt(H[1].replace(/[+]/g, ""))), (J = H[2]))
        : ((J = H[1]), (L = parseInt(H[2].replace(/[+]/g, ""))));
      const cl = Zh(J);
      if (cl && !isNaN(L)) return { habilidad: cl, valor: L };
    }
  }
  return null;
}
function Lh() {
  const [_, al] = ba.useState(!0),
    Q = () => {
      _ && al(!1);
    },
    [v, H] = ba.useState(null),
    [L, J] = ba.useState([]),
    [cl, x] = ba.useState([]),
    [b, R] = ba.useState(null),
    [D, K] = ba.useState(null),
    [tl, Ol] = ba.useState(null),
    [El, Ul] = ba.useState({}),
    [pa, za] = ba.useState(!0);
  function xl(p) {
    const C = /(\d+)D(\d+)([+-]\d+)?/i,
  ...
  const la = () => {
      if (
        !tl ||
        (Object.values(El).some((wl) => wl && wl.trim() !== "") &&
          !window.confirm(
        ...
        return;
      const p = {};
      Object.entries(tl).forEach(([wl, Ht]) => {
        typeof Ht == "string" && (p[wl] = xl(Ht).toString());
      }),
        Ul(p);
      ...
      C >= 18 && C <= 23
        ...
        ? (Y = "+2D6")
        : (Y = "Sin bonus");
      const w = parseInt(p.Destreza || "0", 10),
        dl = C + w;
      let fl = "NO TIENE";
      D &&
        ["ARQUERO", "CASACA AZUL", "ILMIONARIO", "GUARDABOSQUES"].some(
          (wl) => D.nombre.toUpperCase() === wl.toUpperCase()
        ) &&
        (dl >= 0 && dl <= 24
          ? (fl = "Nada")
          : dl >= 25 && dl <= 40
      ...
      S >= 1 && S <= 10
        ...
        : S >= 19 && (T = S + 30);
      const M = S + w + 10,
        O = Math.floor(N / 2) + S + j + P - 5,
        B = w * 2 + S + j - s - 5,
        ll = S * 2 + w + P - 15,
        V = S + Math.floor(C / 2) + j + w - s - 5,
        Jl = j + P + S + 40 - N,
      ...
      D
        ? m.jsx("div", {
            ...
            children: m.jsxs("div", {
              className: "raza-content",
              children: [
                m.jsx("h3", { className: "raza-title", children: D.nombre }),
                m.jsx("p", {
                  className: "raza-description",
                    ...
                    D.variacion_caracteristicas &&
                      ...
                      m.jsxs("div", {
                        ...
                        children: [
                          ...
                          m.jsx("div", {
                            className: "raza-list",
                            children: D.variacion_caracteristicas.map((p, C) =>
                              m.jsx(
                                "div",
                                {
                                  className: "raza-list-item",
                    ...
                    D.variacion_habilidades &&
                      ...
                      m.jsxs("div", {
                        ...
                        children: [
                          ...
                          m.jsx("div", {
                            className: "raza-list",
                            children: D.variacion_habilidades.map((p, C) =>
                              m.jsxs(
                                "div",
                                {
                                  className: "raza-list-item",
    ...
    Ll = () => {
      ...
      return (
        b &&
          Object.entries(b.bonificaciones).forEach(([C, Y]) => {
            if (typeof Y == "number") p[C] = (p[C] || 0) + Y;
              ...
              const w = parseInt(Y.replace(/[+-]/g, "")) || 0,
                dl = Y.startsWith("-") ? -1 : 1;
              p[C] = (p[C] || 0) + w * dl;
            }
          }),
        D &&
          D.variacion_habilidades &&
          D.variacion_habilidades.forEach((C) => {
            const Y = C.trim();
            if (
            ...
            const w = Vh(Y);
            if (w) {
              p[w.habilidad] = (p[w.habilidad] || 0) + w.valor;
              return;
            }
        ...
        m.jsxs("div", {
          ...
          children: [
            ...
            m.jsxs("select", {
              ...
              value: D?.nombre || "",
              onChange: (p) => {
                const C = cl.find((Y) => Y.nombre === p.target.value);
                K(C || null), Ul({}), Q();
              },
              disabled: !!(
                b &&
        ...
        tl &&
          m.jsxs("div", {
            ...
            children: [
              ...
              m.jsx("ul", {
                className: "ficha-resultado-list",
                children: Object.entries(tl).map(([p, C]) =>
                  m.jsxs(
                    "li",
                    {
                      className: "ficha-resultado-item",
              ...
              m.jsxs("div", {
                ...
                children: [
                  m.jsx("button", {
                    ...
                    onClick: la,
                    disabled: Object.keys(tl || {}).length === 0,
                    children: "Generar tiradas aleatorias",
                  }),
                  m.jsx("button", {
                    className: "ficha-habilidades-btn",
                    disabled:
                      Object.keys(tl || {}).length === 0 ||
                      Object.entries(tl || {}).some(([p]) => !El[p]),
                    onClick: () => {
                      ...
                      const fl = parseInt(El.Inteligencia || "0", 10),
                        Sl = parseInt(El.Constitución || "0", 10),
                        S = parseInt(El.Poder || "0", 10),
                        N = parseInt(El.Carisma || "0", 10),
                        j = parseInt(El.Tamaño || "0", 10);
                      let P = 0;
                      fl >= 1 && fl <= 10
                        ? (P = fl)
                        : fl >= 11 && fl <= 18
                        ...
                        : fl >= 19 && (P = fl + 30);
                      const s = fl + Y + 10,
                        T = Math.floor(Sl / 2) + fl + S + N - 5,
                        M = Y * 2 + fl + S - j - 5,
                        O = fl * 2 + Y + N - 15,
                        B = fl + Math.floor(p / 2) + S + Y - j - 5,
                        ll = S + N + fl + 40 - Sl;
                      H({
...
Xh.createRoot(document.getElementById("root")).render(
  m.jsx(ba.StrictMode, { children: m.jsx(Lh, {}) })
);
