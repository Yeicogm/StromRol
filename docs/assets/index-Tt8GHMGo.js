...
function Uh() {
  ...
  function Z(v, x, L) {
    ...
    return (
      (x = L.ref),
      { $$typeof: D, type: v, key: w, ref: x !== void 0 ? x : null, props: L }
    );
  }
...
function jh() {
  ...
  (xl.constructor = ba), Ol(xl, Ul.prototype), (xl.isPureReactComponent = !0);
  var Pl = Array.isArray,
    el = { H: null, A: null, T: null, S: null, V: null },
    Ll = Object.prototype.hasOwnProperty;
  function Kl(s, A, _, O, B, ll) {
    return (
      (_ = ll.ref),
      { $$typeof: D, type: s, key: A, ref: _ !== void 0 ? _ : null, props: ll }
    );
  }
  function Jl(s, A) {
  ...
  function F(s, A, _, O, B) {
        ...
        case "object":
          switch (s.$$typeof) {
            ...
            case tl:
              ...
              break;
            case R:
              return (V = s._init), F(V(s._payload), A, _, O, B);
          }
      }
    if (V)
      return (
    ...
    if (Pl(s))
      for (var yl = 0; yl < s.length; yl++)
        (O = s[yl]), (ll = jl + K(O, yl)), (V += F(O, A, _, ll, B));
    else if (((yl = $(s)), typeof yl == "function"))
      for (s = yl.call(s), yl = 0; !(O = s.next()).done; )
        (O = O.value), (ll = jl + K(O, yl++)), (V += F(O, A, _, ll, B));
    else if (ll === "object") {
      if (typeof s.then == "function") return F(fl(s), A, _, O, B);
      throw (
        ((A = String(s)),
        Error(
  ...
  return (
    ...
    (J.cloneElement = function (s, A, _) {
      ...
      return Kl(s.type, B, void 0, void 0, ll, O);
    }),
    ...
    (J.createElement = function (s, A, _) {
      var O,
        ...
        ll = null;
      if (A != null)
        for (O in (A.key !== void 0 && (ll = "" + A.key), A))
          Ll.call(A, O) &&
            O !== "key" &&
            O !== "__self" &&
            O !== "__source" &&
      ...
      if (s && s.defaultProps)
        for (O in ((V = s.defaultProps), V)) B[O] === void 0 && (B[O] = V[O]);
    ...
    Pd ||
      ...
      (function (D) {
        ...
        var Ll = !1,
          ...
          p = -1;
        function C() {
          return Ul ? !0 : !(D.unstable_now() - p < Jl);
        }
        function Y() {
          if (((Ul = !1), Ll)) {
        ...
        (D.unstable_IdlePriority = 5),
          ...
          (D.unstable_runWithPriority = function (b, N) {
            switch (b) {
              case 1:
              case 2:
              case 3:
          ...
          (D.unstable_scheduleCallback = function (b, N, q) {
            ...
            return (
              ...
              q > al
                ...
                : ((b.sortIndex = s),
                  tl(j, b),
                  Ol || sl || ((Ol = !0), Ll || ((Ll = !0), K()))),
              b
            );
          }),
          (D.unstable_shouldYield = C),
...
function Bh() {
  ...
  var w = D.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
  function il(j, S) {
    if (j === "font") return "";
...
function Ch() {
  ...
  return D(), (lf.exports = Bh()), lf.exports;
}
/**
 * @license React
...
function Yh() {
  ...
  var B = A(null),
    ...
    jl = A(null);
  function yl(l, a) {
    switch ((O(V, a), O(ll, l), O(B, null), a.nodeType)) {
      case 9:
      case 11:
  ...
  var qn = Object.prototype.hasOwnProperty,
    Bn = D.unstable_scheduleCallback,
    Cn = D.unstable_cancelCallback,
    fo = D.unstable_shouldYield,
    so = D.unstable_requestPaint,
    pa = D.unstable_now,
    ro = D.unstable_getCurrentPriorityLevel,
    tf = D.unstable_ImmediatePriority,
    ef = D.unstable_UserBlockingPriority,
    bu = D.unstable_NormalPriority,
    oo = D.unstable_LowPriority,
    uf = D.unstable_IdlePriority,
    ho = D.log,
    vo = D.unstable_setDisableYieldValue,
    be = null,
    la = null;
  function Ja(l) {
    if (
...
` +
    ...
    xu = R({}, Oe, {
      ...
      movementX: function (l) {
        return "movementX" in l
          ...
          : (l !== De &&
              (De && l.type === "mousemove"
                ? ((lc = l.screenX - De.screenX), (ac = l.screenY - De.screenY))
                : (ac = lc = 0),
              (De = l)),
            lc);
      },
  ...
  function wf(l) {
    l =
      ...
      l.ownerDocument.defaultView != null
        ...
        : window;
    for (var a = Ou(l.document); a instanceof l.HTMLIFrameElement; ) {
      try {
  ...
  var zc = A(null),
    ...
    qa = null;
  function Wa(l, a, t) {
    O(zc, a._currentValue), (a._currentValue = t);
  }
  function Ba(l) {
  ...
  var g0 =
    ...
    S0 = D.unstable_scheduleCallback,
    b0 = D.unstable_NormalPriority,
    Ml = {
      $$typeof: xl,
      Consumer: null,
      Provider: null,
  ...
  function Zu(l, a) {
    a === null ? O(_t, _t.current) : O(_t, a.pool);
  }
  function ds() {
    var l = Nc();
  ...
  var le = A(null),
    Ku = A(0);
  function bs(l, a) {
    (l = Va), O(Ku, l), O(le, a), (Va = l | a.baseLanes);
  }
  function Uc() {
    O(Ku, Va), O(le, le.current);
  }
  function xc() {
  ...
  function zs(l) {
    ...
    if (((Pa = 0), (Dl = hl = W = null), (Ju = !1), (Le = 0), (te = null), a))
      throw Error(v(300));
    l === null ||
      ql ||
  ...
  function Cc(l) {
    ...
    (Pa = 0), (Dl = hl = W = null), (ae = !1), (Le = wu = 0), (te = null);
  }
  function kl() {
    var l = {
      memoizedState: null,
  ...
  var Pu = {
    ...
    tr = {
      ...
      useCacheRefresh: function () {
        return (kl().memoizedState = D0.bind(null, W));
      },
    },
    er = {
      readContext: Zl,
  ...
  function ir(l) {
    if (l.tag === 22) {
      if ((O(Rl, Rl.current), O(ma, l), Oa === null)) {
        var a = l.alternate;
        a !== null && a.memoizedState !== null && (Oa = l);
      }
    } else at();
  }
  function at() {
    O(Rl, Rl.current), O(ma, ma.current);
  }
  function Ya(l) {
    _(ma), Oa === l && (Oa = null), _(Rl);
  }
  var Rl = A(0);
  function tn(l) {
    for (var a = l; a !== null; ) {
    ...
    if (
      ...
      if (
        ...
        switch (t.tag) {
          case 13:
            return (
              Oa === null ? Ei() : t.alternate === null && Al === 0 && (Al = 3),
              (t.flags &= -257),
              (t.flags |= 65536),
              (t.lanes = u),
              e === Oc
    ...
    if (a.type !== "stylesheet" || (a.state.loading & 4) !== 0)
      ...
      if (
        ...
        a !== null &&
          ((ul & 4194048) === ul
            ? Oa !== null
            : ((ul & 62914560) !== ul && (ul & 536870912) === 0) || a !== Oa))
      )
        throw ((Xe = Oc), os);
      l.flags |= 8192;
    }
              ...
              for (l = a.child; l !== null; ) {
                if (((n = tn(l)), n !== null)) {
                  for (
                    ...
                    es(t, l), (t = t.sibling);
                  return O(Rl, (Rl.current & 1) | 2), a.child;
                }
                l = l.sibling;
              }
            u.tail !== null &&
  ...
  var Qa = !1,
    ...
    Bl = null;
  function H0(l, a) {
    if (((l = l.containerInfo), (ji = Dn), (l = wf(l)), ic(l))) {
    ...
    for (
      Hi = { focusedElem: l, selectionRange: t }, Dn = !1, Bl = a;
      Bl !== null;
  ...
  function zi() {
    if (I !== null) {
      ...
      else (l = I), (qa = Ot = null), Cc(l), (ue = null), ($e = 0), (l = I);
...
`
  ...
  function Rn(l, a) {
    l.blockedOn === a &&
      ...
      wi ||
        ((wi = !0),
        D.unstable_scheduleCallback(D.unstable_NormalPriority, _h)));
  }
  var Un = null;
  function wd(l) {
    Un !== l &&
...
function Gh() {
  ...
  return D(), (Fi.exports = Yh()), Fi.exports;
}
var Xh = Gh();
const no = {
  Fuerza: "Fuerza",
...
function Lh() {
  ...
  return (
    ...
    Sa.useEffect(() => {
      if (S)
        if (["SELOROK", "DEMONIOS"].includes(S.nombre.toUpperCase())) Ol(co(S));
        else if (M) {
          const p = {
            ...M,
