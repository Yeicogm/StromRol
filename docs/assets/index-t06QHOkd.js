...
function Uh() {
  ...
  function Q(m, H, L) {
    ...
    return (
      (H = L.ref),
      { $$typeof: _, type: m, key: J, ref: H !== void 0 ? H : null, props: L }
    );
  }
      ...
      (function (_) {
        ...
        function la(S) {
          for (var N = Q(b); N !== null; ) {
            if (N.callback === null) m(b);
            else if (N.startTime <= S)
              m(b), (N.sortIndex = N.expirationTime), al(x, N);
            else break;
            N = Q(b);
          }
        }
...
function Bh() {
  ...
  return (
    (Zl.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = m),
    ...
    (Zl.preinit = function (x, b) {
      if (typeof x == "string" && b && typeof b.as == "string") {
        ...
        R === "style"
          ? m.d.S(x, typeof b.precedence == "string" ? b.precedence : void 0, {
              crossOrigin: D,
              integrity: K,
              fetchPriority: tl,
            })
...
function Yh() {
  ...
  function cl(l) {
    if (L(l) !== l) throw Error(m(188));
  }
  function x(l) {
    var a = l.alternate;
    if (!a) {
      if (((a = L(l)), a === null)) throw Error(m(188));
      return a !== l ? null : l;
    }
    for (var t = l, e = a; ; ) {
      var u = t.return;
...
` +
  ...
  function Cu(l) {
    if (50 < uu) throw ((uu = 0), (bi = null), Error(m(185)));
  ...
  var Qe = null;
  function vs() {
    if (Qe === null) throw Error(m(459));
    var l = Qe;
    return (Qe = null), l;
  }
  function ys(l) {
    if (l === Xe || l === Lu) throw Error(m(483));
  }
  var ka = !1;
  function Dc(l) {
    l.updateQueue = {
          ...
          l: {
            ...
            switch (G.tag) {
              ...
              case 0:
                if (
                  ((Z = G.payload),
                  (y = typeof Z == "function" ? Z.call(ml, A, y) : Z),
                  y == null)
                )
                  break l;
                A = R({}, A, y);
    ...
    tr = {
      ...
      useSyncExternalStore: function (l, a, t) {
        ...
        if (il) {
          ...
          if (((t = a()), gl === null)) throw Error(m(349));
          (ul & 124) !== 0 || Ts(e, a, t);
        }
        u.memoizedState = t;
  ...
  function nr(l) {
    ...
    function ml(d, r, o, E) {
      if (
        ...
        if (w(o)) {
          if (((U = w(o)), typeof U != "function")) throw Error(m(150));
          return (o = U.call(o)), G(d, r, o, E);
        }
        if (typeof o.then == "function") return ml(d, r, an(o), E);
        if (o.$$typeof === xl) return ml(d, r, Zu(d, o), E);
        tn(d, o);
      }
      ...
      return (
        ...
        a !== null
          ? ((a.flags & 65536) === 0 && (a.flags |= 256),
            (a.flags |= 65536),
            (a.lanes = u),
            e !== bc && ((l = Error(m(422), { cause: e })), Be(oa(l, t))))
          : (e !== bc && ((a = Error(m(423), { cause: e })), Be(oa(a, t))),
        ...
        l: {
          ...
          if (
            ...
            if (
              ...
              (u = oa(Error(m(424)), a)), Be(u), (a = pr(l, a, e, t));
              break l;
            } else {
        ...
        if (rl !== 0 && F !== null) {
          ...
          switch (rl) {
            ...
            case 6:
              ya.current === null && (a = !0);
              var h = rl;
              if (((rl = 0), (ia = null), me(l, i, f, h), t && se)) {
                c = 0;
                break l;
              }
              break;
            default:
              (h = rl), (rl = 0), (ia = null), me(l, i, f, h);
          }
        }
        G0(), (c = Tl);
        break;
              ...
              if ((z === void 0 && (z = h), "selectionStart" in i))
                ...
                if (y.getSelection) {
                  var g = y.getSelection(),
                    ...
                    ml = f.end === void 0 ? G : Math.min(f.end, Z);
...
`
  ...
  var $d = al.version;
  if ($d !== "19.1.1") throw Error(m(527, $d, "19.1.1"));
...
function Qh(_, al) {
  ...
  const Q = { ..._ };
  for (const m of al) {
    let H = m.match(/^(\w+)\s*([+-]?\d+D\d+|[+-]?\d+D|[+-]?\d+)$/i);
    if (
      !H &&
      ((H = m.match(/^([+-]?\d+D\d+|[+-]?\d+D|[+-]?\d+)\s+(\w+)$/i)), H)
    ) {
      const R = H[1];
      (H[1] = H[2]), (H[2] = R);
    }
...
function co(_, al) {
  const Q = _.caracteristicas,
    m = al?.variacion_caracteristicas;
  return Qh(Q, m);
}
const io = {
      ...
      D
        ? v.jsx("div", {
            ...
            children: v.jsxs("div", {
              className: "raza-content",
              children: [
                v.jsx("h3", { className: "raza-title", children: D.nombre }),
                v.jsx("p", {
                  className: "raza-description",
                  ...
                  children: [
                    v.jsxs("div", {
                      ...
                      children: [
                        v.jsxs("span", {
                          className: "raza-bonus-name",
                          children: [m.bonusCC.split(":")[0], ":"],
                        }),
                        v.jsx("span", {
                          className: "raza-chip raza-chip-secondary",
                          children: m.bonusCC.split(":")[1],
                        }),
                      ],
                    }),
                    v.jsxs("div", {
                      ...
                      children: [
                        v.jsxs("span", {
                          className: "raza-bonus-name",
                          children: [m.bonusAA.split(":")[0], ":"],
                        }),
                        v.jsx("span", {
                          className: "raza-chip raza-chip-secondary",
                          children: m.bonusAA.split(":")[1],
                        }),
                      ],
                    }),
                    v.jsxs("div", {
