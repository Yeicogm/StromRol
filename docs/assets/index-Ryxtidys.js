...
function Hh() {
  ...
  function X(h, x, U) {
    ...
    if (
      ...
      U = {};
      for (var W in x) W !== "key" && (U[W] = x[W]);
    } else U = x;
    return (
      (x = U.ref),
      { $$typeof: M, type: h, key: Q, ref: x !== void 0 ? x : null, props: U }
    );
  }
  return (Du.Fragment = w), (Du.jsx = X), (Du.jsxs = X), Du;
}
var ud;
function Ch() {
...
function qh() {
  ...
  (Ra.prototype.isReactComponent = {}),
    (Ra.prototype.setState = function (r, O) {
    ...
    (Ra.prototype.forceUpdate = function (r) {
  ...
  var J = (za.prototype = new na());
  (J.constructor = za), Ma(J, Ra.prototype), (J.isPureReactComponent = !0);
  var ll = Array.isArray,
    _ = { H: null, A: null, T: null, S: null, V: null },
    Ga = Object.prototype.hasOwnProperty;
  function aa(r, O, R, D, o, S) {
    return (
      (R = S.ref),
      { $$typeof: M, type: r, key: O, ref: R !== void 0 ? R : null, props: S }
    );
  }
  function Ua(r, O) {
    return aa(r.type, O, void 0, void 0, void 0, r.props);
  }
  function Qa(r) {
  ...
  function Da(r, O, R, D, o) {
        ...
        case "object":
          switch (r.$$typeof) {
            ...
            case w:
              ...
              break;
            case Y:
              return (z = r._init), Da(z(r._payload), O, R, D, o);
          }
      }
    if (z)
      return (
        ...
        ll(o)
          ? ((R = ""),
            z != null && (R = z.replace(Ha, "$&/") + "/"),
            Da(o, O, R, "", function (Na) {
              return Na;
            }))
          : o != null &&
            (Qa(o) &&
    ...
    if (ll(r))
      for (var C = 0; C < r.length; C++)
        (D = r[C]), (S = H + ya(D, C)), (z += Da(D, O, R, S, o));
    else if (((C = ea(r)), typeof C == "function"))
      for (r = C.call(r), C = 0; !(D = r.next()).done; )
        (D = D.value), (S = H + ya(D, C++)), (z += Da(D, O, R, S, o));
    else if (S === "object") {
      if (typeof r.then == "function") return Da(ql(r), O, R, D, o);
      throw (
        ((O = String(r)),
        Error(
  ...
  return (
    ...
    ($.cloneElement = function (r, O, R) {
      ...
      if (z === 1) D.children = R;
        ...
        for (var H = Array(z), C = 0; C < z; C++) H[C] = arguments[C + 2];
        D.children = H;
      }
      return aa(r.type, o, void 0, void 0, S, D);
    }),
    ...
    ($.createElement = function (r, O, R) {
      var D,
        o = {},
        S = null;
      if (O != null)
        for (D in (O.key !== void 0 && (S = "" + O.key), O))
          Ga.call(O, D) &&
            D !== "key" &&
            D !== "__self" &&
            D !== "__source" &&
      ...
      if (r && r.defaultProps)
        for (D in ((z = r.defaultProps), z)) o[D] === void 0 && (o[D] = z[D]);
      return aa(r, S, void 0, void 0, null, o);
    }),
    ($.createRef = function () {
      return { current: null };
    }),
    ...
    ($.memo = function (r, O) {
      return { $$typeof: p, type: r, compare: O === void 0 ? null : O };
    }),
    ...
    ($.useActionState = function (r, O, R) {
      return _.H.useActionState(r, O, R);
    }),
    ($.useCallback = function (r, O) {
      return _.H.useCallback(r, O);
    }),
    ...
    ($.useDeferredValue = function (r, O) {
      return _.H.useDeferredValue(r, O);
    }),
    ($.useEffect = function (r, O, R) {
      var D = _.H;
      if (typeof R == "function")
        throw Error(
          "useEffect CRUD overload is not enabled in this build of React."
        );
      return D.useEffect(r, O);
    }),
    ($.useId = function () {
      return _.H.useId();
    }),
    ($.useImperativeHandle = function (r, O, R) {
      return _.H.useImperativeHandle(r, O, R);
    }),
    ($.useInsertionEffect = function (r, O) {
      return _.H.useInsertionEffect(r, O);
    }),
    ($.useLayoutEffect = function (r, O) {
      return _.H.useLayoutEffect(r, O);
    }),
    ($.useMemo = function (r, O) {
      return _.H.useMemo(r, O);
    }),
    ($.useOptimistic = function (r, O) {
      return _.H.useOptimistic(r, O);
    }),
    ($.useReducer = function (r, O, R) {
      return _.H.useReducer(r, O, R);
    }),
    ($.useRef = function (r) {
      return _.H.useRef(r);
    }),
    ...
    ($.useSyncExternalStore = function (r, O, R) {
      return _.H.useSyncExternalStore(r, O, R);
    }),
    ...
    cd ||
      ...
      (function (M) {
        ...
        function h(A) {
          ...
          if (Z !== j) {
            A[0] = Z;
            a: for (var ra = 0, r = A.length, O = r >>> 1; ra < O; ) {
              var R = 2 * (ra + 1) - 1,
                D = A[R],
                o = R + 1,
                S = A[o];
              if (0 > x(D, Z))
                o < r && 0 > x(S, D)
                  ? ((A[ra] = S), (A[o] = Z), (ra = o))
                  : ((A[ra] = D), (A[R] = Z), (ra = R));
              else if (o < r && 0 > x(S, Z)) (A[ra] = S), (A[o] = Z), (ra = o);
              else break a;
            }
          }
          return j;
        ...
        function ll(A) {
          for (var j = X(p); j !== null; ) {
            if (j.callback === null) h(p);
            else if (j.startTime <= A)
              h(p), (j.sortIndex = j.expirationTime), w(B, j);
            else break;
            j = X(p);
          }
        }
        function _(A) {
          if (((Ja = !1), ll(A), !Ma))
            if (X(B) !== null) (Ma = !0), Ga || ((Ga = !0), ya());
            else {
              var j = X(p);
              j !== null && Da(_, j.startTime - A);
            }
        }
        var Ga = !1,
          aa = -1,
          ...
          Qa = -1;
        function Cl() {
          return Ra ? !0 : !(M.unstable_now() - Qa < Ua);
        }
        function Ha() {
          if (((Ra = !1), Ga)) {
            ...
            try {
              a: {
                (Ma = !1), Ja && ((Ja = !1), za(aa), (aa = -1)), (fa = !0);
                var Z = ea;
                try {
                  l: {
                    for (
                      ll(A), k = X(B);
                      k !== null && !(k.expirationTime > A && Cl());

                    ) {
                      var ra = k.callback;
                      if (typeof ra == "function") {
                        (k.callback = null), (ea = k.priorityLevel);
                        var r = ra(k.expirationTime <= A);
                        if (((A = M.unstable_now()), typeof r == "function")) {
                          (k.callback = r), ll(A), (j = !0);
                          break l;
                        }
                        k === X(B) && h(B), ll(A);
                      } else h(B);
        ...
        (M.unstable_IdlePriority = 5),
          ...
          (M.unstable_cancelCallback = function (A) {
            A.callback = null;
          }),
          ...
          (M.unstable_runWithPriority = function (A, j) {
            switch (A) {
              case 1:
              case 2:
              case 3:
          ...
          (M.unstable_scheduleCallback = function (A, j, Z) {
            ...
            return (
              ...
              Z > ra
                ? ((A.sortIndex = Z),
                  ...
                  X(B) === null &&
                    A === X(p) &&
                    (Ja ? (za(aa), (aa = -1)) : (Ja = !0), Da(_, Z - ra)))
                : ((A.sortIndex = r),
                  w(B, A),
                  Ma || fa || ((Ma = !0), Ga || ((Ga = !0), ya()))),
              A
            );
          }),
          (M.unstable_shouldYield = Cl),
          (M.unstable_wrapCallback = function (A) {
            var j = ea;
            return function () {
              var Z = ea;
              ea = j;
...
function Xh() {
  ...
  return (
    ...
    (Pa.preinitModule = function (B, p) {
      if (typeof B == "string")
        if (typeof p == "object" && p !== null) {
          if (p.as == null || p.as === "script") {
            var Y = W(p.as, p.crossOrigin);
            h.d.M(B, {
              crossOrigin: Y,
    ...
    (Pa.unstable_batchedUpdates = function (B, p) {
      return B(p);
    }),
    (Pa.useFormState = function (B, p, Y) {
      return Q.H.useFormState(B, p, Y);
    }),
...
function Qh() {
  ...
  function W(a) {
    if (U(a) !== a) throw Error(h(188));
  }
  function B(a) {
    var l = a.alternate;
    if (!l) {
      if (((l = U(a)), l === null)) throw Error(h(188));
      return l !== a ? null : a;
    }
    for (var t = a, e = l; ; ) {
      var u = t.return;
  ...
  var Da = Array.isArray,
    A = w.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
  ...
  var o = O(null),
    ...
    H = O(null);
  function C(a, l) {
    switch ((D(z, l), D(S, a), D(o, null), l.nodeType)) {
      case 9:
      case 11:
  ...
  function I(a) {
    S.current === a && (R(o), R(S)),
      H.current === a && (R(H), (Nu._currentValue = Z));
  }
  ...
  var et = Math.random().toString(36).slice(2),
    ...
    Fn = "__reactEvents$" + et,
    Nd = "__reactListeners$" + et,
    Td = "__reactHandles$" + et,
    bf = "__reactResources$" + et,
    Ce = "__reactMarker$" + et;
  function In(a) {
    delete a[Fa], delete a[el], delete a[Fn], delete a[Nd], delete a[Td];
  }
  function wt(a) {
    var l = a[Fa];
    if (l) return l;
...
` +
  ...
  function Uf(a, l, t) {
    ...
    try {
      ...
      if (
        ((ci = !1),
        (ae !== null || le !== null) &&
          (On(), ae && ((l = ae), (a = le), (le = ae = null), Rf(l), a)))
      )
  ...
  function ku(a, l, t, e, u, n) {
    var i = 0;
    if (((e = a), typeof a == "function")) Ni(a) && (i = 1);
      ...
      a: switch (a) {
        case Qa:
          return (a = rl(31, t, l, u)), (a.elementType = Qa), (a.lanes = n), a;
        case Ma:
        ...
        case Ra:
          return (
            (a = rl(12, t, l, u | 2)), (a.elementType = Ra), (a.lanes = n), a
          );
        case _:
          return (a = rl(13, t, l, u)), (a.elementType = _), (a.lanes = n), a;
        case Ga:
          return (a = rl(19, t, l, u)), (a.elementType = Ga), (a.lanes = n), a;
        default:
          if (typeof a == "object" && a !== null)
            switch (a.$$typeof) {
              case na:
  ...
  function Je(a) {
    ...
    if (
      ...
      l === 27
        ...
        : (Oa = al ? _l(a.stateNode.nextSibling) : null);
    return !0;
  }
  function we() {
    (Oa = al = null), (sa = !1);
  ...
  function Kl(a) {
    (a._currentValue = xi.current), R(xi);
  }
  function ji(a, l, t) {
    for (; a !== null; ) {
      var e = a.alternate;
  ...
  function We(a, l, t, e) {
    ...
    a !== null && Ri(l, a, t, e), (l.flags |= 262144);
  }
  function Pu(a) {
  ...
  function Li(a, l, t, e, u, n) {
    return (
      ...
      (l.updateQueue = null),
      (l.lanes = 0),
      (A.H = a === null || a.memoizedState === null ? sr : rr),
      (Xt = !1),
      (n = t(e, u)),
      (Xt = !1),
      me && (n = Ms(l, t, e, u)),
  ...
  function _s(a) {
    ...
    if (((st = 0), (Ca = ma = F = null), (nn = !1), (eu = 0), (he = null), l))
      throw Error(h(300));
    a === null ||
      Va ||
  ...
  function Ms(a, l, t, e) {
    ...
    do {
      if ((me && (he = null), (eu = 0), (me = !1), 25 <= u))
        throw Error(h(301));
      if (((u += 1), (Ca = ma = null), a.updateQueue != null)) {
        var n = a.updateQueue;
        (n.lastEffect = null),
          (n.events = null),
          (n.stores = null),
  ...
  function Om() {
    ...
    return (
      ...
      (a = a.useState()[0]),
      (ma !== null ? ma.memoizedState : null) !== a && (F.flags |= 1024),
      l
    );
  }
  function Ki() {
  ...
  function wi(a) {
    ...
    (st = 0), (Ca = ma = F = null), (me = !1), (eu = cn = 0), (he = null);
  }
  function nl() {
    var a = {
      memoizedState: null,
    ...
    return Ca === null ? (F.memoizedState = Ca = a) : (Ca = Ca.next = a), Ca;
  }
  function qa() {
    if (ma === null) {
      var a = F.alternate;
    ...
    var l = Ca === null ? F.memoizedState : Ca.next;
    if (l !== null) (Ca = l), (ma = a);
    else {
      if (a === null)
      ...
      (ma = a),
        ...
        Ca === null ? (F.memoizedState = Ca = a) : (Ca = Ca.next = a);
    }
    return Ca;
  }
  function $i() {
  ...
  function uu(a) {
    ...
    return (
      ...
      (Ca === null ? l.memoizedState : Ca.next) === null &&
        ((l = l.alternate),
        (A.H = l === null || l.memoizedState === null ? sr : rr)),
      a
    );
  }
  function fn(a) {
  ...
  function ki(a, l, t) {
    ...
    if (((n = a.baseState), u === null)) a.memoizedState = n;
      ...
      if (
        (f === null ? (i = n) : (f.next = c),
        !sl(n, a.memoizedState) && ((Va = !0), E && ((t = oe), t !== null)))
      )
        throw t;
      (a.memoizedState = n),
        (a.baseState = i),
  ...
  function xs(a, l, t) {
    (a.flags |= 16384),
      ...
      (l = F.updateQueue),
      l === null
        ? ((l = $i()), (F.updateQueue = l), (l.stores = [a]))
  ...
  function Qs(a, l) {
        ...
        a: {
          ...
          if (sa) {
            if (Oa) {
              ...
              if (u) {
                (Oa = _l(u.nextSibling)), (e = u.data === "F!");
                break a;
              }
            }
            Ct(e);
    ...
    return (
      ...
      (e.dispatch = t),
      (e = Ii(!1)),
      (n = uc.bind(null, F, !1, e.queue)),
      (e = nl()),
      (u = { state: l, dispatch: null, action: a, pending: null }),
      (e.queue = u),
      (t = _m.bind(null, F, u, n, t)),
      (u.dispatch = t),
      (e.memoizedState = a),
      [l, t, !1]
    );
  ...
  function Vs(a, l, t) {
    ...
    return (
      t !== l.memoizedState &&
        ((F.flags |= 2048), ve(9, rn(), Mm.bind(null, u, t), null)),
      [e, n, a]
    );
  }
  function Mm(a, l) {
  ...
  function nu(a, l, t, e) {
    ...
    ma !== null && e !== null && Vi(e, ma.memoizedState.deps)
      ...
      : ((F.flags |= a), (u.memoizedState = ve(1 | l, n, t, e)));
  }
  function Js(a, l) {
    on(8390656, 8, a, l);
  }
  ...
  function lc(a, l, t) {
    return t === void 0 || (st & 1073741824) !== 0
      ? (a.memoizedState = l)
      : ((a.memoizedState = t), (a = to()), (F.lanes |= a), (yt |= a), t);
  }
  function ar(a, l, t, e) {
    return sl(t, l)
      ? t
      : de.current !== null
      ? ((a = lc(a, t, e)), sl(a, l) || (Va = !0), a)
      : (st & 42) === 0
      ? ((Va = !0), (a.memoizedState = t))
      : ((a = to()), (F.lanes |= a), (yt |= a), l);
  }
  ...
  function jm(a, l, t) {
    ...
    (t = {
      ...
      dn(a)
        ? cr(l, t)
        : ((t = Ei(a, l, t, e)), t !== null && (vl(t, a, e), fr(t, l, e)));
  }
  function ir(a, l, t) {
    var e = hl();
    iu(a, l, t, e);
  ...
  function uc(a, l, t, e) {
    ...
    } else (l = Ei(a, t, e, 2)), l !== null && vl(l, a, 2);
  }
  function dn(a) {
    var l = a.alternate;
    return a === F || (l !== null && l === F);
  }
  function cr(a, l) {
    me = nn = !0;
    var t = a.pending;
  ...
  var mn = {
    ...
    sr = {
      ...
      useCallback: function (a, l) {
        return (nl().memoizedState = [a, l === void 0 ? null : l]), a;
      },
      useContext: Ia,
      useEffect: Js,
      ...
      useOptimistic: function (a) {
        ...
        return (
          (l.queue = t), (l = uc.bind(null, F, !0, t)), (t.dispatch = l), [a, l]
        );
      },
      useMemoCache: Wi,
      useCacheRefresh: function () {
        return (nl().memoizedState = xm.bind(null, F));
      },
    },
    rr = {
      readContext: Ia,
  ...
  function dr(a) {
    ...
    function c(m, d, v, N) {
      return d === null || d.tag !== 6
        ? ((d = Ti(v, m.mode, N)), (d.return = m), d)
        : ((d = u(d, v)), (d.return = m), d);
    }
    function f(m, d, v, N) {
      var q = v.type;
      return q === Ma
        ? E(m, d, v.props.children, N, v.key)
        : d !== null &&
          (d.elementType === q ||
            (typeof q == "object" &&
              q !== null &&
        ...
        : ((d = ku(v.type, v.key, v.props, null, m.mode, N)),
          fu(d, v),
          (d.return = m),
          d);
    }
    function y(m, d, v, N) {
      return d === null ||
        ...
        ? ((d = Oi(v, m.mode, N)), (d.return = m), d)
        : ((d = u(d, v.children || [])), (d.return = m), d);
    }
    function E(m, d, v, N, q) {
      return d === null || d.tag !== 7
        ? ((d = jt(v, m.mode, N, q)), (d.return = m), d)
        : ((d = u(d, v)), (d.return = m), d);
    }
    function T(m, d, v) {
      if (
    ...
    function g(m, d, v, N) {
      ...
      if (
        ...
        return q !== null ? null : c(m, d, "" + v, N);
      if (typeof v == "object" && v !== null) {
        switch (v.$$typeof) {
          case ea:
            return v.key === q ? f(m, d, v, N) : null;
          case fa:
            return v.key === q ? y(m, d, v, N) : null;
          case Ua:
            return (q = v._init), (v = q(v._payload)), g(m, d, v, N);
        }
        if (Da(v) || ya(v)) return q !== null ? null : E(m, d, v, N, null);
        if (typeof v.then == "function") return g(m, d, hn(v), N);
        if (v.$$typeof === J) return g(m, d, an(m, v), N);
        vn(m, v);
      }
      return null;
    }
    function b(m, d, v, N, q) {
      if (
        (typeof N == "string" && N !== "") ||
        typeof N == "number" ||
        typeof N == "bigint"
      )
        return (m = m.get(v) || null), c(d, m, "" + N, q);
      if (typeof N == "object" && N !== null) {
        switch (N.$$typeof) {
          case ea:
            return (
              (m = m.get(N.key === null ? v : N.key) || null), f(d, m, N, q)
            );
          case fa:
            return (
              (m = m.get(N.key === null ? v : N.key) || null), y(d, m, N, q)
            );
          case Ua:
            var P = N._init;
            return (N = P(N._payload)), b(m, d, v, N, q);
        }
        if (Da(N) || ya(N)) return (m = m.get(v) || null), E(d, m, N, q, null);
        if (typeof N.then == "function") return b(m, d, v, hn(N), q);
        if (N.$$typeof === J) return b(m, d, v, an(d, N), q);
        vn(d, N);
      }
      return null;
    }
    function K(m, d, v, N) {
      for (
        var q = null, P = null, G = d, L = (d = 0), Ka = null;
        G !== null && L < v.length;
        L++
      ) {
        G.index > L ? ((Ka = G), (G = null)) : (Ka = G.sibling);
        var ca = g(m, G, v[L], N);
        if (ca === null) {
          G === null && (G = Ka);
          break;
        ...
        a && G && ca.alternate === null && l(m, G),
          (d = n(ca, d, L)),
          P === null ? (q = ca) : (P.sibling = ca),
          (P = ca),
          (G = Ka);
      }
      if (L === v.length) return t(m, G), sa && Ut(m, L), q;
      if (G === null) {
        for (; L < v.length; L++)
          (G = T(m, v[L], N)),
            G !== null &&
              ((d = n(G, d, L)),
              P === null ? (q = G) : (P.sibling = G),
              (P = G));
        return sa && Ut(m, L), q;
      }
      for (G = e(G); L < v.length; L++)
        (Ka = b(G, m, L, v[L], N)),
          Ka !== null &&
            (a &&
              Ka.alternate !== null &&
              G.delete(Ka.key === null ? L : Ka.key),
            (d = n(Ka, d, L)),
            P === null ? (q = Ka) : (P.sibling = Ka),
            (P = Ka));
      return (
        a &&
    ...
    function V(m, d, v, N) {
      ...
      for (
        var q = null, P = null, G = d, L = (d = 0), Ka = null, ca = v.next();
        G !== null && !ca.done;
        L++, ca = v.next()
      ) {
        G.index > L ? ((Ka = G), (G = null)) : (Ka = G.sibling);
        var Tt = g(m, G, ca.value, N);
        if (Tt === null) {
          G === null && (G = Ka);
          break;
        }
        a && G && Tt.alternate === null && l(m, G),
          (d = n(Tt, d, L)),
          P === null ? (q = Tt) : (P.sibling = Tt),
          (P = Tt),
          (G = Ka);
      }
      if (ca.done) return t(m, G), sa && Ut(m, L), q;
      if (G === null) {
    ...
    function va(m, d, v, N) {
        ...
        switch (v.$$typeof) {
          case ea:
            a: {
              ...
              v.type === Ma
                ? ((N = jt(v.props.children, m.mode, N, v.key)),
                  (N.return = m),
                  (m = N))
                : ((N = ku(v.type, v.key, v.props, null, m.mode, N)),
                  fu(N, v),
                  (N.return = m),
                  (m = N));
            }
          ...
          case fa:
            a: {
              ...
              (N = Oi(v, m.mode, N)), (N.return = m), (m = N);
            }
            return i(m);
          case Ua:
            return (q = v._init), (v = q(v._payload)), va(m, d, v, N);
        }
        if (Da(v)) return K(m, d, v, N);
        if (ya(v)) {
          if (((q = ya(v)), typeof q != "function")) throw Error(h(150));
          return (v = q.call(v)), V(m, d, v, N);
        }
        if (typeof v.then == "function") return va(m, d, hn(v), N);
        if (v.$$typeof === J) return va(m, d, an(m, v), N);
        vn(m, v);
      }
      return (typeof v == "string" && v !== "") ||
        ...
        ? ((v = "" + v),
          d !== null && d.tag === 6
            ? (t(m, d.sibling), (N = u(d, v)), (N.return = m), (m = N))
            : (t(m, d), (N = Ti(v, m.mode, N)), (N.return = m), (m = N)),
          i(m))
        : t(m, d);
    }
    return function (m, d, v, N) {
      try {
        cu = 0;
        var q = va(m, d, v, N);
        return (ye = null), q;
        ...
        var P = rl(29, G, null, m.mode);
        return (P.lanes = N), (P.return = m), P;
      } finally {
      }
    };
  }
  ...
  function hr(a) {
    if (a.tag === 22) {
      if ((D(Xa, Xa.current), D(Al, a), jl === null)) {
        var l = a.alternate;
  ...
  function ot() {
    D(Xa, Xa.current), D(Al, Al.current);
  }
  function wl(a) {
    R(Al), jl === a && (jl = null), R(Xa);
  }
  var Xa = O(0);
  function yn(a) {
    for (var l = a; l !== null; ) {
  ...
  function Nr(a, l, t, e, u) {
    ...
    return (
      ...
      a !== null && !Va
        ? (Ji(a, l, u), $l(a, l, u))
        : (sa && c && _i(l), (l.flags |= 1), $a(a, l, e, u), l.child)
    );
  }
  ...
  function fc(a, l, t, e, u) {
    return (
      ...
      a !== null && !Va
        ? (Ji(a, l, u), $l(a, l, u))
        : (sa && e && _i(l), (l.flags |= 1), $a(a, l, t, u), l.child)
    );
  }
  function Dr(a, l, t, e, u, n) {
    return (
      ...
      a !== null && !Va
        ? (Ji(a, l, n), $l(a, l, n))
        : (sa && e && _i(l), (l.flags |= 1), $a(a, l, t, n), l.child)
    );
  }
  function xr(a, l, t, e, u) {
    if ((Bt(l), l.stateNode === null)) {
      ...
      var y = n.context,
        E = t.contextType;
      (i = ce), typeof E == "object" && E !== null && (i = Ia(E));
    ...
    if (
      ...
      if (n)
        ...
        if (
          ...
          throw ((f.retryLane = e), ie(a, e), vl(i, a, e), Er);
  ...
  function Hm(a, l, t) {
    switch (l.tag) {
      case 3:
        C(l, l.stateNode.containerInfo), nt(l, Ya, a.memoizedState.cache), we();
        break;
      case 27:
      case 5:
        ia(l);
  ...
  function Cr(a, l, t) {
    ...
    else (Va = !1), sa && (l.flags & 1048576) !== 0 && os(l, Iu, l.index);
    switch (((l.lanes = 0), l.tag)) {
      ...
      case 27:
        return (
          ...
          a === null &&
            ...
            (xl = !0),
            (u = Oa),
            zt(l.type) ? ((Wc = u), (Oa = _l(e.firstChild))) : (Oa = u)),
      ...
      case 5:
        return (
          ...
          l.memoizedState !== null &&
            ((u = Li(a, l, Om, null, null, t)), (Nu._currentValue = u)),
          Sn(a, l),
          $a(a, l, e, t),
          l.child
        );
        ...
        return (
          a === null &&
            ...
            ((a = t = Oa) &&
              ...
              t !== null
                ? ((l.stateNode = t), (al = l), (Oa = null), (a = !0))
                : (a = !1)),
            a || Ct(l)),
          null
        );
    ...
    switch ((Mi(l), l.tag)) {
      ...
      case 26:
        return (
          ...
          a === null
            ? (Wl(l),
              t !== null ? (Ea(l), qr(l, t)) : (Ea(l), (l.flags &= -16777217)))
            : t
            ? t !== a.memoizedState
              ? (Wl(l), Ea(l), qr(l, t))
              : (Ea(l), (l.flags &= -16777217))
            : (a.memoizedProps !== e && Wl(l), Ea(l), (l.flags &= -16777217)),
          null
        );
      case 27:
        I(l), (t = z.current);
        ...
        return Ea(l), null;
      case 5:
        if ((I(l), (t = l.type), a !== null && l.stateNode != null))
        ...
        return Ea(l), (l.flags &= -16777217), null;
      case 6:
      ...
      case 4:
        return Na(), a === null && Gc(l.stateNode.containerInfo), Ea(l), null;
      case 10:
        return Kl(l.type), Ea(l), null;
      case 19:
        if ((R(Xa), (u = l.memoizedState), u === null)) return Ea(l), null;
              ...
              for (a = l.child; a !== null; ) {
                if (((n = yn(a)), n !== null)) {
                  for (
                    ...
                    rs(t, a), (t = t.sibling);
                  return D(Xa, (Xa.current & 1) | 2), l.child;
                }
                a = a.sibling;
              }
            u.tail !== null &&
      ...
      case 23:
        return (
          ...
          e
            ? (t & 536870912) !== 0 &&
              (l.flags & 128) === 0 &&
              (Ea(l), l.subtreeFlags & 6 && (l.flags |= 8192))
            : Ea(l),
          (t = l.updateQueue),
  ...
  function Bm(a, l) {
    ...
    for (
      Lc = { focusedElem: a, selectionRange: t }, Gn = !1, La = l;
      La !== null;

    )
      if (
        ((l = La), (a = l.child), (l.subtreeFlags & 1024) !== 0 && a !== null)
      )
        (a.return = l), (La = a);
      else
        for (; La !== null; ) {
          switch (((l = La), (n = l.alternate), (a = l.flags), l.tag)) {
            case 0:
              break;
            case 11:
            case 15:
      ...
      for (var e = 0; e < t.length; e++) {
        ...
        a: for (; c !== null; ) {
          switch (c.tag) {
            ...
            case 3:
            case 4:
              (pa = c.stateNode.containerInfo), (il = !0);
              break a;
          }
          c = c.return;
        }
        if (pa === null) throw Error(h(160));
        Jr(n, i, u),
          (pa = null),
          (il = !1),
          (n = u.alternate),
  ...
  function $r(a, l) {
    ...
    switch (a.tag) {
      ...
      case 4:
        (e = Ol),
          (Ol = Cn(a.stateNode.containerInfo)),
          ol(l, a),
          dl(a),
          (Ol = e);
        break;
  ...
  function kr(a, l, t, e) {
    ...
    switch (l.tag) {
      ...
      case 22:
        ...
        break;
      case 24:
        Ul(a, l, t, e), u & 2048 && Ac(l.alternate, l);
        break;
      default:
        Ul(a, l, t, e);
    }
    ...
    switch (a.tag) {
      case 26:
        Se(a),
          a.flags & mu &&
            a.memoizedState !== null &&
            Eh(Ol, a.memoizedState, a.memoizedProps);
        break;
      case 5:
        Se(a);
        break;
      ...
      case 4:
        var l = Ol;
        (Ol = Cn(a.stateNode.containerInfo)), Se(a), (Ol = l);
        break;
      case 22:
        a.memoizedState === null &&
          ((l = a.alternate),
  ...
  function ao(a, l) {
    for (; La !== null; ) {
      ...
      if (((e = t.child), e !== null)) (e.return = t), (La = e);
      else
        a: for (t = a; La !== null; ) {
          e = La;
          var u = e.sibling,
  ...
  function to() {
    El === 0 && (El = (ua & 536870912) === 0 || sa ? mf() : 536870912);
    var a = Al.current;
    ...
    do {
      if (u === 0) {
        ...
        if (u === 2) {
          ...
          if (i !== 0) {
            ...
            a: {
              ...
              if ((f && (Ne(c, i).flags |= 256), (i = Rc(c, i, !1)), i !== 2)) {
                if (Ec && !f) {
        ...
        a: {
          ...
          if ((l & 62914560) === l && ((u = Oc + 300 - tl()), 10 < u)) {
            if ((St(e, l, El, !vt), Cu(e, 0, !0) !== 0)) break a;
            e.timeoutHandle = Uo(
              uo.bind(null, e, t, cl, Tn, Tc, l, El, Zt, pe, vt, n, 2, -0, 0),
              u
            );
            break a;
          }
          uo(e, t, cl, Tn, Tc, l, El, Zt, pe, vt, n, 0, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function uo(a, l, t, e, u, n, i, c, f, y, E, T, g, b) {
    if (
      ((a.timeoutHandle = -1),
      (T = l.subtreeFlags),
      (T & 8192 || (T & 16785408) === 16785408) &&
        ((Eu = { stylesheets: null, count: 0, unsuspend: Ah }),
        Fr(l),
        (T = Nh()),
        T !== null))
    ) {
      (a.cancelPendingCommit = T(
        oo.bind(null, a, l, n, t, e, u, i, c, f, E, 1, g, b)
      )),
        St(a, n, i, !y);
      return;
    }
  ...
  function xc() {
    if (la !== null) {
      if (da === 0) var a = la.return;
      else (a = la), (Ll = qt = null), wi(a), (ye = null), (cu = 0), (a = la);
      ...
      l === Ie || l === tn
        ...
        : (da =
            l === Er
              ...
              : 1),
      (ml = l),
      la === null && ((_a = 1), bn(a, bl(l, a.current)));
  }
  function io() {
    var a = A.H;
    return (A.H = mn), a === null ? mn : a;
  }
  function co() {
    var a = A.A;
    return (A.A = Xm), a;
  ...
  function Vm(a, l) {
    ...
    return (
      ...
      (A.A = u),
      (oa = t),
      la !== null ? 0 : ((Sa = null), (ua = 0), wu(), _a)
    );
  }
  function Lm() {
    for (; la !== null && !Dl(); ) fo(la);
  }
  function fo(a) {
  ...
  function Te(a, l, t, e) {
    ...
    try {
      if (Um(a, u, l, t, ua)) {
        (_a = 1), bn(a, bl(t, a.current)), (la = null);
        return;
      }
    } catch (n) {
  ...
  function oo(a, l, t, e, u, n, i, c, f) {
    ...
    if (l !== null) {
      ...
      if (
        ...
        (e = A.T), (A.T = null), (u = j.p), (j.p = 2), (i = oa), (oa |= 4);
        try {
          Bm(a, l, t);
        } finally {
          (oa = i), (j.p = u), (A.T = e);
  ...
  function vo() {
    if (Wa === 4 || Wa === 3) {
      ...
      (l.subtreeFlags & 10256) !== 0 || (l.flags & 10256) !== 0
        ? (Wa = 5)
        : ((Wa = 0), (Ae = bt = null), yo(a, a.pendingLanes));
  ...
  function go() {
    ...
    var t = kn(Ee),
      ...
      u = j.p;
    try {
      (j.p = 32 > t ? 32 : t), (A.T = null), (t = Mc), (Mc = null);
      var n = bt,
        i = Ee;
      if (((Wa = 0), (Ae = bt = null), (Ee = 0), (oa & 6) !== 0))
        throw Error(h(331));
      var c = oa;
      if (
        ((oa |= 4),
  ...
  function Uc(a, l, t) {
    ...
    u.has(t) ||
      ((Ec = !0), u.add(t), (a = Km.bind(null, a, l, t)), l.then(a, a));
  }
  function Km(a, l, t) {
    var e = a.pingCache;
    e !== null && e.delete(l),
      ...
      Sa === a &&
        (ua & t) === t &&
        (_a === 4 || (_a === 3 && (ua & 62914560) === ua && 300 > tl() - Oc)
          ? (oa & 2) === 0 && Ne(a, 0)
          : (Nc |= t),
        pe === ua && (pe = 0)),
      Hl(a);
  ...
  function zo() {
    ...
    var a = 0;
    Vt !== 0 && (uh() && (a = Vt), (Vt = 0));
    for (var l = tl(), t = null, e = Dn; e !== null; ) {
      var u = e.next,
        n = po(e, l);
      n === 0
        ? ((e.next = null),
    ...
    Uf(function () {
      ...
      a: {
        ...
        if (g !== void 0) {
          ...
          for (var d = y, v; d !== null; ) {
            ...
            if (
              ...
              (N !== 5 && N !== 26 && N !== 27) ||
                v === null ||
                m === null ||
                ((N = Be(d, m)), N != null && V.push(Su(d, N, v))),
              va)
            )
              break;
            d = d.return;
          ...
          0 < V.length &&
            ((g = new b(g, K, null, t, E)), T.push({ event: g, listeners: V }));
        }
      }
      if ((l & 7) === 0) {
        a: {
          ...
          if (
            ...
            if (
              ...
              (va = b == null ? g : qe(b)),
              (v = K == null ? g : qe(K)),
              (g = new V(N, d + "leave", b, t, E)),
              (g.target = va),
              (g.relatedTarget = v),
              (N = null),
              wt(E) === y &&
                ((V = new V(m, d + "enter", K, t, E)),
                (V.target = v),
                (V.relatedTarget = va),
                (N = V)),
              (va = N),
              ...
              l: {
                for (V = b, m = K, d = 0, v = V; v; v = _e(v)) d++;
                for (v = 0, N = m; N; N = _e(N)) v++;
                for (; 0 < d - v; ) (V = _e(V)), d--;
                for (; 0 < v - d; ) (m = _e(m)), v--;
                for (; d--; ) {
        ...
        L &&
          ...
          (P = Rn(y, L)),
          0 < P.length &&
            ((L = new Bf(L, a, null, t, E)),
            T.push({ event: L, listeners: P }),
            G ? (L.data = G) : ((G = Vf(t)), G !== null && (L.data = G)))),
          (G = nm ? im(a, t) : cm(a, t)) &&
            ((L = Rn(y, "onBeforeInput")),
            0 < L.length &&
              ((P = new Bf("onBeforeInput", "beforeinput", null, t, E)),
              T.push({ event: P, listeners: L }),
              (P.data = G))),
          Fm(T, a, y, t, E);
      }
      Oo(T, l);
...
`
    ...
    switch (l) {
      ...
      default:
        if (ui(l)) {
          for (E in t)
            t.hasOwnProperty(E) &&
              ((e = t[E]), e !== void 0 && Zc(a, l, E, e, t, void 0));
          return;
        }
    }
    for (c in t)
  ...
  function fh(a, l, t, e) {
    for (; a.nodeType === 1; ) {
      ...
      if (((a = _l(a.nextSibling)), a === null)) break;
    }
    return null;
  }
  function sh(a, l, t) {
  ...
  var Pl = j.d;
  j.d = { f: oh, r: dh, D: mh, C: hh, L: vh, m: yh, X: bh, S: gh, M: Sh };
  function oh() {
    var a = Pl.f(),
      l = On();
    return a || l;
    ...
    if ((l.count++, l.instance === null))
      switch (l.type) {
        case "style":
          ...
          if (e) return (l.instance = e), Za(e), e;
          var u = Y({}, t, {
            "data-href": t.href,
        ...
        case "stylesheet":
          ...
          if (n) return (l.state.loading |= 4), (l.instance = n), Za(n), n;
          (e = Qo(t)),
            (u = Nl.get(u)) && kc(e, u),
  ...
  function Jo(a, l, t, e, u, n, i, c, f, y, E, T) {
    return (
      (a = new Oh(a, l, t, i, c, f, y, T)),
      (l = 1),
      n === !0 && (l |= 24),
      (n = rl(3, null, null, l)),
      (a.current = n),
              ...
              case 3:
                if (((n = n.stateNode), n.current.memoizedState.isDehydrated)) {
                  ...
                  if (i !== 0) {
                    ...
                    Hl(n), (oa & 6) === 0 && ((Nn = tl() + 500), gu(0));
                  }
                }
                break;
              case 13:
                (c = ie(n, 2)), c !== null && vl(c, n, 2), On(), Pc(n, 2);
            }
  ...
  for (const h of w) {
    ...
    if (p && Y) {
      ...
      if (ea === Ja) {
        const na = k + Ma,
          za = fa + Ra;
        X[W] = `${na}D${ea}${za !== 0 ? (za > 0 ? "+" : "") + za : ""}`;
      } else {
        const na = B.trim(),
          za = Q.trim().replace(/^\+/, "");
        na.includes(za) || (X[W] = `${na}+${za}`);
      }
      continue;
    }
    if (p && /^[+-]?\d+D$/.test(Q)) {
      ...
      X[W] = `${k + Ma}D${ea}${fa !== 0 ? (fa > 0 ? "+" : "") + fa : ""}`;
      continue;
    }
    if (p && /^[+-]?\d+$/.test(Q)) {
      const k = parseInt(p[1], 10),
        ea = parseInt(p[2], 10);
      let fa = p[3] ? parseInt(p[3], 10) : 0;
      (fa += parseInt(Q, 10)),
        (X[W] = `${k}D${ea}${fa !== 0 ? (fa > 0 ? "+" : "") + fa : ""}`);
      continue;
    }
    if (/^[+-]?\d+$/.test(Q)) {
      const k = parseInt(B || "0", 10);
      X[W] = (k + parseInt(Q, 10)).toString();
      continue;
    }
    X[W] = Q;
  }
...
function Lh(M, w) {
  ...
  if (w?.variacion_caracMINMAX && w.variacion_caracMINMAX.length > 0) {
    const U = gd(w.variacion_caracMINMAX);
    x = Kh(x, U);
  }
  return x;
}
function gd(M) {
  ...
  for (const X of M) {
    ...
    if (h) {
      const U = wn[h[1].toUpperCase()];
      if (U) {
        const Q = parseInt(h[2], 10);
        w.push({ caracteristica: U, tipo: "MIN", valor: 0, dados: Q });
      }
      continue;
    }
    const x = X.match(/^MAX\s+(\w+)\s+(\d+)$/i);
    if (x) {
      const U = wn[x[1].toUpperCase()];
      if (U) {
        const Q = parseInt(x[2], 10);
        w.push({ caracteristica: U, tipo: "MAX", valor: Q });
      }
    }
  }
  return w;
...
function Kh(M, w) {
  const X = { ...M };
  for (const h of w) {
    const x = X[h.caracteristica];
    if (x && h.tipo === "MIN" && h.dados) {
      const U = x.match(/^(\d+)D(\d+)([+-]\d+)?$/);
      if (U) {
        const Q = parseInt(U[1], 10),
          W = parseInt(U[2], 10),
          B = U[3] ? U[3] : "";
        Q < h.dados &&
          ((X[h.caracteristica] = `${h.dados}D${W}${B}`),
          console.log(
            "[Aplicando límite MIN]",
            h.caracteristica,
            `${Q}D${W}${B} -> ${h.dados}D${W}${B}`
          ));
      }
    }
  }
...
function vd(M) {
  ...
  for (const h of X) {
    ...
    if (x) {
      let U, Q;
      h === X[0]
        ? ((U = parseInt(x[1].replace(/[+]/g, ""))), (Q = x[2]))
        : ((Q = x[1]), (U = parseInt(x[2].replace(/[+]/g, ""))));
      const W = wh(Q);
      if (W && !isNaN(U)) return { habilidad: W, valor: U };
    }
  }
  return null;
}
function $h() {
  const M = () =>
            ...
            children: s.jsxs("div", {
              ...
              children: [
                s.jsxs("h3", {
                  ...
                  children: ["Nacionalidad: ", aa.nombre],
                }),
                s.jsx("hr", { className: "raza-divider" }),
                aa.variacion_caracteristicas &&
                  aa.variacion_caracteristicas.length > 0 &&
                  s.jsxs("div", {
                    ...
                    children: [
                      ...
                      s.jsx("div", {
                        className: "raza-list",
                        children: aa.variacion_caracteristicas.map((o, S) =>
                          s.jsx(
                            "div",
                            {
                ...
                aa.origen_social &&
                  s.jsxs("div", {
                    ...
                    children: [
                      ...
                      s.jsx("div", {
                        className: "raza-list",
                        children: Array.isArray(aa.origen_social)
                          ? aa.origen_social.map((o, S) =>
                              s.jsx(
                                "div",
                                {
                                  className: "raza-list-item",
                ...
                na.variacion_habilidades &&
                  ...
                  s.jsxs("div", {
                    ...
                    children: [
                      ...
                      s.jsx("div", {
                        className: "raza-list",
                        children: na.variacion_habilidades.map((o, S) =>
                          s.jsxs(
                            "div",
                            {
                              className: "raza-list-item",
    ...
    [U, Q] = Ba.useState(null),
    [W, B] = Ba.useState([]),
    [p, Y] = Ba.useState([]),
    [k, ea] = Ba.useState([]),
    [fa, Ma] = Ba.useState([]),
    [Ja, Ra] = Ba.useState([]),
    [na, za] = Ba.useState(null),
    [J, ll] = Ba.useState(null),
    [_, Ga] = Ba.useState(null),
    [aa, Ua] = Ba.useState(null);
  Ba.useEffect(() => {
    if (!aa) {
      Ra(fa);
      return;
    ...
    let o = [];
    if (Array.isArray(aa.origen_social))
      o = aa.origen_social.map((z) => {
        const H = z.split(":");
        return H.length > 1
          ? H[1].trim().toUpperCase()
          : z.trim().toUpperCase();
      });
    else if (typeof aa.origen_social == "string") {
      Ra(fa);
      return;
    }
    const S = fa.filter((z) => o.includes(z.nombre.trim().toUpperCase()));
    Ra(S);
  }, [aa, fa]);
  const [Qa, Cl] = Ba.useState(null),
    [Ha, ya] = Ba.useState({}),
    [Ml, ql] = Ba.useState(!0),
    [Da, A] = Ba.useState([]),
    j = (o, S) => {
      const z = parseInt(S, 10);
      if (!isNaN(z) && Da.length > 0) {
        const H = md(o, z, Da);
        if (!H.valido && H.valorCorregido !== void 0) {
          ya((C) => ({ ...C, [o]: H.valorCorregido.toString() }));
          return;
        }
      }
      ya((H) => ({ ...H, [o]: S }));
  ...
  function Z(o) {
    ...
    for (; (H = z.exec(o)) !== null; ) {
      ...
      for (let Aa = 0; Aa < Math.abs(ia); Aa++) {
        let ba = Math.floor(Math.random() * I) + 1;
        Ml && ba < 2 && (ba = 2), (S += Ta * ba);
      }
    }
    const C = /([+-]\d+)(?!D)/g;
    let Na;
    for (; (Na = C.exec(o)) !== null; ) S += parseInt(Na[1], 10);
    return S;
  }
  const ra = () => {
      if (
        ...
        return;
      const o = {};
      Object.entries(Qa).forEach(([Bl, Ru]) => {
        if (typeof Ru == "string") {
          let Yl = Z(Ru);
          if (Da.length > 0) {
            const wa = md(Bl, Yl, Da);
            !wa.valido &&
        ...
        ya(o);
      const S = parseInt(o.Fuerza || "0", 10);
      let z = "";
      S >= 18 && S <= 23
        ? (z = "+1")
        : S >= 24 && S <= 30
        ...
        ? (z = "+2D6")
        : (z = "Sin bonus");
      const H = parseInt(o.Destreza || "0", 10),
        C = S + H;
      let Na = "NO TIENE";
      _ &&
        ...
        (C >= 0 && C <= 24
          ...
          ? (Na = "+2D4")
          : C >= 53 && (Na = "2D4+1"));
      const I = parseInt(o.Inteligencia || "0", 10),
        Ta = parseInt(o.Constitución || "0", 10),
        Aa = parseInt(o.Poder || "0", 10),
        ba = parseInt(o.Carisma || "0", 10),
        Dl = parseInt(o.Tamaño || "0", 10);
      let at = 0;
      I >= 1 && I <= 10
        ? (at = I)
        : I >= 11 && I <= 18
        ...
        : I >= 19 && (at = I + 30);
      const tl = I + H + 10,
        je = Math.floor(Ta / 2) + I + Aa + ba - 5,
        Lt = H * 2 + I + Aa - Dl - 5,
        Kt = I * 2 + H + ba - 15,
        lt = I + Math.floor(S / 2) + Aa + H - Dl - 5,
        Re = Aa + ba + I + 40 - Ta,
        ju = Math.max(1, Ta + Dl - 12);
      Q({
        bonusCC: `Bonus de Fuerza CC: ${z}`,
        bonusAA: `Bonus de Fuerza AA: ${Na}`,
        conocimiento: at,
        percepcion: tl,
        comunicacion: je,
        agilidad: Lt,
    ...
    O = () =>
      _
                    ...
                    _.variacion_caracteristicas &&
                      ...
                      s.jsxs("div", {
                        ...
                        children: [
                          ...
                          s.jsx("div", {
                            className: "raza-list",
                            children: _.variacion_caracteristicas.map((o, S) =>
                              s.jsx(
                                "div",
                                {
                                  className: "raza-list-item",
                    ...
                    _.variacion_caracMINMAX &&
                      ...
                      s.jsxs("div", {
                        ...
                        children: [
                          ...
                          s.jsx("div", {
                            className: "raza-list",
                            children: _.variacion_caracMINMAX.map((o, S) =>
                              s.jsxs(
                                "div",
                                {
                                  className: "raza-list-item",
                    ...
                    _.variacion_habilidades &&
                      ...
                      s.jsxs("div", {
                        ...
                        children: [
                          ...
                          s.jsx("div", {
                            className: "raza-list",
                            children: _.variacion_habilidades.map((o, S) =>
                              s.jsxs(
                                "div",
                                {
                                  className: "raza-list-item",
        ...
        : null,
    R = () => {
      if (!J && !_ && !na) return null;
      const o = {};
      return (
        J &&
          Object.entries(J.bonificaciones).forEach(([S, z]) => {
            if (typeof z == "number") o[S] = (o[S] || 0) + z;
            else if (typeof z == "string") {
              const H = parseInt(z.replace(/[+-]/g, "")) || 0,
                C = z.startsWith("-") ? -1 : 1;
              o[S] = (o[S] || 0) + H * C;
            }
          }),
        _ &&
          ...
          _.variacion_habilidades.forEach((S) => {
            ...
            const H = vd(z);
            if (H) {
              o[H.habilidad] = (o[H.habilidad] || 0) + H.valor;
              return;
            }
            if (z.includes("100%") || z.includes("+100")) {
              const C = z.replace(/(\+100|100\s*%).*$/, "").trim();
              C && (o[C] = 100);
            }
          }),
        na &&
          na.variacion_habilidades &&
          na.variacion_habilidades.forEach((S) => {
            const z = S.trim();
            if (
              z.includes("Regeneración de SM") ||
              z.includes("al día") ||
        ...
        : s.jsxs("div", {
            ...
            children: [
              ...
              s.jsx("ul", {
                ...
                children: Object.entries(o).map(([S, z]) =>
                  s.jsxs(
                    "li",
                    {
    ...
    Ba.useEffect(() => {
      fetch("/StromRol/Razas.json")
        ...
        fetch("/StromRol/Nacionalidad.json")
          .then((o) => o.json())
          .then((o) => ea(o.nacionalidades)),
        fetch("/StromRol/Origen.json")
          .then((o) => o.json())
          .then((o) => Ma(o.origenes));
    }, []),
    Ba.useEffect(() => {
      if ((ya({}), J)) {
        let o = Lh(
        ...
        aa &&
          aa.variacion_caracteristicas &&
          (o = yd(o, aa.variacion_caracteristicas)),
          Cl(o);
      } else Cl(null);
    }, [J, _, aa]),
    Ba.useEffect(() => {
          ...
          children: s.jsxs("div", {
            ...
            children: [
              ...
              s.jsxs("select", {
                ...
                value: J?.nombre || "",
                onChange: (o) => {
                  const S = W.find((z) => z.nombre === o.target.value);
                  ll(S || null),
                    x(),
                    Q(null),
                    Ua(null),
                ...
                children: [
                  ...
                  W.map((o) =>
                    s.jsx(
                      "option",
                      { value: o.nombre, children: o.nombre.toUpperCase() },
                      o.nombre
                    )
                  ),
                ],
          ...
          children: s.jsxs("div", {
            ...
            children: [
              ...
              s.jsxs("select", {
                ...
                value: _?.nombre || "",
                onChange: (o) => {
                  const S = p.find((z) => z.nombre === o.target.value);
                  Ga(S || null),
                    ya({}),
                    Q(null),
                    Ua(null),
            ...
            children: [
              s.jsx("button", {
                ...
                onClick: () => {
                  ...
                  let S = null;
                  for (const z of k) {
                    let H = parseInt(z.minimo, 10),
                      C = parseInt(z.maximo, 10);
                    if (
                      (z.minimo === "00" && (H = 100),
                      z.maximo === "00" && (C = 100),
                      H > C && ([H, C] = [C, H]),
                    ...
                    if (o === 100 && (z.minimo === "00" || z.maximo === "00")) {
                      S = z;
                      break;
                    }
                  }
                  S
                    ? (Ua(S),
                      ...
                      za(null),
                      x(),
                      alert(`Tirada: ${o} → Nacionalidad: ${S.nombre}`))
                    : alert(`Tirada: ${o} → No se encontró nacionalidad.`);
                },
                children: "🎲",
              }),
              s.jsxs("select", {
                ...
                value: aa?.nombre || "",
                onChange: (o) => {
                  const S = k.find((z) => z.nombre === o.target.value);
                  Ua(S || null), ya({}), Q(null), za(null), x();
                },
                disabled: !J,
                children: [
                  s.jsx("option", {
                  ...
                  k.map((o) =>
                    s.jsx(
                      "option",
                      { value: o.nombre, children: o.nombre },
                      o.nombre
                    )
                  ),
                ],
            ...
            children: [
              s.jsx("button", {
                ...
                onClick: () => {
                  ...
                  if (z) {
                    const H = Ja.find(
                      (C) => C.nombre.trim().toUpperCase() === z
                    );
                    H
                      ? (za(H),
                        ya({}),
                        Q(null),
                        alert(`Tirada: ${o} → Origen: ${H.nombre}`))
                      : alert(
                          `Tirada: ${o} → Origen encontrado en tabla: ${z}, pero no existe en el combo.`
                        );
                  } else alert(`Tirada: ${o} → No se encontró origen.`);
                },
                children: "🎲",
              }),
              s.jsxs("select", {
                ...
                value: na?.nombre || "",
                onChange: (o) => {
                  const S = Ja.find((z) => z.nombre === o.target.value);
                  za(S || null), ya({}), Q(null), x();
                },
                disabled: !aa,
                children: [
        ...
        Qa &&
          s.jsxs("div", {
            ...
            children: [
              ...
              s.jsx("ul", {
                className: "ficha-resultado-list",
                children: Object.entries(Qa).map(([o, S]) =>
                  s.jsxs(
                    "li",
                    {
                      className: "ficha-resultado-item",
                ...
                children: s.jsxs("label", {
                  ...
                  children: [
                    s.jsx("input", {
                      type: "checkbox",
                      checked: Ml,
                      onChange: (o) => ql(o.target.checked),
              ...
              s.jsxs("div", {
                ...
                children: [
                  s.jsx("button", {
                    ...
                    onClick: ra,
                    disabled: Object.keys(Qa || {}).length === 0,
                  ...
                  s.jsx("button", {
                    ...
                    disabled:
                      ...
                      Object.entries(Qa || {}).some(([o]) => !Ha[o]),
                    onClick: () => {
                      const o = parseInt(Ha.Fuerza || "0", 10);
                      let S = "";
                      o >= 18 && o <= 23
                        ? (S = "+1")
                        : o >= 24 && o <= 30
                      ...
                      _ &&
                        [
                          ...
                          (Re) => _.nombre.toUpperCase() === Re.toUpperCase()
                        ) &&
                        (H >= 0 && H <= 24
                          ? (C = "Nada")
                          : H >= 25 && H <= 40
                          ...
                          ? (C = "+2D4")
                          : H >= 53 && (C = "2D4+1"));
                      const ia = parseInt(Ha.Inteligencia || "0", 10),
                        I = parseInt(Ha.Constitución || "0", 10),
                        Ta = parseInt(Ha.Poder || "0", 10),
                        Aa = parseInt(Ha.Carisma || "0", 10),
                        ba = parseInt(Ha.Tamaño || "0", 10);
                      let Dl = 0;
                      ia >= 1 && ia <= 10
                        ? (Dl = ia)
                        : ia >= 11 && ia <= 18
                        ...
                        : ia >= 19 && (Dl = ia + 30);
                      const at = ia + z + 10,
                        tl = Math.floor(I / 2) + ia + Ta + Aa - 5,
                        je = z * 2 + ia + Ta - ba - 5,
                        Lt = ia * 2 + z + Aa - 15,
                        Kt = ia + Math.floor(o / 2) + Ta + z - ba - 5,
                        lt = Ta + Aa + ia + 40 - I;
                      Q({
                  ...
                  children: s.jsxs("div", {
                    ...
                    children: [
                      ...
                      s.jsx("div", {
                        className: "raza-list",
                        children: (() => {
                          const o = _?.Bonus_combate || {},
                            S = na.variacion_bonus_combate || {};
                          function z(ia, I) {
                            const Ta =
                                typeof ia == "string"
                                  ? parseInt(ia)
                          ...
                          const H = z(
                              o && "ataque" in o ? o.ataque : void 0,
                              S && "ataque" in S ? S.ataque : void 0
                            ),
                            C = z(
                              o && "defensa" in o ? o.defensa : void 0,
                              S && "defensa" in S ? S.defensa : void 0
                            ),
                            Na = z(
                              o && "armas_arrojadizas" in o
                                ? o.armas_arrojadizas
                                : void 0,
...
Vh.createRoot(document.getElementById("root")).render(
  s.jsx(Ba.StrictMode, { children: s.jsx($h, {}) })
);
