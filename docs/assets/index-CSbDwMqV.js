...
function jh() {
  ...
  function q(o, R, B) {
    ...
    return (
      (R = B.ref),
      { $$typeof: N, type: o, key: Q, ref: R !== void 0 ? R : null, props: B }
    );
  }
...
function qh() {
  ...
  function Zl(s, p, _, M, Y, tl) {
    return (
      (_ = tl.ref),
      { $$typeof: N, type: s, key: p, ref: _ !== void 0 ? _ : null, props: tl }
    );
  }
  function Vl(s, p) {
  ...
  function W(s, p, _, M, Y) {
        ...
        case "object":
          switch (s.$$typeof) {
            ...
            case $:
              ...
              break;
            case U:
              return (J = s._init), W(J(s._payload), p, _, M, Y);
          }
      }
    if (J)
      return (
    ...
    if (Kl(s))
      for (var rl = 0; rl < s.length; rl++)
        (M = s[rl]), (tl = Hl + T(M, rl)), (J += W(M, p, _, tl, Y));
    else if (((rl = k(s)), typeof rl == "function"))
      for (s = rl.call(s), rl = 0; !(M = s.next()).done; )
        (M = M.value), (tl = Hl + T(M, rl++)), (J += W(M, p, _, tl, Y));
    else if (tl === "object") {
      if (typeof s.then == "function") return W(G(s), p, _, M, Y);
      throw (
        ((p = String(s)),
        Error(
  ...
  return (
    ...
    (F.cloneElement = function (s, p, _) {
      ...
      return Zl(s.type, Y, void 0, void 0, tl, M);
    }),
    ...
    (F.createElement = function (s, p, _) {
      var M,
        Y = {},
        tl = null;
      if (p != null)
        for (M in (p.key !== void 0 && (tl = "" + p.key), p))
          Ql.call(p, M) &&
            M !== "key" &&
            M !== "__self" &&
            M !== "__source" &&
      ...
      if (s && s.defaultProps)
        for (M in ((J = s.defaultProps), J)) Y[M] === void 0 && (Y[M] = J[M]);
    ...
    (F.isValidElement = ia),
    (F.lazy = function (s) {
      return { $$typeof: U, _payload: { _status: -1, _result: s }, _init: D };
    }),
    (F.memo = function (s, p) {
    ...
    (F.useActionState = function (s, p, _) {
      return ul.H.useActionState(s, p, _);
    }),
    ...
    (F.useEffect = function (s, p, _) {
      var M = ul.H;
      if (typeof _ == "function")
        throw Error(
          "useEffect CRUD overload is not enabled in this build of React."
        );
      return M.useEffect(s, p);
    }),
    (F.useId = function () {
      return ul.H.useId();
    }),
    (F.useImperativeHandle = function (s, p, _) {
      return ul.H.useImperativeHandle(s, p, _);
    }),
    ...
    (F.useReducer = function (s, p, _) {
      return ul.H.useReducer(s, p, _);
    }),
    (F.useRef = function (s) {
    ...
    (F.useSyncExternalStore = function (s, p, _) {
      return ul.H.useSyncExternalStore(s, p, _);
    }),
  ...
  return (
    td ||
      ...
      (function (N) {
        ...
        function Kl(S) {
          for (var D = q(b); D !== null; ) {
            if (D.callback === null) o(b);
            else if (D.startTime <= S)
              o(b), (D.sortIndex = D.expirationTime), $(H, D);
            else break;
            D = q(b);
          }
        }
        ...
        var Ql = !1,
          ...
          ia = -1;
        function Ja() {
          return Nl ? !0 : !(N.unstable_now() - ia < Vl);
        }
        function ba() {
          if (((Nl = !1), Ql)) {
              ...
              l: {
                ...
                try {
                  a: {
                    for (
                      Kl(S), O = q(H);
                      O !== null && !(O.expirationTime > S && Ja());

                    ) {
                      var L = O.callback;
                      if (typeof L == "function") {
                        (O.callback = null), (k = O.priorityLevel);
                        var s = L(O.expirationTime <= S);
                        if (((S = N.unstable_now()), typeof s == "function")) {
                          (O.callback = s), Kl(S), (D = !0);
                          break a;
                        }
                        O === q(H) && o(H), Kl(S);
                      } else o(H);
        ...
        (N.unstable_IdlePriority = 5),
          ...
          (N.unstable_runWithPriority = function (S, D) {
            switch (S) {
              case 1:
              case 2:
              case 3:
          ...
          (N.unstable_scheduleCallback = function (S, D, x) {
...
function Xh() {
  ...
  return N(), (tf.exports = Yh()), tf.exports;
}
/**
 * @license React
...
function Gh() {
  ...
  var Y = p(null),
    ...
    Hl = p(null);
  function rl(l, a) {
    switch ((M(J, a), M(tl, l), M(Y, null), a.nodeType)) {
      case 9:
      case 11:
  ...
  function Bt(l) {
    tl.current === l && (_(Y), _(tl)),
      Hl.current === l && (_(Hl), (gu._currentValue = x));
  }
  var za = Object.prototype.hasOwnProperty,
    Yt = N.unstable_scheduleCallback,
    St = N.unstable_cancelCallback,
    Te = N.unstable_shouldYield,
    dd = N.unstable_requestPaint,
    Na = N.unstable_now,
    hd = N.unstable_getCurrentPriorityLevel,
    uf = N.unstable_ImmediatePriority,
    nf = N.unstable_UserBlockingPriority,
    Tu = N.unstable_NormalPriority,
    md = N.unstable_LowPriority,
    cf = N.unstable_IdlePriority,
    vd = N.log,
    yd = N.unstable_setDisableYieldValue,
    Ne = null,
    Il = null;
  function wa(l) {
    if (
...
` +
  ...
  var _d = /[\n"\\]/g;
  function ra(l) {
    return l.replace(_d, function (a) {
  ...
  function Df(l, a, t) {
    ...
    try {
      ...
      if (
        ((Pn = !1),
        (wt !== null || $t !== null) &&
          (Sn(), wt && ((a = wt), (l = $t), ($t = wt = null), Mf(a), l)))
      )
        for (a = 0; a < l.length; a++) Mf(l[a]);
    }
  }
  function Re(l, a) {
    var t = l.stateNode;
  ...
  function ss() {
    ...
    return (
      l !== null &&
        (kl === null ? (kl = l) : kl.push.apply(kl, l), (Mt = null)),
      l
    );
  }
  function Qe(l) {
  ...
  var Ec = p(null),
    ...
    Ca = null;
  function ka(l, a, t) {
    M(Ec, a._currentValue), (a._currentValue = t);
  }
  function Ba(l) {
    (l._currentValue = Ec.current), _(Ec);
  }
  function pc(l, a, t) {
    for (; l !== null; ) {
      var e = l.alternate;
  ...
  var b0 =
    ...
    z0 = N.unstable_scheduleCallback,
    A0 = N.unstable_NormalPriority,
    Dl = {
      $$typeof: Al,
      Consumer: null,
      Provider: null,
  ...
  function wu(l, a) {
    a === null ? M(Ut, Ut.current) : M(Ut, a.pool);
  }
  function hs() {
    var l = Mc();
  ...
  var ne = p(null),
    ku = p(0);
  function As(l, a) {
    (l = La), M(ku, l), M(ne, a), (La = l | a.baseLanes);
  }
  function jc() {
    M(ku, La), M(ne, ne.current);
  }
  function Hc() {
    (La = ku.current), _(ne), _(ku);
  }
  var lt = 0,
    I = null,
    ol = null,
  ...
  function Os(l, a, t, e) {
    (a.value = t), (a.getSnapshot = e), Ds(a) && _s(l);
  }
  function Ms(l, a, t) {
    return t(function () {
      Ds(a) && _s(l);
  ...
  function Ys(l, a, t) {
    ...
    return (
      t !== a.memoizedState &&
        ((I.flags |= 2048), fe(9, an(), M0.bind(null, u, t), null)),
      [e, n, l]
    );
  }
  function M0(l, a) {
  ...
  var un = {
    ...
    ur = {
      ...
      useCacheRefresh: function () {
        return ($l().memoizedState = _0.bind(null, I));
      },
    },
    nr = {
      readContext: Xl,
  ...
  function sr(l) {
    if (l.tag === 22) {
      if ((M(_l, _l.current), M(va, l), Ma === null)) {
        var a = l.alternate;
        a !== null && a.memoizedState !== null && (Ma = l);
      }
    } else tt();
  }
  function tt() {
    M(_l, _l.current), M(va, va.current);
  }
  function Xa(l) {
    _(va), Ma === l && (Ma = null), _(_l);
  }
  var _l = p(0);
  function fn(l) {
    for (var a = l; a !== null; ) {
    ...
    if (
      ...
      if (
        ...
        switch (t.tag) {
          case 13:
            return (
              Ma === null ? pi() : t.alternate === null && zl === 0 && (zl = 3),
              (t.flags &= -257),
              (t.flags |= 65536),
              (t.lanes = u),
              e === Dc
  ...
  function _r(l, a, t) {
    var e = a.pendingProps,
      u = e.revealOrder,
      n = e.tail;
    if ((ql(l, a, e.children, t), (e = _l.current), (e & 2) !== 0))
      (e = (e & 1) | 2), (a.flags |= 128);
    else {
      if (l !== null && (l.flags & 128) !== 0)
        l: for (l = a.child; l !== null; ) {
          if (l.tag === 13) l.memoizedState !== null && Dr(l, t, a);
          else if (l.tag === 19) Dr(l, t, a);
    ...
    if (a.type !== "stylesheet" || (a.state.loading & 4) !== 0)
      ...
      if (
        ...
        a !== null &&
          ((nl & 4194048) === nl
            ? Ma !== null
            : ((nl & 62914560) !== nl && (nl & 536870912) === 0) || a !== Ma))
      )
        throw ((Je = Dc), ms);
      l.flags |= 8192;
    }
  ...
  function H0(l, a, t) {
    ...
    switch ((zc(a), a.tag)) {
      ...
      case 19:
        if ((_(_l), (u = a.memoizedState), u === null)) return gl(a), null;
              ...
              for (l = a.child; l !== null; ) {
                if (((n = fn(l)), n !== null)) {
                  for (
                    ...
                    ns(t, l), (t = t.sibling);
                  return M(_l, (_l.current & 1) | 2), a.child;
                }
                l = l.sibling;
              }
            u.tail !== null &&
  ...
  function Vr(l, a) {
    ...
    switch (l.tag) {
      ...
      case 4:
        (e = Ea),
          (Ea = Mn(l.stateNode.containerInfo)),
          ta(a, l),
          ea(l),
          (Ea = e);
        break;
  ...
  function Kr(l, a, t, e) {
    ...
    switch (a.tag) {
      ...
      case 22:
        ...
        break;
      case 24:
        _a(l, a, t, e), u & 2048 && mi(a.alternate, a);
        break;
      default:
        _a(l, a, t, e);
    }
  ...
  function Jr(l) {
    switch (l.tag) {
      ...
      case 4:
        var a = Ea;
        (Ea = Mn(l.stateNode.containerInfo)), de(l), (Ea = a);
        break;
      case 22:
        l.memoizedState === null &&
          ((a = l.alternate),
      ...
      if (u === 0) {
        ...
        l: {
          ...
          if ((a & 62914560) === a && ((u = Si + 300 - Na()), 10 < u)) {
            if ((rt(e, a, ya, !ct), Mu(e, 0, !0) !== 0)) break l;
            e.timeoutHandle = Do(
  ...
  function Ei() {
    if (ll !== null) {
      ...
      else (l = ll), (Ca = _t = null), Xc(l), (se = null), (lu = 0), (l = ll);
  ...
  function co(l, a, t, e, u, n, c, i, f) {
    ...
    if (a !== null) {
      ...
      if (
        ...
        (e = S.T), (S.T = null), (u = D.p), (D.p = 2), (c = fl), (fl |= 4);
        try {
          C0(l, a, t);
        } finally {
          (fl = c), (D.p = u), (S.T = e);
  ...
  function oo() {
    ...
    var t = Zn(ye),
      ...
      u = D.p;
    try {
      (D.p = 32 > t ? 32 : t), (S.T = null), (t = zi), (zi = null);
      var n = st,
        c = ye;
  ...
  function mo(l, a) {
    a === 0 && (a = sf()), (l = Pt(l, a)), l !== null && (Me(l, a), Ra(l));
  }
  function K0(l) {
    var a = l.memoizedState,
      t = 0;
...
`
  ...
  function dl(l, a, t, e, u, n) {
    switch (t) {
      ...
      case "start":
        ...
        break;
      case "popover":
        al("beforetoggle", l), al("toggle", l), Du(l, "popover", e);
        break;
      case "xlinkActuate":
  ...
  var Do = typeof setTimeout == "function" ? setTimeout : void 0,
    ...
    nh =
      typeof queueMicrotask == "function"
        ...
        : typeof _o < "u"
        ? function (l) {
            return _o.resolve(null).then(l).catch(ch);
          }
        : Do;
  function ch(l) {
    setTimeout(function () {
  ...
  var Ka = D.d;
  D.d = { f: rh, r: oh, D: dh, C: hh, L: mh, m: vh, X: gh, S: yh, M: Sh };
  function rh() {
    var l = Ka.f(),
      a = Sn();
    return l || a;
  ...
  function Bo(l, a, t) {
    if ((a.count++, a.instance === null))
      ...
      a.type === "stylesheet" &&
        (a.state.loading & 4) === 0 &&
        ((e = a.instance), (a.state.loading |= 4), Dn(e, t.precedence, l));
    return a.instance;
  }
  function Dn(l, a, t) {
    for (
  ...
  function Yo(l, a, t) {
    if (_n === null) {
      var e = new Map(),
        u = (_n = new Map());
      u.set(t, e);
    } else (u = _n), (e = u.get(t)), e || ((e = new Map()), u.set(t, e));
    if (e.has(l)) return e;
    for (
  ...
  function Ji(l, a, t, e) {
    if (xn) {
      ...
      else if (_h(u, l, a, t, e)) e.stopPropagation();
  ...
  function qn(l, a) {
    l.blockedOn === a &&
      ...
      Wi ||
        ((Wi = !0),
        N.unstable_scheduleCallback(N.unstable_NormalPriority, Rh)));
  }
  var Cn = null;
  function ko(l) {
    Cn !== l &&
...
function Qh() {
  ...
  return N(), (Pi.exports = Gh()), Pi.exports;
}
var Zh = Qh();
const Xn = {
  Fuerza: "Fuerza",
  ...
  for (const o of $) {
    ...
    if (b) {
      ...
      if (/^[+-]?\d+D$/.test(Q)) {
        ...
        el && ((U += parseInt(el[1], 10)), (O = parseInt(el[2], 10))),
          (q[K] = `${U}D${O}${k !== 0 ? (k > 0 ? "+" : "") + k : ""}`),
      ...
      if (U) {
        let O = parseInt(U[1], 10),
          k = parseInt(U[2], 10),
          el = U[3] ? parseInt(U[3], 10) : 0;
        (el += parseInt(Q, 10)),
          (q[K] = `${O}D${k}${el !== 0 ? (el > 0 ? "+" : "") + el : ""}`),
          console.log("[Suma modificador simple]", K, "->", q[K]);
      } else {
        const O = parseInt(H || "0", 10);
        (q[K] = (O + parseInt(Q, 10)).toString()),
...
function sd(N, $, q) {
  for (const o of q)
    if (o.caracteristica === N && o.tipo === "MAX" && $ > o.valor)
      return {
        valido: !1,
        mensaje: `El valor máximo para ${N} es ${o.valor}`,
        valorCorregido: o.valor,
      };
  return { valido: !0 };
}
function Kh(N) {
  return !N?.variacion_caracMINMAX || N.variacion_caracMINMAX.length === 0
    ? []
    : od(N.variacion_caracMINMAX);
}
const rd = {
  ...
  const Zl = () => {
      ...
      O &&
        ["ARQUERO", "CASACA AZUL", "ILMIONARIO", "GUARDABOSQUES"].some(
          (za) => O.nombre.toUpperCase() === za.toUpperCase()
        ) &&
        (S >= 0 && S <= 24
          ? (D = "Nada")
          : S >= 25 && S <= 40
      ...
      const L = parseInt(T.Inteligencia || "0", 10),
        ...
        _ = parseInt(T.Carisma || "0", 10),
        M = parseInt(T.Tamaño || "0", 10);
      let Y = 0;
      L >= 1 && L <= 10
        ? (Y = L)
        : L >= 11 && L <= 18
        ...
        : L >= 19 && (Y = L + 30);
      const tl = L + W + 10,
        J = Math.floor(s / 2) + L + p + _ - 5,
        Hl = W * 2 + L + p - M - 5,
        rl = L * 2 + W + _ - 15,
        fa = L + Math.floor(C / 2) + p + W - M - 5,
        gt = p + _ + L + 40 - s,
        Bt = Math.max(1, s + M - 12);
      R({
        bonusCC: `Bonus de Fuerza CC: ${G}`,
        bonusAA: `Bonus de Fuerza AA: ${D}`,
        conocimiento: Y,
        percepcion: tl,
        comunicacion: J,
        agilidad: Hl,
      ...
      O
        ? m.jsx("div", {
            ...
            children: m.jsxs("div", {
              className: "raza-content",
              children: [
                m.jsx("h3", { className: "raza-title", children: O.nombre }),
                m.jsx("p", {
                  className: "raza-description",
                    ...
                    O.variacion_caracteristicas &&
                      ...
                      m.jsxs("div", {
                        ...
                        children: [
                          ...
                          m.jsx("div", {
                            className: "raza-list",
                            children: O.variacion_caracteristicas.map((T, C) =>
                              m.jsx(
                                "div",
                                {
                                  className: "raza-list-item",
                    ...
                    O.variacion_caracMINMAX &&
                      ...
                      m.jsxs("div", {
                        ...
                        children: [
                          ...
                          m.jsx("div", {
                            className: "raza-list",
                            children: O.variacion_caracMINMAX.map((T, C) =>
                              m.jsxs(
                                "div",
                                {
                                  className: "raza-list-item",
                    ...
                    O.variacion_habilidades &&
                      ...
                      m.jsxs("div", {
                        ...
                        children: [
                          ...
                          m.jsx("div", {
                            className: "raza-list",
                            children: O.variacion_habilidades.map((T, C) =>
                              m.jsxs(
                                "div",
                                {
                                  className: "raza-list-item",
                    ...
                    onClick: () => {
                      ...
                      O &&
                        [
                          ...
                          (gt) => O.nombre.toUpperCase() === gt.toUpperCase()
                        ) &&
                        (W >= 0 && W <= 24
                          ? (S = "Nada")
                          : W >= 25 && W <= 40
