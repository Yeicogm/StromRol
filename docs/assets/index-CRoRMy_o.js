  ...
  function Na(r, _, R, D, d) {
    ...
    if (cl(r))
      for (var Q = 0; Q < r.length; Q++)
        (D = r[Q]), (E = X + ba(D, Q)), (N += Na(D, _, R, E, d));
    else if (((Q = la(r)), typeof Q == "function"))
      for (r = Q.call(r), Q = 0; !(D = r.next()).done; )
        (D = D.value), (E = X + ba(D, Q++)), (N += Na(D, _, R, E, d));
    else if (E === "object") {
    ...
    cd ||
      ...
      (function (M) {
        ...
        var Wa = !1,
          ...
          Ba = -1;
        function ql() {
          return Oa ? !0 : !(M.unstable_now() - Ba < Za);
        }
        function Da() {
          if (((Oa = !1), Wa)) {
            ...
            return (
              ...
              Z > sa
                ? ((S.sortIndex = Z),
                  ...
                  B(q) === null &&
                    S === B(p) &&
                    ($a ? (Ma(ta), (ta = -1)) : ($a = !0), Na(O, Z - sa)))
                : ((S.sortIndex = r),
                  J(q, S),
                  Ea || ia || ((Ea = !0), Wa || ((Wa = !0), ba()))),
              S
            );
          }),
    ...
    (Pa.preinit = function (q, p) {
      if (typeof q == "string" && p && typeof p.as == "string") {
        var C = p.as,
          ...
          ia = typeof p.fetchPriority == "string" ? p.fetchPriority : void 0;
        C === "style"
  ...
  function dr(a) {
    ...
    function g(h, o, v, A) {
      ...
      if (typeof v == "object" && v !== null) {
        ...
        if (Na(v) || ba(v)) return H !== null ? null : z(h, o, v, A, null);
    ...
    function b(h, o, v, A, H) {
      ...
      if (typeof A == "object" && A !== null) {
        ...
        if (Na(A) || ba(A)) return (h = h.get(v) || null), z(o, h, A, H, null);
  ...
  for (const m of J) {
    ...
    if (p && C) {
      ...
      if (la === $a) {
        const ca = k + Ea,
          Ma = ia + Oa;
        B[aa] = `${ca}D${la}${Ma !== 0 ? (Ma > 0 ? "+" : "") + Ma : ""}`;
      } else {
        const ca = q.trim(),
          Ma = G.trim().replace(/^\+/, "");
        ca.includes(Ma) || (B[aa] = `${ca}+${Ma}`);
      }
      continue;
    }
    if (p && /^[+-]?\d+D$/.test(G)) {
      ...
      B[aa] = `${k + Ea}D${la}${ia !== 0 ? (ia > 0 ? "+" : "") + ia : ""}`;
      continue;
    }
    if (p && /^[+-]?\d+$/.test(G)) {
      const k = parseInt(p[1], 10),
        la = parseInt(p[2], 10);
      let ia = p[3] ? parseInt(p[3], 10) : 0;
      (ia += parseInt(G, 10)),
        (B[aa] = `${k}D${la}${ia !== 0 ? (ia > 0 ? "+" : "") + ia : ""}`);
      continue;
    }
    if (/^[+-]?\d+$/.test(G)) {
...
function $m() {
                ...
                ca.variacion_habilidades &&
                  ...
                  s.jsxs("div", {
                    ...
                    children: [
                      ...
                      s.jsx("div", {
                        className: "raza-list",
                        children: ca.variacion_habilidades.map((d, E) =>
                          s.jsxs(
                            "div",
                            {
                              className: "raza-list-item",
  ...
  Ha.useEffect(() => {
    ...
    const E = ia.filter((N) => d.includes(N.nombre.trim().toUpperCase()));
    Oa(E);
  }, [ta, ia]);
  ...
  const sa = () => {
      ...
      ua >= 1 && ua <= 10
        ...
        : ua >= 19 && (at = ua + 30);
      const ll = ua + X + 10,
        xe = Math.floor(ka / 2) + ua + Va + xa - 5,
        Lt = X * 2 + ua + Va - Dl - 5,
        Kt = ua * 2 + X + xa - 15,
        lt = ua + Math.floor(E / 2) + Va + X - Dl - 5,
        Re = Va + xa + ua + 40 - ka,
    ...
    R = () => {
      ...
      return (
        ...
        ca &&
          ca.variacion_habilidades &&
          ca.variacion_habilidades.forEach((E) => {
            const N = E.trim();
            if (
              N.includes("Regeneración de SM") ||
              N.includes("al día") ||
          ...
          children: [
            ...
            s.jsxs("select", {
              ...
              onChange: (d) => {
                ...
                Wa(E || null), ba({}), G(null), Za(null), Ma(null), x();
              },
              disabled: !!(
                w &&
                ["SELOROK", "DEMONIOS", "DEMONIO", "SELEROK"].includes(
